...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function al(){return new Vn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Pa(),fragmentShader:`
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function cl(){return new Vn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Pa(),fragmentShader:`
	...
	`}function t_(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===ra||c===sa,d=c===Hi||c===Vi;if(l||d){let u=e.get(a);const h=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==h)return t===null&&(t=new sl(i)),u=l?t.fromEquirectangular(a,u):t.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),u.texture;if(u!==void 0)return u.texture;{const f=a.image;return l&&f&&f.height>0||d&&f&&r(f)?(t===null&&(t=new sl(i)),u=l?t.fromEquirectangular(a):t.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),a.addEventListener("dispose",s),u.texture):null}}}return a}function r(a){let c=0;const l=6;for(let d=0;d<l;d++)a[d]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function n_(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Ca("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function i_(i,e,t,n){const r={},s=new WeakMap;function o(u){const h=u.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);for(const g in h.morphAttributes){const _=h.morphAttributes[g];for(let p=0,m=_.length;p<m;p++)e.remove(_[p])}h.removeEventListener("dispose",o),delete r[h.id];const f=s.get(h);f&&(e.remove(f),s.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(u,h){return r[h.id]===!0||(h.addEventListener("dispose",o),r[h.id]=!0,t.memory.geometries++),h}function c(u){const h=u.attributes;for(const g in h)e.update(h[g],i.ARRAY_BUFFER);const f=u.morphAttributes;for(const g in f){const _=f[g];for(let p=0,m=_.length;p<m;p++)e.update(_[p],i.ARRAY_BUFFER)}}function l(u){const h=[],f=u.index,g=u.attributes.position;let _=0;if(f!==null){const S=f.array;_=f.version;for(let y=0,E=S.length;y<E;y+=3){const D=S[y+0],w=S[y+1],T=S[y+2];h.push(D,w,w,T,T,D)}}else if(g!==void 0){const S=g.array;_=g.version;for(let y=0,E=S.length/3-1;y<E;y+=3){const D=y+0,w=y+1,T=y+2;h.push(D,w,w,T,T,D)}}else return;const p=new(Cu(h)?Nu:Du)(h,1);p.version=_;const m=s.get(u);m&&e.remove(m),s.set(u,p)}function d(u){const h=s.get(u);if(h){const f=u.index;f!==null&&h.version<f.version&&l(u)}else l(u);return s.get(u)}return{get:a,update:c,getWireframeAttribute:d}}function r_(i,e,t){let n;function r(h){n=h}let s,o;function a(h){s=h.type,o=h.bytesPerElement}function c(h,f){i.drawElements(n,f,s,h*o),t.update(f,n,1)}function l(h,f,g){g!==0&&(i.drawElementsInstanced(n,f,s,h*o,g),t.update(f,n,g))}function d(h,f,g){if(g===0)return;const _=e.get("WEBGL_multi_draw");if(_===null)for(let p=0;p<g;p++)this.render(h[p]/o,f[p]);else{_.multiDrawElementsWEBGL(n,f,0,s,h,0,g);let p=0;for(let m=0;m<g;m++)p+=f[m];t.update(p,n,1)}}function u(h,f,g,_){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let m=0;m<h.length;m++)l(h[m]/o,f[m],_[m]);else{p.multiDrawElementsInstancedWEBGL(n,f,0,s,h,0,_,0,g);let m=0;for(let S=0;S<g;S++)m+=f[S];for(let S=0;S<_.length;S++)t.update(m,n,_[S])}}this.setMode=r,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=d,this.renderMultiDrawInstances=u}function s_(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function o_(i,e,t){const n=new WeakMap,r=new et;function s(o,a,c){const l=o.morphTargetInfluences,d=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=d!==void 0?d.length:0;let h=n.get(a);if(h===void 0||h.count!==u){let x=function(){P.dispose(),n.delete(a),a.removeEventListener("dispose",x)};var f=x;h!==void 0&&h.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,p=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],S=a.morphAttributes.normal||[],y=a.morphAttributes.color||[];let E=0;g===!0&&(E=1),_===!0&&(E=2),p===!0&&(E=3);let D=a.attributes.position.count*E,w=1;D>e.maxTextureSize&&(w=Math.ceil(D/e.maxTextureSize),D=e.maxTextureSize);const T=new Float32Array(D*w*4*u),P=new Lu(T,D,w,u);P.type=on,P.needsUpdate=!0;const b=E*4;for(let R=0;R<u;R++){const k=m[R],B=S[R],W=y[R],q=D*w*4*R;for(let V=0;V<k.count;V++){const $=V*b;g===!0&&(r.fromBufferAttribute(k,V),T[q+$+0]=r.x,T[q+$+1]=r.y,T[q+$+2]=r.z,T[q+$+3]=0),_===!0&&(r.fromBufferAttribute(B,V),T[q+$+4]=r.x,T[q+$+5]=r.y,T[q+$+6]=r.z,T[q+$+7]=0),p===!0&&(r.fromBufferAttribute(W,V),T[q+$+8]=r.x,T[q+$+9]=r.y,T[q+$+10]=r.z,T[q+$+11]=W.itemSize===4?r.w:1)}}h={count:u,texture:P,size:new ve(D,w)},n.set(a,h),a.addEventListener("dispose",x)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let g=0;for(let p=0;p<l.length;p++)g+=l[p];const _=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(i,"morphTargetBaseInfluence",_),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:s}}function a_(i,e,t,n){let r=new WeakMap;function s(c){const l=n.render.frame,d=c.geometry,u=e.get(c,d);if(r.get(u)!==l&&(e.update(u),r.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==l&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const h=c.skeleton;r.get(h)!==l&&(h.update(),r.set(h,l))}return u}function o(){r=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:o}}class ku extends dt{constructor(e,t,n,r,s,o,a,c,l,d=Fi){if(d!==Fi&&d!==qi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&d===Fi&&(n=Wi),n===void 0&&d===qi&&(n=Xi),super(null,r,s,o,a,c,d,n,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:Ct,this.minFilter=c!==void 0?c:Ct,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const zu=new dt,Hu=new ku(1,1);Hu.compareFunction=Ru;const Vu=new Lu,Gu=new jf,Wu=new Ou,ll=[],ul=[],dl=new Float32Array(16),hl=new Float32Array(9),fl=new Float32Array(4);function rr(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=ll[r];if(s===void 0&&(s=new Float32Array(r),ll[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function ht(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function ft(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Qs(i,e){let t=ul[e];t===void 0&&(t=new Int32Array(e),ul[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function c_(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function l_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ht(t,e))return;i.uniform2fv(this.addr,e),ft(t,e)}}function u_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(ht(t,e))return;i.uniform3fv(this.addr,e),ft(t,e)}}function d_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ht(t,e))return;i.uniform4fv(this.addr,e),ft(t,e)}}function h_(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ht(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),ft(t,e)}else{if(ht(t,n))return;fl.set(n),i.uniformMatrix2fv(this.addr,!1,fl),ft(t,n)}}function f_(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ht(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),ft(t,e)}else{if(ht(t,n))return;hl.set(n),i.uniformMatrix3fv(this.addr,!1,hl),ft(t,n)}}function p_(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ht(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),ft(t,e)}else{if(ht(t,n))return;dl.set(n),i.uniformMatrix4fv(this.addr,!1,dl),ft(t,n)}}function m_(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function g_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ht(t,e))return;i.uniform2iv(this.addr,e),ft(t,e)}}function __(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ht(t,e))return;i.uniform3iv(this.addr,e),ft(t,e)}}function x_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ht(t,e))return;i.uniform4iv(this.addr,e),ft(t,e)}}function v_(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function y_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ht(t,e))return;i.uniform2uiv(this.addr,e),ft(t,e)}}function M_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ht(t,e))return;i.uniform3uiv(this.addr,e),ft(t,e)}}function S_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ht(t,e))return;i.uniform4uiv(this.addr,e),ft(t,e)}}function b_(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);const s=this.type===i.SAMPLER_2D_SHADOW?Hu:zu;t.setTexture2D(e||s,r)}function E_(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Gu,r)}function T_(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Wu,r)}function A_(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Vu,r)}function w_(i){switch(i){case 5126:return c_;case 35664:return l_;case 35665:return u_;case 35666:return d_;case 35674:return h_;case 35675:return f_;case 35676:return p_;case 5124:case 35670:return m_;case 35667:case 35671:return g_;case 35668:case 35672:return __;case 35669:case 35673:return x_;case 5125:return v_;case 36294:return y_;case 36295:return M_;case 36296:return S_;case 35678:case 36198:case 36298:case 36306:case 35682:return b_;case 35679:case 36299:case 36307:return E_;case 35680:case 36300:case 36308:case 36293:return T_;case 36289:case 36303:case 36311:case 36292:return A_}}function R_(i,e){i.uniform1fv(this.addr,e)}function C_(i,e){const t=rr(e,this.size,2);i.uniform2fv(this.addr,t)}function I_(i,e){const t=rr(e,this.size,3);i.uniform3fv(this.addr,t)}function L_(i,e){const t=rr(e,this.size,4);i.uniform4fv(this.addr,t)}function P_(i,e){const t=rr(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function D_(i,e){const t=rr(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function N_(i,e){const t=rr(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function U_(i,e){i.uniform1iv(this.addr,e)}function F_(i,e){i.uniform2iv(this.addr,e)}function O_(i,e){i.uniform3iv(this.addr,e)}function B_(i,e){i.uniform4iv(this.addr,e)}function k_(i,e){i.uniform1uiv(this.addr,e)}function z_(i,e){i.uniform2uiv(this.addr,e)}function H_(i,e){i.uniform3uiv(this.addr,e)}function V_(i,e){i.uniform4uiv(this.addr,e)}function G_(i,e,t){const n=this.cache,r=e.length,s=Qs(t,r);ht(n,s)||(i.uniform1iv(this.addr,s),ft(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||zu,s[o])}function W_(i,e,t){const n=this.cache,r=e.length,s=Qs(t,r);ht(n,s)||(i.uniform1iv(this.addr,s),ft(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Gu,s[o])}function X_(i,e,t){const n=this.cache,r=e.length,s=Qs(t,r);ht(n,s)||(i.uniform1iv(this.addr,s),ft(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Wu,s[o])}function q_(i,e,t){const n=this.cache,r=e.length,s=Qs(t,r);ht(n,s)||(i.uniform1iv(this.addr,s),ft(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Vu,s[o])}function j_(i){switch(i){case 5126:return R_;case 35664:return C_;case 35665:return I_;case 35666:return L_;case 35674:return P_;case 35675:return D_;case 35676:return N_;case 5124:case 35670:return U_;case 35667:case 35671:return F_;case 35668:case 35672:return O_;case 35669:case 35673:return B_;case 5125:return k_;case 36294:return z_;case 36295:return H_;case 36296:return V_;case 35678:case 36198:case 36298:case 36306:case 35682:return G_;case 35679:case 36299:case 36307:return W_;case 35680:case 36300:case 36308:case 36293:return X_;case 36289:case 36303:case 36311:case 36292:return q_}}class Y_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=w_(t.type)}}class $_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=j_(t.type)}}class K_{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const ko=/(\w+)(\])?(\[|\.)?/g;function pl(i,e){i.seq.push(e),i.map[e.id]=e}function Z_(i,e,t){const n=i.name,r=n.length;for(ko.lastIndex=0;;){const s=ko.exec(n),o=ko.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){pl(t,l===void 0?new Y_(a,i,e):new $_(a,i,e));break}else{let u=t.map[a];u===void 0&&(u=new K_(a),pl(t,u)),t=u}}}class ws{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Z_(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],c=n[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function ml(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const J_=37297;let Q_=0;function ex(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function tx(i){const e=Xe.getPrimaries(Xe.workingColorSpace),t=Xe.getPrimaries(i);let n;switch(e===t?n="":e===zs&&t===ks?n="LinearDisplayP3ToLinearSRGB":e===ks&&t===zs&&(n="LinearSRGBToLinearDisplayP3"),i){case yt:case Zs:return[n,"LinearTransferOETF"];case Rt:case wa:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function gl(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+ex(i.getShaderSource(e),o)}else return r}function nx(i,e){const t=tx(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function ix(i,e){let t;switch(e){case qh:t="Linear";break;case jh:t="Reinhard";break;case Yh:t="OptimizedCineon";break;case $h:t="ACESFilmic";break;case Zh:t="AgX";break;case Jh:t="Neutral";break;case Kh:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function rx(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Tr).join(`
`)}function sx(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function ox(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Tr(i){return i!==""}function _l(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function xl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const ax=/^[ \t]*#include +<([\w\d./]+)>/gm;function ca(i){return i.replace(ax,lx)}const cx=new Map;function lx(i,e){let t=Ce[e];if(t===void 0){const n=cx.get(e);if(n!==void 0)t=Ce[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ca(t)}const ux=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function vl(i){return i.replace(ux,dx)}function dx(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function yl(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function hx(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===fu?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===xh?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===xn&&(e="SHADOWMAP_TYPE_VSM"),e}function fx(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Hi:case Vi:e="ENVMAP_TYPE_CUBE";break;case $s:e="ENVMAP_TYPE_CUBE_UV";break}return e}function px(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Vi:e="ENVMAP_MODE_REFRACTION";break}return e}function mx(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case pu:e="ENVMAP_BLENDING_MULTIPLY";break;case Wh:e="ENVMAP_BLENDING_MIX";break;case Xh:e="ENVMAP_BLENDING_ADD";break}return e}function gx(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function _x(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=hx(t),l=fx(t),d=px(t),u=mx(t),h=gx(t),f=rx(t),g=sx(s),_=r.createProgram();let p,m,S=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
    ...
    <p style="color:#9b8f78">Suggerimento: apri le porte con cautela, tieni Kristy vicina, e usa Vesna per colpire prima del contatto.</p>`;const t=document.createElement("button");t.textContent="Chiudi",t.style.cssText="margin-top:8px;padding:9px 16px;background:#e0892f;color:#15110d;border:none;border-radius:6px;cursor:pointer;font-weight:bold",t.onclick=()=>document.body.removeChild(i),e.appendChild(t),i.appendChild(e),document.body.appendChild(i)}const _a={impatto:"⚔",schivata:"✋",corazza:"⛨"},md=["impatto","schivata","corazza"],ru=Number(localStorage.getItem("dustfall.diceSpeed")??"1");let Mn=[0,1,2].includes(ru)?ru:1,xa=!1,ii=!1;function er(){return xa}function uy(){return Mn}function dy(){return Mn=Mn===1?2:Mn===2?0:1,localStorage.setItem("dustfall.diceSpeed",String(Mn)),Mn}let Dn=null;function hy(){return Dn||(Dn=document.createElement("div"),Dn.id="diceOverlay",Dn.style.display="none",Dn.addEventListener("pointerdown",()=>{ii=!0}),(document.querySelector(".board-wrap")??document.body).appendChild(Dn),Dn)}function Dr(i){return Mn===0||ii?Promise.resolve():new Promise(e=>setTimeout(e,i/Mn))}function su(i,e){const t=document.createElement("div");t.className="dov-row";const n=document.createElement("span");n.className="dov-label",n.textContent=i,t.appendChild(n);const r=[];for(let s=0;s<e;s++){const o=document.createElement("span");o.className="dov-die dov-rolling",o.textContent=_a[md[s%3]],t.appendChild(o),r.push(o)}return{row:t,dice:r}}async function ou(i,e,t){if(Mn!==0&&!ii)for(let r=0;r<13;r++){for(const s of i)s.textContent=_a[md[Math.random()*3|0]];if(await Dr(70),ii)break}for(let n=0;n<i.length;n++)i[n].classList.remove("dov-rolling"),i[n].textContent=_a[e[n]],i[n].classList.add(e[n]===t?"dov-hit":"dov-miss"),n<i.length-1&&await Dr(150)}async function fy(i,e,t,n){var o,a;if(i.length===0){t();return}xa=!0,ii=!1;const r=hy();r.style.display="flex";const s=c=>{ii||e(c)};for(const c of i){const l=c===i[i.length-1];r.innerHTML=`<div class="dov-card">
      ...
      </div>`;const d=r.querySelector(".dov-rows"),u=r.querySelector(".dov-result");(o=n==null?void 0:n.onEvent)==null||o.call(n,c);const h=su("Attacco",c.attackFaces.length);d.appendChild(h.row),s("dice"),await ou(h.dice,c.attackFaces,"impatto");const f=document.createElement("b");f.className="dov-tot",f.textContent=`${c.hits} colpi`,h.row.appendChild(f),await Dr(520);const g=c.shield==="corazza"?"Corazza":"Schivata",_=su(g,c.defendFaces.length);d.appendChild(_.row),s("dice"),await ou(_.dice,c.defendFaces,c.shield);const p=document.createElement("b");p.className="dov-tot",p.textContent=`${c.blocks} parati`,_.row.appendChild(p),await Dr(560),c.dmg>0?(u.innerHTML=`💥 <b>${c.dmg}</b> ${c.dmg===1?"DANNO":"DANNI"}`+(c.killed?' <span class="dov-kill">— ELIMINATO!</span>':""),u.classList.add("dov-dmg"),(l||!ii)&&e(c.killed?"down":"hit")):(u.textContent="Nessun danno",u.classList.add("dov-none")),(a=n==null?void 0:n.onResult)==null||a.call(n,c),await Dr(1400)}xa=!1,r.style.display="none",r.innerHTML="",t()}let gd=!0;function py(i){gd=i}function my(){var e;const i=((e=window.speechSynthesis)==null?void 0:e.getVoices())??[];return i.find(t=>{var n;return(n=t.lang)==null?void 0:n.toLowerCase().startsWith("it")})??i[0]}function gy(i,e){if(!gd||!("speechSynthesis"in window))return;window.speechSynthesis.cancel();const t=new SpeechSynthesisUtterance(i),n=my();n&&(t.voice=n),t.lang="it-IT",e==="custode"?(t.rate=.92,t.pitch=.7):(t.rate=1,t.pitch=1),window.speechSynthesis.speak(t)}const _d="dustfall:auto";function _y(i){localStorage.setItem(_d,JSON.stringify(i))}function xd(){const i=localStorage.getItem(_d);if(!i)return null;const e=JSON.parse(i);return e.combatQueue||(e.combatQueue=[]),e}function xy(i,e,t){const n=document.createElement("div");n.style.cssText="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(8,10,12,.9);z-index:70";const r=document.createElement("div");if(r.style.cssText="max-width:520px;margin:16px;padding:22px;border-radius:10px;background:#1a1410;border:1px solid #3a2f20;color:#e8ddc8",r.innerHTML=`<h1 style="margin:0;color:#e0892f;letter-spacing:4px;font-size:22px">DUSTFALL</h1>
    <div style="color:#9b8f78;font-size:12px;margin:2px 0 14px">wasteland crawler — scegli un'incursione</div>`,e){const s=document.createElement("button");s.textContent="▸ Continua partita salvata",s.style.cssText="display:block;width:100%;margin-bottom:12px;padding:10px;background:#7fae57;color:#15110d;border:none;border-radius:6px;cursor:pointer;font-weight:bold",s.onclick=()=>{document.body.removeChild(n),t.cont()},r.appendChild(s)}i.forEach((s,o)=>{const a=document.createElement("button");a.textContent=`${o+1}. ${s.quest.name}`,a.style.cssText="display:block;width:100%;text-align:left;margin:4px 0;padding:8px 10px;background:#2c2317;color:#e8ddc8;border:1px solid #3a2f20;border-radius:6px;cursor:pointer",a.onclick=()=>{document.body.removeChild(n),t.select(o)},r.appendChild(a)}),n.appendChild(r),document.body.appendChild(n)}function vy(i,e){const t=document.createElement("div");t.style.cssText="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(8,10,12,.85);z-index:60";const n=document.createElement("div");n.style.cssText="max-width:460px;margin:16px;padding:20px;border-radius:10px;background:#1a1410;border:1px solid #3a2f20;color:#e8ddc8",n.innerHTML=`<h2 style="margin:0 0 4px;color:#e0892f;letter-spacing:2px;font-size:16px">SCHIERA LA SQUADRA</h2>
    <div style="color:#9b8f78;font-size:12px;margin-bottom:10px">Scegli da 1 a 4 recuperatori.</div>`;const r=[];for(const o of i){const a=document.createElement("label");a.style.cssText="display:flex;gap:8px;align-items:center;padding:6px;cursor:pointer";const c=document.createElement("input");c.type="checkbox",c.checked=!0,r.push(c);const l=document.createElement("span");l.innerHTML=`<b style="color:${o.color}">${o.person}</b> — ${o.role} · ♥${o.body} ⚡${o.energy} ⚔${o.attack} ◈${o.defend}`,a.appendChild(c),a.appendChild(l),n.appendChild(a)}const s=document.createElement("button");s.textContent="Inizia la missione",s.style.cssText="margin-top:12px;padding:9px 14px;background:#e0892f;color:#15110d;border:none;border-radius:6px;cursor:pointer;font-weight:bold",s.onclick=()=>{const o=i.filter((a,c)=>r[c].checked);o.length!==0&&(document.body.removeChild(t),e(o))},n.appendChild(s),t.appendChild(n),document.body.appendChild(t)}let Ae,Qe,lr={wasDrag:()=>!1,centerOn:()=>{}},Ni=!0,Is=ry(),Ar=null,Ws=!1,Nr=!1,Xs=!1,qs=0,Ur=0,js=ya;const yy=new Set(["adrenalina","carica","schermo"]),My=new Set(["mira","soppressione","hackera"]);function Sy(i){if(i.gameOver)return i.won?"win":"lose";const e=i.monsters.filter(r=>r.alive&&i.grid[r.y][r.x].revealed),t=e.some(r=>r.type==="aberr"||r.type==="custode"),n=i.heroes.some(r=>r.alive&&e.some(s=>sn(r,s)))||e.some(r=>r.ranged&&i.heroes.some(s=>s.alive&&zr(i,r,s)));return t?"boss":n?"combat":e.length?"tension":"explore"}function by(){const i=Ae;if(i){for(const e of i.log.slice(qs))e.includes("tira il movimento")?Di("dice"):e.includes("apre una porta")?Di("door"):e.includes("raccoglie")?Di("pickup"):(e.includes("usa ")||e.includes("cura ")||e.includes("rianima"))&&Di("ability");qs=i.log.length}}function vd(){const i=Ae;if(!i||Nr)return;if(i.narrativeQueue.length===0){Ey();return}Nr=!0;const e=i.narrativeQueue.shift();Ni&&gy(e.text,e.voice),ay(e.text,e.voice,()=>{var t;(t=window.speechSynthesis)==null||t.cancel(),Nr=!1,vd()})}function Ey(){const i=Ae;i&&i.gameOver&&!Xs&&(Xs=!0,cy(i,{retry:()=>va(Ur,js),next:()=>va(Math.min(Ur+1,Ls.length-1),js),menu:()=>io(),hasNext:Ur<Ls.length-1}))}function _t(){if(er())return;const i=Ae;if(!i)return;const e=i.combatQueue.splice(0,i.combatQueue.length);if(e.length>0){fy(e,t=>Di(t),()=>_t(),{onEvent:t=>{if(!Qe)return;const n=Qe.units.get(t.attackerRef);if(n&&Ji(n,"attack"),t.attackerRef.startsWith("m")){const r=i.monsters.find(s=>"m"+s.id===t.attackerRef);r&&lr.centerOn(r.x,r.y)}},onResult:t=>{!Qe||t.dmg<=0||(Q0(Qe,t.targetRef),J0(Qe,t.targetRef,t.killed?`−${t.dmg} ☠`:`−${t.dmg}`,t.targetIsHero?"#ff6a45":"#ffd24a"))}});return}Qe&&dd(Qe,i),oy(i,yd,Ni,Is,uy()),by(),Ya(Sy(i)),_y(i),vd()}function br(i){return()=>{er()||i()}}const yd={rollMove:br(()=>{Ae&&(oh(Ae),Cs("Clicca una casella illuminata per muoverti."),_t())}),openDoor:br(()=>{Ae&&(ch(Ae),_t())}),endTurn:br(()=>{Ae&&(dh(Ae),_t())}),rangedMode:br(()=>{Ae&&(Ae.actionMode="ranged",Cs("Clicca un nemico in linea di tiro."),_t())}),selectHero(i){if(er()||!Ae)return;Ae.selId=i,Ae.actionMode="move",_t();const e=Ae.heroes.find(t=>t.id===i);e&&lr.centerOn(e.x,e.y)},ability(i){if(!(er()||!Ae)){if(yy.has(i)){ta(Ae,i),_t();return}Ar=i,Ws=My.has(i),Ae.actionMode="ability",Cs(Ws?"Clicca un nemico bersaglio.":"Clicca un compagno bersaglio."),_t()}},toggleVoice(){var i;Ni=!Ni,py(Ni),Ni||(i=window.speechSynthesis)==null||i.cancel(),_t()},toggleMusic(){Is=!Is,iy(Is),_t()},diceSpeed(){dy(),_t()},help(){ly()},menu(){var i;(i=window.speechSynthesis)==null||i.cancel(),io()},explore:br(()=>{Ae&&(ph(Ae),_t())})};function Ty(i,e){if(er()||!Ae||Ae.gameOver||Ae.phase!=="hero")return;const t=Ae,n=t.heroes.find(o=>o.id===t.selId),r=zi(t,i,e),s=ki(t,i,e);if(t.actionMode==="ranged"){r&&r.alive&&t.grid[e][i].revealed&&uh(t,r.id),t.actionMode="move",_t();return}if(t.actionMode==="ability"&&Ar){Ws&&r?ta(t,Ar,r.id,!0):!Ws&&s&&ta(t,Ar,s.id,!1),t.actionMode="move",Ar=null,_t();return}if(r&&r.alive&&t.grid[e][i].revealed){n&&sn(n,r)&&lh(t,r.id),_t();return}if(s){yd.selectHero(s.id);return}ah(t,i,e),_t()}function va(i,e){Ur=i,js=e,Qe&&ud(Qe),Ae=sh(Ls[i].quest,e),Qe=cd(document.getElementById("board"),Ae.quest),ld(Qe,Ae),Ga(Qe,document.getElementById("board")),qs=0,Xs=!1,Nr=!1,fd(),Cs("Seleziona un sopravvissuto e tira il movimento."),Ae.heroes[0]&&lr.centerOn(Ae.heroes[0].x,Ae.heroes[0].y),_t()}function Ay(){const i=xd();if(!i){io();return}Ae=i,Ur=0,js=ya,Qe&&ud(Qe),Qe=cd(document.getElementById("board"),Ae.quest),ld(Qe,Ae),Ga(Qe,document.getElementById("board")),qs=Ae.log.length,Xs=!1,Nr=!1,fd();const e=Ae.heroes.find(t=>t.alive);e&&lr.centerOn(e.x,e.y),_t()}function io(){xy(Ls,xd()!==null,{select:i=>vy(ya,e=>va(i,e)),cont:Ay})}async function wy(){const i=document.createElement("div");i.style.cssText="position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:#0b0e11;color:#c4d2dc;font:16px sans-serif;z-index:9999",i.textContent="Caricamento assetâ€¦ 0/0",document.body.appendChild(i);try{await y0((e,t)=>{i.textContent=`Caricamento assetâ€¦ ${e}/${t}`}),i.remove(),io()}catch(e){i.textContent="Errore nel caricamento degli asset. Ricarica la pagina.",i.style.color="#ff6b6b",console.error(e)}}const Ry=new Tv;(function i(){const e=Ry.getDelta();Qe&&(ey(Qe,e),Qe.renderer.render(Qe.scene,Qe.camera)),requestAnimationFrame(i)})();lr=ny(document.getElementById("board"),()=>Qe);ty(document.getElementById("board"),()=>Qe,Ty,(i,e)=>{if(!Ae||!Qe)return;const t=zi(Ae,i,e),n=ki(Ae,i,e);Z0(t&&t.alive&&Ae.grid[e][i].revealed?"m"+t.id:n&&n.alive?"h"+n.id:null),er()||dd(Qe,Ae)},(i,e,t,n)=>{if(!Ae)return;const r=zi(Ae,i,e),s=ki(Ae,i,e);r&&r.alive&&Ae.grid[e][i].revealed?iu(t,n,`<b style="color:${r.color}">${r.name}</b><br>â™¥ ${r.hp}/${r.body} Â· âš” ${r.attack} Â· â›¨ ${r.defend}`+(r.stunned?"<br>âš¡ stordito":"")):s&&s.alive&&iu(t,n,`<b style="color:${s.color}">${s.person}</b> â€” ${s.role}<br>â™¥ ${s.hp}/${s.maxhp} Â· âš¡ ${s.ep}/${s.maxep} Â· âœ‹ ${s.defend+s.defBuff}`)},lr.wasDrag);window.addEventListener("resize",()=>{const i=document.getElementById("board");Qe&&Ga(Qe,i)});wy();
