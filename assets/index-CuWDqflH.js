...
void main() {
	...
	`}function T0(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===zc||c===Hc,u=c===Vs||c===zs;if(l||u){let h=e.get(a);const d=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new lh(i)),h=l?t.fromEquirectangular(a,h):t.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),h.texture;if(h!==void 0)return h.texture;{const f=a.image;return l&&f&&f.height>0||u&&f&&s(f)?(t===null&&(t=new lh(i)),h=l?t.fromEquirectangular(a):t.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),a.addEventListener("dispose",r),h.texture):null}}}return a}function s(a){let c=0;const l=6;for(let u=0;u<l;u++)a[u]!==void 0&&c++;return c===l}function r(a){const c=a.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function b0(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&Ed("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function E0(i,e,t,n){const s={},r=new WeakMap;function o(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let m=0,p=_.length;m<p;m++)e.remove(_[m])}d.removeEventListener("dispose",o),delete s[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(h,d){return s[d.id]===!0||(d.addEventListener("dispose",o),s[d.id]=!0,t.memory.geometries++),d}function c(h){const d=h.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const f=h.morphAttributes;for(const g in f){const _=f[g];for(let m=0,p=_.length;m<p;m++)e.update(_[m],i.ARRAY_BUFFER)}}function l(h){const d=[],f=h.index,g=h.attributes.position;let _=0;if(f!==null){const y=f.array;_=f.version;for(let x=0,M=y.length;x<M;x+=3){const E=y[x+0],T=y[x+1],b=y[x+2];d.push(E,T,T,b,b,E)}}else if(g!==void 0){const y=g.array;_=g.version;for(let x=0,M=y.length/3-1;x<M;x+=3){const E=x+0,T=x+1,b=x+2;d.push(E,T,T,b,b,E)}}else return;const m=new(bd(d)?Pd:Id)(d,1);m.version=_;const p=r.get(h);p&&e.remove(p),r.set(h,m)}function u(h){const d=r.get(h);if(d){const f=h.index;f!==null&&d.version<f.version&&l(h)}else l(h);return r.get(h)}return{get:a,update:c,getWireframeAttribute:u}}function w0(i,e,t){let n;function s(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function c(d,f){i.drawElements(n,f,r,d*o),t.update(f,n,1)}function l(d,f,g){g!==0&&(i.drawElementsInstanced(n,f,r,d*o,g),t.update(f,n,g))}function u(d,f,g){if(g===0)return;const _=e.get("WEBGL_multi_draw");if(_===null)for(let m=0;m<g;m++)this.render(d[m]/o,f[m]);else{_.multiDrawElementsWEBGL(n,f,0,r,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}}function h(d,f,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)l(d[p]/o,f[p],_[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,_,0,g);let p=0;for(let y=0;y<g;y++)p+=f[y];for(let y=0;y<_.length;y++)t.update(p,n,_[y])}}this.setMode=s,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function A0(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(r/3);break;case i.LINES:t.lines+=a*(r/2);break;case i.LINE_STRIP:t.lines+=a*(r-1);break;case i.LINE_LOOP:t.lines+=a*r;break;case i.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function C0(i,e,t){const n=new WeakMap,s=new Dt;function r(o,a,c){const l=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let d=n.get(a);if(d===void 0||d.count!==h){let v=function(){A.dispose(),n.delete(a),a.removeEventListener("dispose",v)};var f=v;d!==void 0&&d.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],y=a.morphAttributes.normal||[],x=a.morphAttributes.color||[];let M=0;g===!0&&(M=1),_===!0&&(M=2),m===!0&&(M=3);let E=a.attributes.position.count*M,T=1;E>e.maxTextureSize&&(T=Math.ceil(E/e.maxTextureSize),E=e.maxTextureSize);const b=new Float32Array(E*T*4*h),A=new Ad(b,E,T,h);A.type=yi,A.needsUpdate=!0;const S=M*4;for(let R=0;R<h;R++){const P=p[R],D=y[R],O=x[R],B=E*T*4*R;for(let U=0;U<P.count;U++){const H=U*S;g===!0&&(s.fromBufferAttribute(P,U),b[B+H+0]=s.x,b[B+H+1]=s.y,b[B+H+2]=s.z,b[B+H+3]=0),_===!0&&(s.fromBufferAttribute(D,U),b[B+H+4]=s.x,b[B+H+5]=s.y,b[B+H+6]=s.z,b[B+H+7]=0),m===!0&&(s.fromBufferAttribute(O,U),b[B+H+8]=s.x,b[B+H+9]=s.y,b[B+H+10]=s.z,b[B+H+11]=O.itemSize===4?s.w:1)}}d={count:h,texture:A,size:new He(E,T)},n.set(a,d),a.addEventListener("dispose",v)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];const _=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(i,"morphTargetBaseInfluence",_),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function R0(i,e,t,n){let s=new WeakMap;function r(c){const l=n.render.frame,u=c.geometry,h=e.get(c,u);if(s.get(h)!==l&&(e.update(h),s.set(h,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),s.get(c)!==l&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;s.get(d)!==l&&(d.update(),s.set(d,l))}return h}function o(){s=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:o}}class Ud extends Qt{constructor(e,t,n,s,r,o,a,c,l,u=Fs){if(u!==Fs&&u!==Ws)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Fs&&(n=Hs),n===void 0&&u===Ws&&(n=Gs),super(null,s,r,o,a,c,u,n,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:un,this.minFilter=c!==void 0?c:un,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Fd=new Qt,kd=new Ud(1,1);kd.compareFunction=Td;const Bd=new Ad,Vd=new mg,zd=new Ld,fh=[],ph=[],mh=new Float32Array(16),gh=new Float32Array(9),_h=new Float32Array(4);function sr(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=fh[s];if(r===void 0&&(r=new Float32Array(s),fh[s]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(r,a)}return r}function wt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function At(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function La(i,e){let t=ph[e];t===void 0&&(t=new Int32Array(e),ph[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function I0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function P0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;i.uniform2fv(this.addr,e),At(t,e)}}function D0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(wt(t,e))return;i.uniform3fv(this.addr,e),At(t,e)}}function N0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;i.uniform4fv(this.addr,e),At(t,e)}}function L0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),At(t,e)}else{if(wt(t,n))return;_h.set(n),i.uniformMatrix2fv(this.addr,!1,_h),At(t,n)}}function O0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),At(t,e)}else{if(wt(t,n))return;gh.set(n),i.uniformMatrix3fv(this.addr,!1,gh),At(t,n)}}function U0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),At(t,e)}else{if(wt(t,n))return;mh.set(n),i.uniformMatrix4fv(this.addr,!1,mh),At(t,n)}}function F0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function k0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;i.uniform2iv(this.addr,e),At(t,e)}}function B0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(wt(t,e))return;i.uniform3iv(this.addr,e),At(t,e)}}function V0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;i.uniform4iv(this.addr,e),At(t,e)}}function z0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function H0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;i.uniform2uiv(this.addr,e),At(t,e)}}function G0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(wt(t,e))return;i.uniform3uiv(this.addr,e),At(t,e)}}function W0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;i.uniform4uiv(this.addr,e),At(t,e)}}function q0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);const r=this.type===i.SAMPLER_2D_SHADOW?kd:Fd;t.setTexture2D(e||r,s)}function X0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Vd,s)}function j0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||zd,s)}function Y0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Bd,s)}function $0(i){switch(i){case 5126:return I0;case 35664:return P0;case 35665:return D0;case 35666:return N0;case 35674:return L0;case 35675:return O0;case 35676:return U0;case 5124:case 35670:return F0;case 35667:case 35671:return k0;case 35668:case 35672:return B0;case 35669:case 35673:return V0;case 5125:return z0;case 36294:return H0;case 36295:return G0;case 36296:return W0;case 35678:case 36198:case 36298:case 36306:case 35682:return q0;case 35679:case 36299:case 36307:return X0;case 35680:case 36300:case 36308:case 36293:return j0;case 36289:case 36303:case 36311:case 36292:return Y0}}function Z0(i,e){i.uniform1fv(this.addr,e)}function K0(i,e){const t=sr(e,this.size,2);i.uniform2fv(this.addr,t)}function Q0(i,e){const t=sr(e,this.size,3);i.uniform3fv(this.addr,t)}function J0(i,e){const t=sr(e,this.size,4);i.uniform4fv(this.addr,t)}function ex(i,e){const t=sr(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function tx(i,e){const t=sr(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function nx(i,e){const t=sr(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function ix(i,e){i.uniform1iv(this.addr,e)}function sx(i,e){i.uniform2iv(this.addr,e)}function rx(i,e){i.uniform3iv(this.addr,e)}function ox(i,e){i.uniform4iv(this.addr,e)}function ax(i,e){i.uniform1uiv(this.addr,e)}function cx(i,e){i.uniform2uiv(this.addr,e)}function lx(i,e){i.uniform3uiv(this.addr,e)}function ux(i,e){i.uniform4uiv(this.addr,e)}function hx(i,e,t){const n=this.cache,s=e.length,r=La(t,s);wt(n,r)||(i.uniform1iv(this.addr,r),At(n,r));for(let o=0;o!==s;++o)t.setTexture2D(e[o]||Fd,r[o])}function dx(i,e,t){const n=this.cache,s=e.length,r=La(t,s);wt(n,r)||(i.uniform1iv(this.addr,r),At(n,r));for(let o=0;o!==s;++o)t.setTexture3D(e[o]||Vd,r[o])}function fx(i,e,t){const n=this.cache,s=e.length,r=La(t,s);wt(n,r)||(i.uniform1iv(this.addr,r),At(n,r));for(let o=0;o!==s;++o)t.setTextureCube(e[o]||zd,r[o])}function px(i,e,t){const n=this.cache,s=e.length,r=La(t,s);wt(n,r)||(i.uniform1iv(this.addr,r),At(n,r));for(let o=0;o!==s;++o)t.setTexture2DArray(e[o]||Bd,r[o])}function mx(i){switch(i){case 5126:return Z0;case 35664:return K0;case 35665:return Q0;case 35666:return J0;case 35674:return ex;case 35675:return tx;case 35676:return nx;case 5124:case 35670:return ix;case 35667:case 35671:return sx;case 35668:case 35672:return rx;case 35669:case 35673:return ox;case 5125:return ax;case 36294:return cx;case 36295:return lx;case 36296:return ux;case 35678:case 36198:case 36298:case 36306:case 35682:return hx;case 35679:case 36299:case 36307:return dx;case 35680:case 36300:case 36308:case 36293:return fx;case 36289:case 36303:case 36311:case 36292:return px}}class gx{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=$0(t.type)}}class _x{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=mx(t.type)}}class vx{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(e,t[a.id],n)}}}const Dc=/(\w+)(\])?(\[|\.)?/g;function vh(i,e){i.seq.push(e),i.map[e.id]=e}function xx(i,e,t){const n=i.name,s=n.length;for(Dc.lastIndex=0;;){const r=Dc.exec(n),o=Dc.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){vh(t,l===void 0?new gx(a,i,e):new _x(a,i,e));break}else{let h=t.map[a];h===void 0&&(h=new vx(a),vh(t,h)),t=h}}}class Ro{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),o=e.getUniformLocation(t,r.name);xx(r,o,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,o=t.length;r!==o;++r){const a=t[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const o=e[s];o.id in t&&n.push(o)}return n}}function xh(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const yx=37297;let Sx=0;function Mx(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function Tx(i){const e=et.getPrimaries(et.workingColorSpace),t=et.getPrimaries(i);let n;switch(e===t?n="":e===zo&&t===Vo?n="LinearDisplayP3ToLinearSRGB":e===Vo&&t===zo&&(n="LinearSRGBToLinearDisplayP3"),i){case Di:case Da:return[n,"LinearTransferOETF"];case Pn:case _l:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function yh(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+Mx(i.getShaderSource(e),o)}else return s}function bx(i,e){const t=Tx(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Ex(i,e){let t;switch(e){case Nm:t="Linear";break;case Lm:t="Reinhard";break;case Om:t="OptimizedCineon";break;case Um:t="ACESFilmic";break;case km:t="AgX";break;case Bm:t="Neutral";break;case Fm:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function wx(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(mr).join(`
`)}function Ax(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Cx(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function mr(i){return i!==""}function Sh(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Mh(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Rx=/^[ \t]*#include +<([\w\d./]+)>/gm;function Xc(i){return i.replace(Rx,Px)}const Ix=new Map;function Px(i,e){let t=ke[e];if(t===void 0){const n=Ix.get(e);if(n!==void 0)t=ke[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Xc(t)}const Dx=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Th(i){return i.replace(Dx,Nx)}function Nx(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function bh(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function Lx(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===fd?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===rm?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Zn&&(e="SHADOWMAP_TYPE_VSM"),e}function Ox(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Vs:case zs:e="ENVMAP_TYPE_CUBE";break;case Ia:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Ux(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case zs:e="ENVMAP_MODE_REFRACTION";break}return e}function Fx(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case pd:e="ENVMAP_BLENDING_MULTIPLY";break;case Pm:e="ENVMAP_BLENDING_MIX";break;case Dm:e="ENVMAP_BLENDING_ADD";break}return e}function kx(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Bx(i,e,t,n){const s=i.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=Lx(t),l=Ox(t),u=Ux(t),h=Fx(t),d=kx(t),f=wx(t),g=Ax(r),_=s.createProgram();let m,p,y=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const x=y+m+o,M=y+p+a,E=xh(s,s.VERTEX_SHADER,x),T=xh(s,s.FRAGMENT_SHADER,M);s.attachShader(_,E),s.attachShader(_,T),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function b(R){if(i.debug.checkShaderErrors){const P=s.getProgramInfoLog(_).trim(),D=s.getShaderInfoLog(E).trim(),O=s.getShaderInfoLog(T).trim();let B=!0,U=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(B=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,E,T);else{const H=yh(s,E,"vertex"),z=yh(s,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
Program Info Log: `+P+`
`+H+`
`+z)}else P!==""?console.warn("THREE.WebGLProgram: Program Info Log:",P):(D===""||O==="")&&(U=!1);U&&(R.diagnostics={runnable:B,programLog:P,vertexShader:{log:D,prefix:m},fragmentShader:{log:O,prefix:p}})}s.deleteShader(E),s.deleteShader(T),A=new Ro(s,_),S=Cx(s,_)}let A;this.getUniforms=function(){return A===void 0&&b(this),A};let S;this.getAttributes=function(){return S===void 0&&b(this),S};let v=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return v===!1&&(v=s.getProgramParameter(_,yx)),v},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Sx++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=E,this.fragmentShader=T,this}let Vx=0;class zx{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(s)===!1&&(o.add(s),s.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new Hx(e),t.set(e,n)),n}}class Hx{constructor(e){this.id=Vx++,this.code=e,this.usedTimes=0}}function Gx(i,e,t,n,s,r,o){const a=new xl,c=new zx,l=new Set,u=[],h=s.logarithmicDepthBuffer,d=s.vertexTextures;let f=s.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(S){return l.add(S),S===0?"uv":`uv${S}`}function m(S,v,R,P,D){const O=P.fog,B=D.geometry,U=S.isMeshStandardMaterial?P.environment:null,H=(S.isMeshStandardMaterial?t:e).get(S.envMap||U),z=H&&H.mapping===Ia?H.image.height:null,Z=g[S.type];S.precision!==null&&(f=s.getMaxPrecision(S.precision),f!==S.precision&&console.warn("THREE.WebGLProgram.getParameters:",S.precision,"not supported, using",f,"instead."));const ee=B.morphAttributes.position||B.morphAttributes.normal||B.morphAttributes.color,te=ee!==void 0?ee.length:0;let ve=0;B.morphAttributes.position!==void 0&&(ve=1),B.morphAttributes.normal!==void 0&&(ve=2),B.morphAttributes.color!==void 0&&(ve=3);let Oe,X,j,oe;if(Z){const nt=Dn[Z];Oe=nt.vertexShader,X=nt.fragmentShader}else Oe=S.vertexShader,X=S.fragmentShader,c.update(S),j=c.getVertexShaderID(S),oe=c.getFragmentShaderID(S);const re=i.getRenderTarget(),se=D.isInstancedMesh===!0,Re=D.isBatchedMesh===!0,Ue=!!S.map,N=!!S.matcap,Fe=!!H,Ge=!!S.aoMap,ct=!!S.lightMap,Y=!!S.bumpMap,ue=!!S.normalMap,Se=!!S.displacementMap,_e=!!S.emissiveMap,we=!!S.metalnessMap,I=!!S.roughnessMap,w=S.anisotropy>0,W=S.clearcoat>0,J=S.dispersion>0,ne=S.iridescence>0,ie=S.sheen>0,be=S.transmission>0,de=w&&!!S.anisotropyMap,fe=W&&!!S.clearcoatMap,Ve=W&&!!S.clearcoatNormalMap,ae=W&&!!S.clearcoatRoughnessMap,Te=ne&&!!S.iridescenceMap,We=ne&&!!S.iridescenceThicknessMap,De=ie&&!!S.sheenColorMap,pe=ie&&!!S.sheenRoughnessMap,ze=!!S.specularMap,Xe=!!S.specularColorMap,_t=!!S.specularIntensityMap,L=be&&!!S.transmissionMap,me=be&&!!S.thicknessMap,$=!!S.gradientMap,Q=!!S.alphaMap,le=S.alphaTest>0,Ne=!!S.alphaHash,Ze=!!S.extensions;let vt=Ti;S.toneMapped&&(re===null||re.isXRRenderTarget===!0)&&(vt=i.toneMapping);const Rt={shaderID:Z,shaderType:S.type,shaderName:S.name,vertexShader:Oe,fragmentShader:X,defines:S.defines,customVertexShaderID:j,customFragmentShaderID:oe,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:f,batching:Re,batchingColor:Re&&D._colorsTexture!==null,instancing:se,instancingColor:se&&D.instanceColor!==null,instancingMorph:se&&D.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:re===null?i.outputColorSpace:re.isXRRenderTarget===!0?re.texture.colorSpace:Di,alphaToCoverage:!!S.alphaToCoverage,map:Ue,matcap:N,envMap:Fe,envMapMode:Fe&&H.mapping,envMapCubeUVHeight:z,aoMap:Ge,lightMap:ct,bumpMap:Y,normalMap:ue,displacementMap:d&&Se,emissiveMap:_e,normalMapObjectSpace:ue&&S.normalMapType===Jm,normalMapTangentSpace:ue&&S.normalMapType===Md,metalnessMap:we,roughnessMap:I,anisotropy:w,anisotropyMap:de,clearcoat:W,clearcoatMap:fe,clearcoatNormalMap:Ve,clearcoatRoughnessMap:ae,dispersion:J,iridescence:ne,iridescenceMap:Te,iridescenceThicknessMap:We,sheen:ie,sheenColorMap:De,sheenRoughnessMap:pe,specularMap:ze,specularColorMap:Xe,specularIntensityMap:_t,transmission:be,transmissionMap:L,thicknessMap:me,gradientMap:$,opaque:S.transparent===!1&&S.blending===Us&&S.alphaToCoverage===!1,alphaMap:Q,alphaTest:le,alphaHash:Ne,combine:S.combine,mapUv:Ue&&_(S.map.channel),aoMapUv:Ge&&_(S.aoMap.channel),lightMapUv:ct&&_(S.lightMap.channel),bumpMapUv:Y&&_(S.bumpMap.channel),normalMapUv:ue&&_(S.normalMap.channel),displacementMapUv:Se&&_(S.displacementMap.channel),emissiveMapUv:_e&&_(S.emissiveMap.channel),metalnessMapUv:we&&_(S.metalnessMap.channel),roughnessMapUv:I&&_(S.roughnessMap.channel),anisotropyMapUv:de&&_(S.anisotropyMap.channel),clearcoatMapUv:fe&&_(S.clearcoatMap.channel),clearcoatNormalMapUv:Ve&&_(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ae&&_(S.clearcoatRoughnessMap.channel),iridescenceMapUv:Te&&_(S.iridescenceMap.channel),iridescenceThicknessMapUv:We&&_(S.iridescenceThicknessMap.channel),sheenColorMapUv:De&&_(S.sheenColorMap.channel),sheenRoughnessMapUv:pe&&_(S.sheenRoughnessMap.channel),specularMapUv:ze&&_(S.specularMap.channel),specularColorMapUv:Xe&&_(S.specularColorMap.channel),specularIntensityMapUv:_t&&_(S.specularIntensityMap.channel),transmissionMapUv:L&&_(S.transmissionMap.channel),thicknessMapUv:me&&_(S.thicknessMap.channel),alphaMapUv:Q&&_(S.alphaMap.channel),vertexTangents:!!B.attributes.tangent&&(ue||w),vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!B.attributes.color&&B.attributes.color.itemSize===4,pointsUvs:D.isPoints===!0&&!!B.attributes.uv&&(Ue||Q),fog:!!O,useFog:S.fog===!0,fogExp2:!!O&&O.isFogExp2,flatShading:S.flatShading===!0,sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:h,skinning:D.isSkinnedMesh===!0,morphTargets:B.morphAttributes.position!==void 0,morphNormals:B.morphAttributes.normal!==void 0,morphColors:B.morphAttributes.color!==void 0,morphTargetsCount:te,morphTextureStride:ve,numDirLights:v.directional.length,numPointLights:v.point.length,numSpotLights:v.spot.length,numSpotLightMaps:v.spotLightMap.length,numRectAreaLights:v.rectArea.length,numHemiLights:v.hemi.length,numDirLightShadows:v.directionalShadowMap.length,numPointLightShadows:v.pointShadowMap.length,numSpotLightShadows:v.spotShadowMap.length,numSpotLightShadowsWithMaps:v.numSpotLightShadowsWithMaps,numLightProbes:v.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:S.dithering,shadowMapEnabled:i.shadowMap.enabled&&R.length>0,shadowMapType:i.shadowMap.type,toneMapping:vt,decodeVideoTexture:Ue&&S.map.isVideoTexture===!0&&et.getTransfer(S.map.colorSpace)===lt,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===Jn,flipSided:S.side===Kt,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:Ze&&S.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:Ze&&S.extensions.multiDraw===!0&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return Rt.vertexUv1s=l.has(1),Rt.vertexUv2s=l.has(2),Rt.vertexUv3s=l.has(3),l.clear(),Rt}function p(S){const v=[];if(S.shaderID?v.push(S.shaderID):(v.push(S.customVertexShaderID),v.push(S.customFragmentShaderID)),S.defines!==void 0)for(const R in S.defines)v.push(R),v.push(S.defines[R]);return S.isRawShaderMaterial===!1&&(y(v,S),x(v,S),v.push(i.outputColorSpace)),v.push(S.customProgramCacheKey),v.join()}function y(S,v){S.push(v.precision),S.push(v.outputColorSpace),S.push(v.envMapMode),S.push(v.envMapCubeUVHeight),S.push(v.mapUv),S.push(v.alphaMapUv),S.push(v.lightMapUv),S.push(v.aoMapUv),S.push(v.bumpMapUv),S.push(v.normalMapUv),S.push(v.displacementMapUv),S.push(v.emissiveMapUv),S.push(v.metalnessMapUv),S.push(v.roughnessMapUv),S.push(v.anisotropyMapUv),S.push(v.clearcoatMapUv),S.push(v.clearcoatNormalMapUv),S.push(v.clearcoatRoughnessMapUv),S.push(v.iridescenceMapUv),S.push(v.iridescenceThicknessMapUv),S.push(v.sheenColorMapUv),S.push(v.sheenRoughnessMapUv),S.push(v.specularMapUv),S.push(v.specularColorMapUv),S.push(v.specularIntensityMapUv),S.push(v.transmissionMapUv),S.push(v.thicknessMapUv),S.push(v.combine),S.push(v.fogExp2),S.push(v.sizeAttenuation),S.push(v.morphTargetsCount),S.push(v.morphAttributeCount),S.push(v.numDirLights),S.push(v.numPointLights),S.push(v.numSpotLights),S.push(v.numSpotLightMaps),S.push(v.numHemiLights),S.push(v.numRectAreaLights),S.push(v.numDirLightShadows),S.push(v.numPointLightShadows),S.push(v.numSpotLightShadows),S.push(v.numSpotLightShadowsWithMaps),S.push(v.numLightProbes),S.push(v.shadowMapType),S.push(v.toneMapping),S.push(v.numClippingPlanes),S.push(v.numClipIntersection),S.push(v.depthPacking)}function x(S,v){a.disableAll(),v.supportsVertexTextures&&a.enable(0),v.instancing&&a.enable(1),v.instancingColor&&a.enable(2),v.instancingMorph&&a.enable(3),v.matcap&&a.enable(4),v.envMap&&a.enable(5),v.normalMapObjectSpace&&a.enable(6),v.normalMapTangentSpace&&a.enable(7),v.clearcoat&&a.enable(8),v.iridescence&&a.enable(9),v.alphaTest&&a.enable(10),v.vertexColors&&a.enable(11),v.vertexAlphas&&a.enable(12),v.vertexUv1s&&a.enable(13),v.vertexUv2s&&a.enable(14),v.vertexUv3s&&a.enable(15),v.vertexTangents&&a.enable(16),v.anisotropy&&a.enable(17),v.alphaHash&&a.enable(18),v.batching&&a.enable(19),v.dispersion&&a.enable(20),v.batchingColor&&a.enable(21),S.push(a.mask),a.disableAll(),v.fog&&a.enable(0),v.useFog&&a.enable(1),v.flatShading&&a.enable(2),v.logarithmicDepthBuffer&&a.enable(3),v.skinning&&a.enable(4),v.morphTargets&&a.enable(5),v.morphNormals&&a.enable(6),v.morphColors&&a.enable(7),v.premultipliedAlpha&&a.enable(8),v.shadowMapEnabled&&a.enable(9),v.doubleSided&&a.enable(10),v.flipSided&&a.enable(11),v.useDepthPacking&&a.enable(12),v.dithering&&a.enable(13),v.transmission&&a.enable(14),v.sheen&&a.enable(15),v.opaque&&a.enable(16),v.pointsUvs&&a.enable(17),v.decodeVideoTexture&&a.enable(18),v.alphaToCoverage&&a.enable(19),S.push(a.mask)}function M(S){const v=g[S.type];let R;if(v){const P=Dn[v];R=Ag.clone(P.uniforms)}else R=S.uniforms;return R}function E(S,v){let R;for(let P=0,D=u.length;P<D;P++){const O=u[P];if(O.cacheKey===v){R=O,++R.usedTimes;break}}return R===void 0&&(R=new Bx(i,v,S,r),u.push(R)),R}function T(S){if(--S.usedTimes===0){const v=u.indexOf(S);u[v]=u[u.length-1],u.pop(),S.destroy()}}function b(S){c.remove(S)}function A(){c.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:M,acquireProgram:E,releaseProgram:T,releaseShaderCache:b,programs:u,dispose:A}}function Wx(){let i=new WeakMap;function e(r){let o=i.get(r);return o===void 0&&(o={},i.set(r,o)),o}function t(r){i.delete(r)}function n(r,o,a){i.get(r)[o]=a}function s(){i=new WeakMap}return{get:e,remove:t,update:n,dispose:s}}function qx(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function Eh(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function wh(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function o(h,d,f,g,_,m){let p=i[e];return p===void 0?(p={id:h.id,object:h,geometry:d,material:f,groupOrder:g,renderOrder:h.renderOrder,z:_,group:m},i[e]=p):(p.id=h.id,p.object=h,p.geometry=d,p.material=f,p.groupOrder=g,p.renderOrder=h.renderOrder,p.z=_,p.group=m),e++,p}function a(h,d,f,g,_,m){const p=o(h,d,f,g,_,m);f.transmission>0?n.push(p):f.transparent===!0?s.push(p):t.push(p)}function c(h,d,f,g,_,m){const p=o(h,d,f,g,_,m);f.transmission>0?n.unshift(p):f.transparent===!0?s.unshift(p):t.unshift(p)}function l(h,d){t.length>1&&t.sort(h||qx),n.length>1&&n.sort(d||Eh),s.length>1&&s.sort(d||Eh)}function u(){for(let h=e,d=i.length;h<d;h++){const f=i[h];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:a,unshift:c,finish:u,sort:l}}function Xx(){let i=new WeakMap;function e(n,s){const r=i.get(n);let o;return r===void 0?(o=new wh,i.set(n,[o])):s>=r.length?(o=new wh,r.push(o)):o=r[s],o}function t(){i=new WeakMap}return{get:e,dispose:t}}function jx(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new V,color:new Ye};break;case"SpotLight":t={position:new V,direction:new V,color:new Ye,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new V,color:new Ye,distance:0,decay:0};break;case"HemisphereLight":t={direction:new V,skyColor:new Ye,groundColor:new Ye};break;case"RectAreaLight":t={color:new Ye,position:new V,halfWidth:new V,halfHeight:new V};break}return i[e.id]=t,t}}}function Yx(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new He};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new He};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new He,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let $x=0;function Zx(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function Kx(i){const e=new jx,t=Yx(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new V);const s=new V,r=new gt,o=new gt;function a(l){let u=0,h=0,d=0;for(let S=0;S<9;S++)n.probe[S].set(0,0,0);let f=0,g=0,_=0,m=0,p=0,y=0,x=0,M=0,E=0,T=0,b=0;l.sort(Zx);for(let S=0,v=l.length;S<v;S++){const R=l[S],P=R.color,D=R.intensity,O=R.distance,B=R.shadow&&R.shadow.map?R.shadow.map.texture:null;if(R.isAmbientLight)u+=P.r*D,h+=P.g*D,d+=P.b*D;else if(R.isLightProbe){for(let U=0;U<9;U++)n.probe[U].addScaledVector(R.sh.coefficients[U],D);b++}else if(R.isDirectionalLight){const U=e.get(R);if(U.color.copy(R.color).multiplyScalar(R.intensity),R.castShadow){const H=R.shadow,z=t.get(R);z.shadowBias=H.bias,z.shadowNormalBias=H.normalBias,z.shadowRadius=H.radius,z.shadowMapSize=H.mapSize,n.directionalShadow[f]=z,n.directionalShadowMap[f]=B,n.directionalShadowMatrix[f]=R.shadow.matrix,y++}n.directional[f]=U,f++}else if(R.isSpotLight){const U=e.get(R);U.position.setFromMatrixPosition(R.matrixWorld),U.color.copy(P).multiplyScalar(D),U.distance=O,U.coneCos=Math.cos(R.angle),U.penumbraCos=Math.cos(R.angle*(1-R.penumbra)),U.decay=R.decay,n.spot[_]=U;const H=R.shadow;if(R.map&&(n.spotLightMap[E]=R.map,E++,H.updateMatrices(R),R.castShadow&&T++),n.spotLightMatrix[_]=H.matrix,R.castShadow){const z=t.get(R);z.shadowBias=H.bias,z.shadowNormalBias=H.normalBias,z.shadowRadius=H.radius,z.shadowMapSize=H.mapSize,n.spotShadow[_]=z,n.spotShadowMap[_]=B,M++}_++}else if(R.isRectAreaLight){const U=e.get(R);U.color.copy(P).multiplyScalar(D),U.halfWidth.set(R.width*.5,0,0),U.halfHeight.set(0,R.height*.5,0),n.rectArea[m]=U,m++}else if(R.isPointLight){const U=e.get(R);if(U.color.copy(R.color).multiplyScalar(R.intensity),U.distance=R.distance,U.decay=R.decay,R.castShadow){const H=R.shadow,z=t.get(R);z.shadowBias=H.bias,z.shadowNormalBias=H.normalBias,z.shadowRadius=H.radius,z.shadowMapSize=H.mapSize,z.shadowCameraNear=H.camera.near,z.shadowCameraFar=H.camera.far,n.pointShadow[g]=z,n.pointShadowMap[g]=B,n.pointShadowMatrix[g]=R.shadow.matrix,x++}n.point[g]=U,g++}else if(R.isHemisphereLight){const U=e.get(R);U.skyColor.copy(R.color).multiplyScalar(D),U.groundColor.copy(R.groundColor).multiplyScalar(D),n.hemi[p]=U,p++}}m>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=he.LTC_FLOAT_1,n.rectAreaLTC2=he.LTC_FLOAT_2):(n.rectAreaLTC1=he.LTC_HALF_1,n.rectAreaLTC2=he.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=h,n.ambient[2]=d;const A=n.hash;(A.directionalLength!==f||A.pointLength!==g||A.spotLength!==_||A.rectAreaLength!==m||A.hemiLength!==p||A.numDirectionalShadows!==y||A.numPointShadows!==x||A.numSpotShadows!==M||A.numSpotMaps!==E||A.numLightProbes!==b)&&(n.directional.length=f,n.spot.length=_,n.rectArea.length=m,n.point.length=g,n.hemi.length=p,n.directionalShadow.length=y,n.directionalShadowMap.length=y,n.pointShadow.length=x,n.pointShadowMap.length=x,n.spotShadow.length=M,n.spotShadowMap.length=M,n.directionalShadowMatrix.length=y,n.pointShadowMatrix.length=x,n.spotLightMatrix.length=M+E-T,n.spotLightMap.length=E,n.numSpotLightShadowsWithMaps=T,n.numLightProbes=b,A.directionalLength=f,A.pointLength=g,A.spotLength=_,A.rectAreaLength=m,A.hemiLength=p,A.numDirectionalShadows=y,A.numPointShadows=x,A.numSpotShadows=M,A.numSpotMaps=E,A.numLightProbes=b,n.version=$x++)}function c(l,u){let h=0,d=0,f=0,g=0,_=0;const m=u.matrixWorldInverse;for(let p=0,y=l.length;p<y;p++){const x=l[p];if(x.isDirectionalLight){const M=n.directional[h];M.direction.setFromMatrixPosition(x.matrixWorld),s.setFromMatrixPosition(x.target.matrixWorld),M.direction.sub(s),M.direction.transformDirection(m),h++}else if(x.isSpotLight){const M=n.spot[f];M.position.setFromMatrixPosition(x.matrixWorld),M.position.applyMatrix4(m),M.direction.setFromMatrixPosition(x.matrixWorld),s.setFromMatrixPosition(x.target.matrixWorld),M.direction.sub(s),M.direction.transformDirection(m),f++}else if(x.isRectAreaLight){const M=n.rectArea[g];M.position.setFromMatrixPosition(x.matrixWorld),M.position.applyMatrix4(m),o.identity(),r.copy(x.matrixWorld),r.premultiply(m),o.extractRotation(r),M.halfWidth.set(x.width*.5,0,0),M.halfHeight.set(0,x.height*.5,0),M.halfWidth.applyMatrix4(o),M.halfHeight.applyMatrix4(o),g++}else if(x.isPointLight){const M=n.point[d];M.position.setFromMatrixPosition(x.matrixWorld),M.position.applyMatrix4(m),d++}else if(x.isHemisphereLight){const M=n.hemi[_];M.direction.setFromMatrixPosition(x.matrixWorld),M.direction.transformDirection(m),_++}}}return{setup:a,setupView:c,state:n}}function Ah(i){const e=new Kx(i),t=[],n=[];function s(u){l.camera=u,t.length=0,n.length=0}function r(u){t.push(u)}function o(u){n.push(u)}function a(){e.setup(t)}function c(u){e.setupView(t,u)}const l={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:s,state:l,setupLights:a,setupLightsView:c,pushLight:r,pushShadow:o}}function Qx(i){let e=new WeakMap;function t(s,r=0){const o=e.get(s);let a;return o===void 0?(a=new Ah(i),e.set(s,[a])):r>=o.length?(a=new Ah(i),o.push(a)):a=o[r],a}function n(){e=new WeakMap}return{get:t,dispose:n}}class Jx extends Br{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Km,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class ey extends Br{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const ty=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function iy(i,e,t){let n=new yl;const s=new He,r=new He,o=new Dt,a=new Jx({depthPacking:Qm}),c=new ey,l={},u=t.maxTextureSize,h={[wi]:Kt,[Kt]:wi,[Jn]:Jn},d=new Ci({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new He},radius:{value:4}},vertexShader:ty,fragmentShader:ny}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new bn;g.setAttribute("position",new On(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new bt(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=fd;let p=this.type;this.render=function(T,b,A){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;const S=i.getRenderTarget(),v=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),P=i.state;P.setBlending(Mi),P.buffers.color.setClear(1,1,1,1),P.buffers.depth.setTest(!0),P.setScissorTest(!1);const D=p!==Zn&&this.type===Zn,O=p===Zn&&this.type!==Zn;for(let B=0,U=T.length;B<U;B++){const H=T[B],z=H.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",H,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;s.copy(z.mapSize);const Z=z.getFrameExtents();if(s.multiply(Z),r.copy(z.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/Z.x),s.x=r.x*Z.x,z.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/Z.y),s.y=r.y*Z.y,z.mapSize.y=r.y)),z.map===null||D===!0||O===!0){const te=this.type!==Zn?{minFilter:un,magFilter:un}:{};z.map!==null&&z.map.dispose(),z.map=new ns(s.x,s.y,te),z.map.texture.name=H.name+".shadowMap",z.camera.updateProjectionMatrix()}i.setRenderTarget(z.map),i.clear();const ee=z.getViewportCount();for(let te=0;te<ee;te++){const ve=z.getViewport(te);o.set(r.x*ve.x,r.y*ve.y,r.x*ve.z,r.y*ve.w),P.viewport(o),z.updateMatrices(H,te),n=z.getFrustum(),M(b,A,z.camera,H,this.type)}z.isPointLightShadow!==!0&&this.type===Zn&&y(z,A),z.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(S,v,R)};function y(T,b){const A=e.update(_);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new ns(s.x,s.y)),d.uniforms.shadow_pass.value=T.map.texture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,i.setRenderTarget(T.mapPass),i.clear(),i.renderBufferDirect(b,null,A,d,_,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,i.setRenderTarget(T.map),i.clear(),i.renderBufferDirect(b,null,A,f,_,null)}function x(T,b,A,S){let v=null;const R=A.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(R!==void 0)v=R;else if(v=A.isPointLight===!0?c:a,i.localClippingEnabled&&b.clipShadows===!0&&Array.isArray(b.clippingPlanes)&&b.clippingPlanes.length!==0||b.displacementMap&&b.displacementScale!==0||b.alphaMap&&b.alphaTest>0||b.map&&b.alphaTest>0){const P=v.uuid,D=b.uuid;let O=l[P];O===void 0&&(O={},l[P]=O);let B=O[D];B===void 0&&(B=v.clone(),O[D]=B,b.addEventListener("dispose",E)),v=B}if(v.visible=b.visible,v.wireframe=b.wireframe,S===Zn?v.side=b.shadowSide!==null?b.shadowSide:b.side:v.side=b.shadowSide!==null?b.shadowSide:h[b.side],v.alphaMap=b.alphaMap,v.alphaTest=b.alphaTest,v.map=b.map,v.clipShadows=b.clipShadows,v.clippingPlanes=b.clippingPlanes,v.clipIntersection=b.clipIntersection,v.displacementMap=b.displacementMap,v.displacementScale=b.displacementScale,v.displacementBias=b.displacementBias,v.wireframeLinewidth=b.wireframeLinewidth,v.linewidth=b.linewidth,A.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const P=i.properties.get(v);P.light=A}return v}function M(T,b,A,S,v){if(T.visible===!1)return;if(T.layers.test(b.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&v===Zn)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(A.matrixWorldInverse,T.matrixWorld);const D=e.update(T),O=T.material;if(Array.isArray(O)){const B=D.groups;for(let U=0,H=B.length;U<H;U++){const z=B[U],Z=O[z.materialIndex];if(Z&&Z.visible){const ee=x(T,Z,S,v);T.onBeforeShadow(i,T,b,A,D,ee,z),i.renderBufferDirect(A,null,D,ee,T,z),T.onAfterShadow(i,T,b,A,D,ee,z)}}}else if(O.visible){const B=x(T,O,S,v);T.onBeforeShadow(i,T,b,A,D,B,null),i.renderBufferDirect(A,null,D,B,T,null),T.onAfterShadow(i,T,b,A,D,B,null)}}const P=T.children;for(let D=0,O=P.length;D<O;D++)M(P[D],b,A,S,v)}function E(T){T.target.removeEventListener("dispose",E);for(const A in l){const S=l[A],v=T.target.uuid;v in S&&(S[v].dispose(),delete S[v])}}}function sy(i){function e(){let L=!1;const me=new Dt;let $=null;const Q=new Dt(0,0,0,0);return{setMask:function(le){$!==le&&!L&&(i.colorMask(le,le,le,le),$=le)},setLocked:function(le){L=le},setClear:function(le,Ne,Ze,vt,Rt){Rt===!0&&(le*=vt,Ne*=vt,Ze*=vt),me.set(le,Ne,Ze,vt),Q.equals(me)===!1&&(i.clearColor(le,Ne,Ze,vt),Q.copy(me))},reset:function(){L=!1,$=null,Q.set(-1,0,0,0)}}}function t(){let L=!1,me=null,$=null,Q=null;return{setTest:function(le){le?oe(i.DEPTH_TEST):re(i.DEPTH_TEST)},setMask:function(le){me!==le&&!L&&(i.depthMask(le),me=le)},setFunc:function(le){if($!==le){switch(le){case bm:i.depthFunc(i.NEVER);break;case Em:i.depthFunc(i.ALWAYS);break;case wm:i.depthFunc(i.LESS);break;case Fo:i.depthFunc(i.LEQUAL);break;case Am:i.depthFunc(i.EQUAL);break;case Cm:i.depthFunc(i.GEQUAL);break;case Rm:i.depthFunc(i.GREATER);break;case Im:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}$=le}},setLocked:function(le){L=le},setClear:function(le){Q!==le&&(i.clearDepth(le),Q=le)},reset:function(){L=!1,me=null,$=null,Q=null}}}function n(){let L=!1,me=null,$=null,Q=null,le=null,Ne=null,Ze=null,vt=null,Rt=null;return{setTest:function(nt){L||(nt?oe(i.STENCIL_TEST):re(i.STENCIL_TEST))},setMask:function(nt){me!==nt&&!L&&(i.stencilMask(nt),me=nt)},setFunc:function(nt,Cn,Rn){($!==nt||Q!==Cn||le!==Rn)&&(i.stencilFunc(nt,Cn,Rn),$=nt,Q=Cn,le=Rn)},setOp:function(nt,Cn,Rn){(Ne!==nt||Ze!==Cn||vt!==Rn)&&(i.stencilOp(nt,Cn,Rn),Ne=nt,Ze=Cn,vt=Rn)},setLocked:function(nt){L=nt},setClear:function(nt){Rt!==nt&&(i.clearStencil(nt),Rt=nt)},reset:function(){L=!1,me=null,$=null,Q=null,le=null,Ne=null,Ze=null,vt=null,Rt=null}}}const s=new e,r=new t,o=new n,a=new WeakMap,c=new WeakMap;let l={},u={},h=new WeakMap,d=[],f=null,g=!1,_=null,m=null,p=null,y=null,x=null,M=null,E=null,T=new Ye(0,0,0),b=0,A=!1,S=null,v=null,R=null,P=null,D=null;const O=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,U=0;const H=i.getParameter(i.VERSION);H.indexOf("WebGL")!==-1?(U=parseFloat(/^WebGL (\d)/.exec(H)[1]),B=U>=1):H.indexOf("OpenGL ES")!==-1&&(U=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),B=U>=2);let z=null,Z={};const ee=i.getParameter(i.SCISSOR_BOX),te=i.getParameter(i.VIEWPORT),ve=new Dt().fromArray(ee),Oe=new Dt().fromArray(te);function X(L,me,$,Q){const le=new Uint8Array(4),Ne=i.createTexture();i.bindTexture(L,Ne),i.texParameteri(L,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(L,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ze=0;Ze<$;Ze++)L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY?i.texImage3D(me,0,i.RGBA,1,1,Q,0,i.RGBA,i.UNSIGNED_BYTE,le):i.texImage2D(me+Ze,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,le);return Ne}const j={};j[i.TEXTURE_2D]=X(i.TEXTURE_2D,i.TEXTURE_2D,1),j[i.TEXTURE_CUBE_MAP]=X(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),j[i.TEXTURE_2D_ARRAY]=X(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),j[i.TEXTURE_3D]=X(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),o.setClear(0),oe(i.DEPTH_TEST),r.setFunc(Fo),Y(!1),ue(cu),oe(i.CULL_FACE),Ge(Mi);function oe(L){l[L]!==!0&&(i.enable(L),l[L]=!0)}function re(L){l[L]!==!1&&(i.disable(L),l[L]=!1)}function se(L,me){return u[L]!==me?(i.bindFramebuffer(L,me),u[L]=me,L===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=me),L===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=me),!0):!1}function Re(L,me){let $=d,Q=!1;if(L){$=h.get(me),$===void 0&&($=[],h.set(me,$));const le=L.textures;if($.length!==le.length||$[0]!==i.COLOR_ATTACHMENT0){for(let Ne=0,Ze=le.length;Ne<Ze;Ne++)$[Ne]=i.COLOR_ATTACHMENT0+Ne;$.length=le.length,Q=!0}}else $[0]!==i.BACK&&($[0]=i.BACK,Q=!0);Q&&i.drawBuffers($)}function Ue(L){return f!==L?(i.useProgram(L),f=L,!0):!1}const N={[qi]:i.FUNC_ADD,[am]:i.FUNC_SUBTRACT,[cm]:i.FUNC_REVERSE_SUBTRACT};N[lm]=i.MIN,N[um]=i.MAX;const Fe={[hm]:i.ZERO,[dm]:i.ONE,[fm]:i.SRC_COLOR,[Bc]:i.SRC_ALPHA,[xm]:i.SRC_ALPHA_SATURATE,[_m]:i.DST_COLOR,[mm]:i.DST_ALPHA,[pm]:i.ONE_MINUS_SRC_COLOR,[Vc]:i.ONE_MINUS_SRC_ALPHA,[vm]:i.ONE_MINUS_DST_COLOR,[gm]:i.ONE_MINUS_DST_ALPHA,[ym]:i.CONSTANT_COLOR,[Sm]:i.ONE_MINUS_CONSTANT_COLOR,[Mm]:i.CONSTANT_ALPHA,[Tm]:i.ONE_MINUS_CONSTANT_ALPHA};function Ge(L,me,$,Q,le,Ne,Ze,vt,Rt,nt){if(L===Mi){g===!0&&(re(i.BLEND),g=!1);return}if(g===!1&&(oe(i.BLEND),g=!0),L!==om){if(L!==_||nt!==A){if((m!==qi||x!==qi)&&(i.blendEquation(i.FUNC_ADD),m=qi,x=qi),nt)switch(L){case Us:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case lu:i.blendFunc(i.ONE,i.ONE);break;case uu:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case hu:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case Us:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case lu:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case uu:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case hu:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}p=null,y=null,M=null,E=null,T.set(0,0,0),b=0,_=L,A=nt}return}le=le||me,Ne=Ne||$,Ze=Ze||Q,(me!==m||le!==x)&&(i.blendEquationSeparate(N[me],N[le]),m=me,x=le),($!==p||Q!==y||Ne!==M||Ze!==E)&&(i.blendFuncSeparate(Fe[$],Fe[Q],Fe[Ne],Fe[Ze]),p=$,y=Q,M=Ne,E=Ze),(vt.equals(T)===!1||Rt!==b)&&(i.blendColor(vt.r,vt.g,vt.b,Rt),T.copy(vt),b=Rt),_=L,A=!1}function ct(L,me){L.side===Jn?re(i.CULL_FACE):oe(i.CULL_FACE);let $=L.side===Kt;me&&($=!$),Y($),L.blending===Us&&L.transparent===!1?Ge(Mi):Ge(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),r.setFunc(L.depthFunc),r.setTest(L.depthTest),r.setMask(L.depthWrite),s.setMask(L.colorWrite);const Q=L.stencilWrite;o.setTest(Q),Q&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),_e(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?oe(i.SAMPLE_ALPHA_TO_COVERAGE):re(i.SAMPLE_ALPHA_TO_COVERAGE)}function Y(L){S!==L&&(L?i.frontFace(i.CW):i.frontFace(i.CCW),S=L)}function ue(L){L!==im?(oe(i.CULL_FACE),L!==v&&(L===cu?i.cullFace(i.BACK):L===sm?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):re(i.CULL_FACE),v=L}function Se(L){L!==R&&(B&&i.lineWidth(L),R=L)}function _e(L,me,$){L?(oe(i.POLYGON_OFFSET_FILL),(P!==me||D!==$)&&(i.polygonOffset(me,$),P=me,D=$)):re(i.POLYGON_OFFSET_FILL)}function we(L){L?oe(i.SCISSOR_TEST):re(i.SCISSOR_TEST)}function I(L){L===void 0&&(L=i.TEXTURE0+O-1),z!==L&&(i.activeTexture(L),z=L)}function w(L,me,$){$===void 0&&(z===null?$=i.TEXTURE0+O-1:$=z);let Q=Z[$];Q===void 0&&(Q={type:void 0,texture:void 0},Z[$]=Q),(Q.type!==L||Q.texture!==me)&&(z!==$&&(i.activeTexture($),z=$),i.bindTexture(L,me||j[L]),Q.type=L,Q.texture=me)}function W(){const L=Z[z];L!==void 0&&L.type!==void 0&&(i.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function J(){try{i.compressedTexImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ne(){try{i.compressedTexImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ie(){try{i.texSubImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function be(){try{i.texSubImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function de(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function fe(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ve(){try{i.texStorage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ae(){try{i.texStorage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Te(){try{i.texImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function We(){try{i.texImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function De(L){ve.equals(L)===!1&&(i.scissor(L.x,L.y,L.z,L.w),ve.copy(L))}function pe(L){Oe.equals(L)===!1&&(i.viewport(L.x,L.y,L.z,L.w),Oe.copy(L))}function ze(L,me){let $=c.get(me);$===void 0&&($=new WeakMap,c.set(me,$));let Q=$.get(L);Q===void 0&&(Q=i.getUniformBlockIndex(me,L.name),$.set(L,Q))}function Xe(L,me){const Q=c.get(me).get(L);a.get(me)!==Q&&(i.uniformBlockBinding(me,Q,L.__bindingPointIndex),a.set(me,Q))}function _t(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),l={},z=null,Z={},u={},h=new WeakMap,d=[],f=null,g=!1,_=null,m=null,p=null,y=null,x=null,M=null,E=null,T=new Ye(0,0,0),b=0,A=!1,S=null,v=null,R=null,P=null,D=null,ve.set(0,0,i.canvas.width,i.canvas.height),Oe.set(0,0,i.canvas.width,i.canvas.height),s.reset(),r.reset(),o.reset()}return{buffers:{color:s,depth:r,stencil:o},enable:oe,disable:re,bindFramebuffer:se,drawBuffers:Re,useProgram:Ue,setBlending:Ge,setMaterial:ct,setFlipSided:Y,setCullFace:ue,setLineWidth:Se,setPolygonOffset:_e,setScissorTest:we,activeTexture:I,bindTexture:w,unbindTexture:W,compressedTexImage2D:J,compressedTexImage3D:ne,texImage2D:Te,texImage3D:We,updateUBOMapping:ze,uniformBlockBinding:Xe,texStorage2D:Ve,texStorage3D:ae,texSubImage2D:ie,texSubImage3D:be,compressedTexSubImage2D:de,compressedTexSubImage3D:fe,scissor:De,viewport:pe,reset:_t}}function ry(i,e,t,n,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new He,u=new WeakMap;let h;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(I,w){return f?new OffscreenCanvas(I,w):Go("canvas")}function _(I,w,W){let J=1;const ne=we(I);if((ne.width>W||ne.height>W)&&(J=W/Math.max(ne.width,ne.height)),J<1)if(typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&I instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&I instanceof ImageBitmap||typeof VideoFrame<"u"&&I instanceof VideoFrame){const ie=Math.floor(J*ne.width),be=Math.floor(J*ne.height);h===void 0&&(h=g(ie,be));const de=w?g(ie,be):h;return de.width=ie,de.height=be,de.getContext("2d").drawImage(I,0,0,ie,be),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+ie+"x"+be+")."),de}else return"data"in I&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),I;return I}function m(I){return I.generateMipmaps&&I.minFilter!==un&&I.minFilter!==yn}function p(I){i.generateMipmap(I)}function y(I,w,W,J,ne=!1){if(I!==null){if(i[I]!==void 0)return i[I];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+I+"'")}let ie=w;if(w===i.RED&&(W===i.FLOAT&&(ie=i.R32F),W===i.HALF_FLOAT&&(ie=i.R16F),W===i.UNSIGNED_BYTE&&(ie=i.R8)),w===i.RED_INTEGER&&(W===i.UNSIGNED_BYTE&&(ie=i.R8UI),W===i.UNSIGNED_SHORT&&(ie=i.R16UI),W===i.UNSIGNED_INT&&(ie=i.R32UI),W===i.BYTE&&(ie=i.R8I),W===i.SHORT&&(ie=i.R16I),W===i.INT&&(ie=i.R32I)),w===i.RG&&(W===i.FLOAT&&(ie=i.RG32F),W===i.HALF_FLOAT&&(ie=i.RG16F),W===i.UNSIGNED_BYTE&&(ie=i.RG8)),w===i.RG_INTEGER&&(W===i.UNSIGNED_BYTE&&(ie=i.RG8UI),W===i.UNSIGNED_SHORT&&(ie=i.RG16UI),W===i.UNSIGNED_INT&&(ie=i.RG32UI),W===i.BYTE&&(ie=i.RG8I),W===i.SHORT&&(ie=i.RG16I),W===i.INT&&(ie=i.RG32I)),w===i.RGB&&W===i.UNSIGNED_INT_5_9_9_9_REV&&(ie=i.RGB9_E5),w===i.RGBA){const be=ne?Bo:et.getTransfer(J);W===i.FLOAT&&(ie=i.RGBA32F),W===i.HALF_FLOAT&&(ie=i.RGBA16F),W===i.UNSIGNED_BYTE&&(ie=be===lt?i.SRGB8_ALPHA8:i.RGBA8),W===i.UNSIGNED_SHORT_4_4_4_4&&(ie=i.RGBA4),W===i.UNSIGNED_SHORT_5_5_5_1&&(ie=i.RGB5_A1)}return(ie===i.R16F||ie===i.R32F||ie===i.RG16F||ie===i.RG32F||ie===i.RGBA16F||ie===i.RGBA32F)&&e.get("EXT_color_buffer_float"),ie}function x(I,w){let W;return I?w===null||w===Hs||w===Gs?W=i.DEPTH24_STENCIL8:w===yi?W=i.DEPTH32F_STENCIL8:w===ko&&(W=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):w===null||w===Hs||w===Gs?W=i.DEPTH_COMPONENT24:w===yi?W=i.DEPTH_COMPONENT32F:w===ko&&(W=i.DEPTH_COMPONENT16),W}function M(I,w){return m(I)===!0||I.isFramebufferTexture&&I.minFilter!==un&&I.minFilter!==yn?Math.log2(Math.max(w.width,w.height))+1:I.mipmaps!==void 0&&I.mipmaps.length>0?I.mipmaps.length:I.isCompressedTexture&&Array.isArray(I.image)?w.mipmaps.length:1}function E(I){const w=I.target;w.removeEventListener("dispose",E),b(w),w.isVideoTexture&&u.delete(w)}function T(I){const w=I.target;w.removeEventListener("dispose",T),S(w)}function b(I){const w=n.get(I);if(w.__webglInit===void 0)return;const W=I.source,J=d.get(W);if(J){const ne=J[w.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&A(I),Object.keys(J).length===0&&d.delete(W)}n.remove(I)}function A(I){const w=n.get(I);i.deleteTexture(w.__webglTexture);const W=I.source,J=d.get(W);delete J[w.__cacheKey],o.memory.textures--}function S(I){const w=n.get(I);if(I.depthTexture&&I.depthTexture.dispose(),I.isWebGLCubeRenderTarget)for(let J=0;J<6;J++){if(Array.isArray(w.__webglFramebuffer[J]))for(let ne=0;ne<w.__webglFramebuffer[J].length;ne++)i.deleteFramebuffer(w.__webglFramebuffer[J][ne]);else i.deleteFramebuffer(w.__webglFramebuffer[J]);w.__webglDepthbuffer&&i.deleteRenderbuffer(w.__webglDepthbuffer[J])}else{if(Array.isArray(w.__webglFramebuffer))for(let J=0;J<w.__webglFramebuffer.length;J++)i.deleteFramebuffer(w.__webglFramebuffer[J]);else i.deleteFramebuffer(w.__webglFramebuffer);if(w.__webglDepthbuffer&&i.deleteRenderbuffer(w.__webglDepthbuffer),w.__webglMultisampledFramebuffer&&i.deleteFramebuffer(w.__webglMultisampledFramebuffer),w.__webglColorRenderbuffer)for(let J=0;J<w.__webglColorRenderbuffer.length;J++)w.__webglColorRenderbuffer[J]&&i.deleteRenderbuffer(w.__webglColorRenderbuffer[J]);w.__webglDepthRenderbuffer&&i.deleteRenderbuffer(w.__webglDepthRenderbuffer)}const W=I.textures;for(let J=0,ne=W.length;J<ne;J++){const ie=n.get(W[J]);ie.__webglTexture&&(i.deleteTexture(ie.__webglTexture),o.memory.textures--),n.remove(W[J])}n.remove(I)}let v=0;function R(){v=0}function P(){const I=v;return I>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+I+" texture units while this GPU supports only "+s.maxTextures),v+=1,I}function D(I){const w=[];return w.push(I.wrapS),w.push(I.wrapT),w.push(I.wrapR||0),w.push(I.magFilter),w.push(I.minFilter),w.push(I.anisotropy),w.push(I.internalFormat),w.push(I.format),w.push(I.type),w.push(I.generateMipmaps),w.push(I.premultiplyAlpha),w.push(I.flipY),w.push(I.unpackAlignment),w.push(I.colorSpace),w.join()}function O(I,w){const W=n.get(I);if(I.isVideoTexture&&Se(I),I.isRenderTargetTexture===!1&&I.version>0&&W.__version!==I.version){const J=I.image;if(J===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(J.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Oe(W,I,w);return}}t.bindTexture(i.TEXTURE_2D,W.__webglTexture,i.TEXTURE0+w)}function B(I,w){const W=n.get(I);if(I.version>0&&W.__version!==I.version){Oe(W,I,w);return}t.bindTexture(i.TEXTURE_2D_ARRAY,W.__webglTexture,i.TEXTURE0+w)}function U(I,w){const W=n.get(I);if(I.version>0&&W.__version!==I.version){Oe(W,I,w);return}t.bindTexture(i.TEXTURE_3D,W.__webglTexture,i.TEXTURE0+w)}function H(I,w){const W=n.get(I);if(I.version>0&&W.__version!==I.version){X(W,I,w);return}t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture,i.TEXTURE0+w)}const z={[Gc]:i.REPEAT,[$i]:i.CLAMP_TO_EDGE,[Wc]:i.MIRRORED_REPEAT},Z={[un]:i.NEAREST,[Vm]:i.NEAREST_MIPMAP_NEAREST,[eo]:i.NEAREST_MIPMAP_LINEAR,[yn]:i.LINEAR,[tc]:i.LINEAR_MIPMAP_NEAREST,[Zi]:i.LINEAR_MIPMAP_LINEAR},ee={[eg]:i.NEVER,[og]:i.ALWAYS,[tg]:i.LESS,[Td]:i.LEQUAL,[ng]:i.EQUAL,[rg]:i.GEQUAL,[ig]:i.GREATER,[sg]:i.NOTEQUAL};function te(I,w){if(w.type===yi&&e.has("OES_texture_float_linear")===!1&&(w.magFilter===yn||w.magFilter===tc||w.magFilter===eo||w.magFilter===Zi||w.minFilter===yn||w.minFilter===tc||w.minFilter===eo||w.minFilter===Zi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(I,i.TEXTURE_WRAP_S,z[w.wrapS]),i.texParameteri(I,i.TEXTURE_WRAP_T,z[w.wrapT]),(I===i.TEXTURE_3D||I===i.TEXTURE_2D_ARRAY)&&i.texParameteri(I,i.TEXTURE_WRAP_R,z[w.wrapR]),i.texParameteri(I,i.TEXTURE_MAG_FILTER,Z[w.magFilter]),i.texParameteri(I,i.TEXTURE_MIN_FILTER,Z[w.minFilter]),w.compareFunction&&(i.texParameteri(I,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(I,i.TEXTURE_COMPARE_FUNC,ee[w.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(w.magFilter===un||w.minFilter!==eo&&w.minFilter!==Zi||w.type===yi&&e.has("OES_texture_float_linear")===!1)return;if(w.anisotropy>1||n.get(w).__currentAnisotropy){const W=e.get("EXT_texture_filter_anisotropic");i.texParameterf(I,W.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(w.anisotropy,s.getMaxAnisotropy())),n.get(w).__currentAnisotropy=w.anisotropy}}}function ve(I,w){let W=!1;I.__webglInit===void 0&&(I.__webglInit=!0,w.addEventListener("dispose",E));const J=w.source;let ne=d.get(J);ne===void 0&&(ne={},d.set(J,ne));const ie=D(w);if(ie!==I.__cacheKey){ne[ie]===void 0&&(ne[ie]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,W=!0),ne[ie].usedTimes++;const be=ne[I.__cacheKey];be!==void 0&&(ne[I.__cacheKey].usedTimes--,be.usedTimes===0&&A(w)),I.__cacheKey=ie,I.__webglTexture=ne[ie].texture}return W}function Oe(I,w,W){let J=i.TEXTURE_2D;(w.isDataArrayTexture||w.isCompressedArrayTexture)&&(J=i.TEXTURE_2D_ARRAY),w.isData3DTexture&&(J=i.TEXTURE_3D);const ne=ve(I,w),ie=w.source;t.bindTexture(J,I.__webglTexture,i.TEXTURE0+W);const be=n.get(ie);if(ie.version!==be.__version||ne===!0){t.activeTexture(i.TEXTURE0+W);const de=et.getPrimaries(et.workingColorSpace),fe=w.colorSpace===xi?null:et.getPrimaries(w.colorSpace),Ve=w.colorSpace===xi||de===fe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,w.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,w.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,w.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ve);let ae=_(w.image,!1,s.maxTextureSize);ae=_e(w,ae);const Te=r.convert(w.format,w.colorSpace),We=r.convert(w.type);let De=y(w.internalFormat,Te,We,w.colorSpace,w.isVideoTexture);te(J,w);let pe;const ze=w.mipmaps,Xe=w.isVideoTexture!==!0,_t=be.__version===void 0||ne===!0,L=ie.dataReady,me=M(w,ae);if(w.isDepthTexture)De=x(w.format===Ws,w.type),_t&&(Xe?t.texStorage2D(i.TEXTURE_2D,1,De,ae.width,ae.height):t.texImage2D(i.TEXTURE_2D,0,De,ae.width,ae.height,0,Te,We,null));else if(w.isDataTexture)if(ze.length>0){Xe&&_t&&t.texStorage2D(i.TEXTURE_2D,me,De,ze[0].width,ze[0].height);for(let $=0,Q=ze.length;$<Q;$++)pe=ze[$],Xe?L&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,pe.width,pe.height,Te,We,pe.data):t.texImage2D(i.TEXTURE_2D,$,De,pe.width,pe.height,0,Te,We,pe.data);w.generateMipmaps=!1}else Xe?(_t&&t.texStorage2D(i.TEXTURE_2D,me,De,ae.width,ae.height),L&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ae.width,ae.height,Te,We,ae.data)):t.texImage2D(i.TEXTURE_2D,0,De,ae.width,ae.height,0,Te,We,ae.data);else if(w.isCompressedTexture)if(w.isCompressedArrayTexture){Xe&&_t&&t.texStorage3D(i.TEXTURE_2D_ARRAY,me,De,ze[0].width,ze[0].height,ae.depth);for(let $=0,Q=ze.length;$<Q;$++)if(pe=ze[$],w.format!==Ln)if(Te!==null)if(Xe){if(L)if(w.layerUpdates.size>0){for(const le of w.layerUpdates){const Ne=pe.width*pe.height;t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,le,pe.width,pe.height,1,Te,pe.data.slice(Ne*le,Ne*(le+1)),0,0)}w.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,0,pe.width,pe.height,ae.depth,Te,pe.data,0,0)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,$,De,pe.width,pe.height,ae.depth,0,pe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Xe?L&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,0,pe.width,pe.height,ae.depth,Te,We,pe.data):t.texImage3D(i.TEXTURE_2D_ARRAY,$,De,pe.width,pe.height,ae.depth,0,Te,We,pe.data)}else{Xe&&_t&&t.texStorage2D(i.TEXTURE_2D,me,De,ze[0].width,ze[0].height);for(let $=0,Q=ze.length;$<Q;$++)pe=ze[$],w.format!==Ln?Te!==null?Xe?L&&t.compressedTexSubImage2D(i.TEXTURE_2D,$,0,0,pe.width,pe.height,Te,pe.data):t.compressedTexImage2D(i.TEXTURE_2D,$,De,pe.width,pe.height,0,pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Xe?L&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,pe.width,pe.height,Te,We,pe.data):t.texImage2D(i.TEXTURE_2D,$,De,pe.width,pe.height,0,Te,We,pe.data)}else if(w.isDataArrayTexture)if(Xe){if(_t&&t.texStorage3D(i.TEXTURE_2D_ARRAY,me,De,ae.width,ae.height,ae.depth),L)if(w.layerUpdates.size>0){let $;switch(We){case i.UNSIGNED_BYTE:switch(Te){case i.ALPHA:$=1;break;case i.LUMINANCE:$=1;break;case i.LUMINANCE_ALPHA:$=2;break;case i.RGB:$=3;break;case i.RGBA:$=4;break;default:throw new Error(`Unknown texel size for format ${Te}.`)}break;case i.UNSIGNED_SHORT_4_4_4_4:case i.UNSIGNED_SHORT_5_5_5_1:case i.UNSIGNED_SHORT_5_6_5:$=1;break;default:throw new Error(`Unknown texel size for type ${We}.`)}const Q=ae.width*ae.height*$;for(const le of w.layerUpdates)t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,le,ae.width,ae.height,1,Te,We,ae.data.slice(Q*le,Q*(le+1)));w.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ae.width,ae.height,ae.depth,Te,We,ae.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,De,ae.width,ae.height,ae.depth,0,Te,We,ae.data);else if(w.isData3DTexture)Xe?(_t&&t.texStorage3D(i.TEXTURE_3D,me,De,ae.width,ae.height,ae.depth),L&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ae.width,ae.height,ae.depth,Te,We,ae.data)):t.texImage3D(i.TEXTURE_3D,0,De,ae.width,ae.height,ae.depth,0,Te,We,ae.data);else if(w.isFramebufferTexture){if(_t)if(Xe)t.texStorage2D(i.TEXTURE_2D,me,De,ae.width,ae.height);else{let $=ae.width,Q=ae.height;for(let le=0;le<me;le++)t.texImage2D(i.TEXTURE_2D,le,De,$,Q,0,Te,We,null),$>>=1,Q>>=1}}else if(ze.length>0){if(Xe&&_t){const $=we(ze[0]);t.texStorage2D(i.TEXTURE_2D,me,De,$.width,$.height)}for(let $=0,Q=ze.length;$<Q;$++)pe=ze[$],Xe?L&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,Te,We,pe):t.texImage2D(i.TEXTURE_2D,$,De,Te,We,pe);w.generateMipmaps=!1}else if(Xe){if(_t){const $=we(ae);t.texStorage2D(i.TEXTURE_2D,me,De,$.width,$.height)}L&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Te,We,ae)}else t.texImage2D(i.TEXTURE_2D,0,De,Te,We,ae);m(w)&&p(J),be.__version=ie.version,w.onUpdate&&w.onUpdate(w)}I.__version=w.version}function X(I,w,W){if(w.image.length!==6)return;const J=ve(I,w),ne=w.source;t.bindTexture(i.TEXTURE_CUBE_MAP,I.__webglTexture,i.TEXTURE0+W);const ie=n.get(ne);if(ne.version!==ie.__version||J===!0){t.activeTexture(i.TEXTURE0+W);const be=et.getPrimaries(et.workingColorSpace),de=w.colorSpace===xi?null:et.getPrimaries(w.colorSpace),fe=w.colorSpace===xi||be===de?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,w.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,w.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,w.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,fe);const Ve=w.isCompressedTexture||w.image[0].isCompressedTexture,ae=w.image[0]&&w.image[0].isDataTexture,Te=[];for(let Q=0;Q<6;Q++)!Ve&&!ae?Te[Q]=_(w.image[Q],!0,s.maxCubemapSize):Te[Q]=ae?w.image[Q].image:w.image[Q],Te[Q]=_e(w,Te[Q]);const We=Te[0],De=r.convert(w.format,w.colorSpace),pe=r.convert(w.type),ze=y(w.internalFormat,De,pe,w.colorSpace),Xe=w.isVideoTexture!==!0,_t=ie.__version===void 0||J===!0,L=ne.dataReady;let me=M(w,We);te(i.TEXTURE_CUBE_MAP,w);let $;if(Ve){Xe&&_t&&t.texStorage2D(i.TEXTURE_CUBE_MAP,me,ze,We.width,We.height);for(let Q=0;Q<6;Q++){$=Te[Q].mipmaps;for(let le=0;le<$.length;le++){const Ne=$[le];w.format!==Ln?De!==null?Xe?L&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,le,0,0,Ne.width,Ne.height,De,Ne.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,le,ze,Ne.width,Ne.height,0,Ne.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Xe?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,le,0,0,Ne.width,Ne.height,De,pe,Ne.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,le,ze,Ne.width,Ne.height,0,De,pe,Ne.data)}}}else{if($=w.mipmaps,Xe&&_t){$.length>0&&me++;const Q=we(Te[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,me,ze,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(ae){Xe?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Te[Q].width,Te[Q].height,De,pe,Te[Q].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,ze,Te[Q].width,Te[Q].height,0,De,pe,Te[Q].data);for(let le=0;le<$.length;le++){const Ze=$[le].image[Q].image;Xe?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,le+1,0,0,Ze.width,Ze.height,De,pe,Ze.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,le+1,ze,Ze.width,Ze.height,0,De,pe,Ze.data)}}else{Xe?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,De,pe,Te[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,ze,De,pe,Te[Q]);for(let le=0;le<$.length;le++){const Ne=$[le];Xe?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,le+1,0,0,De,pe,Ne.image[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,le+1,ze,De,pe,Ne.image[Q])}}}m(w)&&p(i.TEXTURE_CUBE_MAP),ie.__version=ne.version,w.onUpdate&&w.onUpdate(w)}I.__version=w.version}function j(I,w,W,J,ne,ie){const be=r.convert(W.format,W.colorSpace),de=r.convert(W.type),fe=y(W.internalFormat,be,de,W.colorSpace);if(!n.get(w).__hasExternalTextures){const ae=Math.max(1,w.width>>ie),Te=Math.max(1,w.height>>ie);ne===i.TEXTURE_3D||ne===i.TEXTURE_2D_ARRAY?t.texImage3D(ne,ie,fe,ae,Te,w.depth,0,be,de,null):t.texImage2D(ne,ie,fe,ae,Te,0,be,de,null)}t.bindFramebuffer(i.FRAMEBUFFER,I),ue(w)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,J,ne,n.get(W).__webglTexture,0,Y(w)):(ne===i.TEXTURE_2D||ne>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,J,ne,n.get(W).__webglTexture,ie),t.bindFramebuffer(i.FRAMEBUFFER,null)}function oe(I,w,W){if(i.bindRenderbuffer(i.RENDERBUFFER,I),w.depthBuffer){const J=w.depthTexture,ne=J&&J.isDepthTexture?J.type:null,ie=x(w.stencilBuffer,ne),be=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,de=Y(w);ue(w)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,de,ie,w.width,w.height):W?i.renderbufferStorageMultisample(i.RENDERBUFFER,de,ie,w.width,w.height):i.renderbufferStorage(i.RENDERBUFFER,ie,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,be,i.RENDERBUFFER,I)}else{const J=w.textures;for(let ne=0;ne<J.length;ne++){const ie=J[ne],be=r.convert(ie.format,ie.colorSpace),de=r.convert(ie.type),fe=y(ie.internalFormat,be,de,ie.colorSpace),Ve=Y(w);W&&ue(w)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ve,fe,w.width,w.height):ue(w)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ve,fe,w.width,w.height):i.renderbufferStorage(i.RENDERBUFFER,fe,w.width,w.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function re(I,w){if(w&&w.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,I),!(w.depthTexture&&w.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(w.depthTexture).__webglTexture||w.depthTexture.image.width!==w.width||w.depthTexture.image.height!==w.height)&&(w.depthTexture.image.width=w.width,w.depthTexture.image.height=w.height,w.depthTexture.needsUpdate=!0),O(w.depthTexture,0);const J=n.get(w.depthTexture).__webglTexture,ne=Y(w);if(w.depthTexture.format===Fs)ue(w)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0,ne):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0);else if(w.depthTexture.format===Ws)ue(w)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0,ne):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function se(I){const w=n.get(I),W=I.isWebGLCubeRenderTarget===!0;if(I.depthTexture&&!w.__autoAllocateDepthBuffer){if(W)throw new Error("target.depthTexture not supported in Cube render targets");re(w.__webglFramebuffer,I)}else if(W){w.__webglDepthbuffer=[];for(let J=0;J<6;J++)t.bindFramebuffer(i.FRAMEBUFFER,w.__webglFramebuffer[J]),w.__webglDepthbuffer[J]=i.createRenderbuffer(),oe(w.__webglDepthbuffer[J],I,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,w.__webglFramebuffer),w.__webglDepthbuffer=i.createRenderbuffer(),oe(w.__webglDepthbuffer,I,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function Re(I,w,W){const J=n.get(I);w!==void 0&&j(J.__webglFramebuffer,I,I.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),W!==void 0&&se(I)}function Ue(I){const w=I.texture,W=n.get(I),J=n.get(w);I.addEventListener("dispose",T);const ne=I.textures,ie=I.isWebGLCubeRenderTarget===!0,be=ne.length>1;if(be||(J.__webglTexture===void 0&&(J.__webglTexture=i.createTexture()),J.__version=w.version,o.memory.textures++),ie){W.__webglFramebuffer=[];for(let de=0;de<6;de++)if(w.mipmaps&&w.mipmaps.length>0){W.__webglFramebuffer[de]=[];for(let fe=0;fe<w.mipmaps.length;fe++)W.__webglFramebuffer[de][fe]=i.createFramebuffer()}else W.__webglFramebuffer[de]=i.createFramebuffer()}else{if(w.mipmaps&&w.mipmaps.length>0){W.__webglFramebuffer=[];for(let de=0;de<w.mipmaps.length;de++)W.__webglFramebuffer[de]=i.createFramebuffer()}else W.__webglFramebuffer=i.createFramebuffer();if(be)for(let de=0,fe=ne.length;de<fe;de++){const Ve=n.get(ne[de]);Ve.__webglTexture===void 0&&(Ve.__webglTexture=i.createTexture(),o.memory.textures++)}if(I.samples>0&&ue(I)===!1){W.__webglMultisampledFramebuffer=i.createFramebuffer(),W.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,W.__webglMultisampledFramebuffer);for(let de=0;de<ne.length;de++){const fe=ne[de];W.__webglColorRenderbuffer[de]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,W.__webglColorRenderbuffer[de]);const Ve=r.convert(fe.format,fe.colorSpace),ae=r.convert(fe.type),Te=y(fe.internalFormat,Ve,ae,fe.colorSpace,I.isXRRenderTarget===!0),We=Y(I);i.renderbufferStorageMultisample(i.RENDERBUFFER,We,Te,I.width,I.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,W.__webglColorRenderbuffer[de])}i.bindRenderbuffer(i.RENDERBUFFER,null),I.depthBuffer&&(W.__webglDepthRenderbuffer=i.createRenderbuffer(),oe(W.__webglDepthRenderbuffer,I,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ie){t.bindTexture(i.TEXTURE_CUBE_MAP,J.__webglTexture),te(i.TEXTURE_CUBE_MAP,w);for(let de=0;de<6;de++)if(w.mipmaps&&w.mipmaps.length>0)for(let fe=0;fe<w.mipmaps.length;fe++)j(W.__webglFramebuffer[de][fe],I,w,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+de,fe);else j(W.__webglFramebuffer[de],I,w,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+de,0);m(w)&&p(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(be){for(let de=0,fe=ne.length;de<fe;de++){const Ve=ne[de],ae=n.get(Ve);t.bindTexture(i.TEXTURE_2D,ae.__webglTexture),te(i.TEXTURE_2D,Ve),j(W.__webglFramebuffer,I,Ve,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,0),m(Ve)&&p(i.TEXTURE_2D)}t.unbindTexture()}else{let de=i.TEXTURE_2D;if((I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(de=I.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(de,J.__webglTexture),te(de,w),w.mipmaps&&w.mipmaps.length>0)for(let fe=0;fe<w.mipmaps.length;fe++)j(W.__webglFramebuffer[fe],I,w,i.COLOR_ATTACHMENT0,de,fe);else j(W.__webglFramebuffer,I,w,i.COLOR_ATTACHMENT0,de,0);m(w)&&p(de),t.unbindTexture()}I.depthBuffer&&se(I)}function N(I){const w=I.textures;for(let W=0,J=w.length;W<J;W++){const ne=w[W];if(m(ne)){const ie=I.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,be=n.get(ne).__webglTexture;t.bindTexture(ie,be),p(ie),t.unbindTexture()}}}const Fe=[],Ge=[];function ct(I){if(I.samples>0){if(ue(I)===!1){const w=I.textures,W=I.width,J=I.height;let ne=i.COLOR_BUFFER_BIT;const ie=I.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,be=n.get(I),de=w.length>1;if(de)for(let fe=0;fe<w.length;fe++)t.bindFramebuffer(i.FRAMEBUFFER,be.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,be.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,be.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,be.__webglFramebuffer);for(let fe=0;fe<w.length;fe++){if(I.resolveDepthBuffer&&(I.depthBuffer&&(ne|=i.DEPTH_BUFFER_BIT),I.stencilBuffer&&I.resolveStencilBuffer&&(ne|=i.STENCIL_BUFFER_BIT)),de){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,be.__webglColorRenderbuffer[fe]);const Ve=n.get(w[fe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ve,0)}i.blitFramebuffer(0,0,W,J,0,0,W,J,ne,i.NEAREST),c===!0&&(Fe.length=0,Ge.length=0,Fe.push(i.COLOR_ATTACHMENT0+fe),I.depthBuffer&&I.resolveDepthBuffer===!1&&(Fe.push(ie),Ge.push(ie),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Ge)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Fe))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),de)for(let fe=0;fe<w.length;fe++){t.bindFramebuffer(i.FRAMEBUFFER,be.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,be.__webglColorRenderbuffer[fe]);const Ve=n.get(w[fe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,be.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,Ve,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,be.__webglMultisampledFramebuffer)}else if(I.depthBuffer&&I.resolveDepthBuffer===!1&&c){const w=I.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[w])}}}function Y(I){return Math.min(s.maxSamples,I.samples)}function ue(I){const w=n.get(I);return I.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&w.__useRenderToTexture!==!1}function Se(I){const w=o.render.frame;u.get(I)!==w&&(u.set(I,w),I.update())}function _e(I,w){const W=I.colorSpace,J=I.format,ne=I.type;return I.isCompressedTexture===!0||I.isVideoTexture===!0||W!==Di&&W!==xi&&(et.getTransfer(W)===lt?(J!==Ln||ne!==Ai)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",W)),w}function we(I){return typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement?(l.width=I.naturalWidth||I.width,l.height=I.naturalHeight||I.height):typeof VideoFrame<"u"&&I instanceof VideoFrame?(l.width=I.displayWidth,l.height=I.displayHeight):(l.width=I.width,l.height=I.height),l}this.allocateTextureUnit=P,this.resetTextureUnits=R,this.setTexture2D=O,this.setTexture2DArray=B,this.setTexture3D=U,this.setTextureCube=H,this.rebindTextures=Re,this.setupRenderTarget=Ue,this.updateRenderTargetMipmap=N,this.updateMultisampleRenderTarget=ct,this.setupDepthRenderbuffer=se,this.setupFrameBufferTexture=j,this.useMultisampledRTT=ue}function oy(i,e){function t(n,s=xi){let r;const o=et.getTransfer(s);if(n===Ai)return i.UNSIGNED_BYTE;if(n===_d)return i.UNSIGNED_SHORT_4_4_4_4;if(n===vd)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Gm)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===zm)return i.BYTE;if(n===Hm)return i.SHORT;if(n===ko)return i.UNSIGNED_SHORT;if(n===gd)return i.INT;if(n===Hs)return i.UNSIGNED_INT;if(n===yi)return i.FLOAT;if(n===Pa)return i.HALF_FLOAT;if(n===Wm)return i.ALPHA;if(n===qm)return i.RGB;if(n===Ln)return i.RGBA;if(n===Xm)return i.LUMINANCE;if(n===jm)return i.LUMINANCE_ALPHA;if(n===Fs)return i.DEPTH_COMPONENT;if(n===Ws)return i.DEPTH_STENCIL;if(n===Ym)return i.RED;if(n===xd)return i.RED_INTEGER;if(n===$m)return i.RG;if(n===yd)return i.RG_INTEGER;if(n===Sd)return i.RGBA_INTEGER;if(n===nc||n===ic||n===sc||n===rc)if(o===lt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===nc)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ic)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===sc)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===rc)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===nc)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ic)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===sc)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===rc)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===du||n===fu||n===pu||n===mu)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===du)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===fu)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===pu)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===mu)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===gu||n===_u||n===vu)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===gu||n===_u)return o===lt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===vu)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===xu||n===yu||n===Su||n===Mu||n===Tu||n===bu||n===Eu||n===wu||n===Au||n===Cu||n===Ru||n===Iu||n===Pu||n===Du)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===xu)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===yu)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Su)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Mu)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Tu)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===bu)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Eu)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===wu)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Au)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Cu)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ru)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Iu)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Pu)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Du)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===oc||n===Nu||n===Lu)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===oc)return o===lt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Nu)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Lu)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Zm||n===Ou||n===Uu||n===Fu)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===oc)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ou)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Uu)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Fu)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Gs?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class ay extends vn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Si extends Bt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const cy={type:"move"};class Nc{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Si,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Si,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new V,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new V),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Si,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new V,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new V),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,o=null;const a=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){o=!0;for(const _ of e.hand.values()){const m=t.getJointPose(_,n),p=this._getHandJoint(l,_);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const u=l.joints["index-finger-tip"],h=l.joints["thumb-tip"],d=u.position.distanceTo(h.position),f=.02,g=.005;l.inputState.pinching&&d>f+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&d<=f-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(c.matrix.fromArray(r.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,r.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(r.linearVelocity)):c.hasLinearVelocity=!1,r.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(r.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(cy)))}return a!==null&&(a.visible=s!==null),c!==null&&(c.visible=r!==null),l!==null&&(l.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Si;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const ly=`
void main() {
...
void main() {
    ...
    <p style="color:#9b8f78">Suggerimento: apri le porte con cautela, tieni Kristy vicina, e usa Vesna per colpire prima del contatto.</p>`;const t=document.createElement("button");t.textContent="Chiudi",t.style.cssText="margin-top:8px;padding:9px 16px;background:#e0892f;color:#15110d;border:none;border-radius:6px;cursor:pointer;font-weight:bold",t.onclick=()=>document.body.removeChild(i),e.appendChild(t),i.appendChild(e),document.body.appendChild(i)}let Xd=!0;function Py(i){Xd=i}function Dy(){var e;const i=((e=window.speechSynthesis)==null?void 0:e.getVoices())??[];return i.find(t=>{var n;return(n=t.lang)==null?void 0:n.toLowerCase().startsWith("it")})??i[0]}function Ny(i,e){if(!Xd||!("speechSynthesis"in window))return;window.speechSynthesis.cancel();const t=new SpeechSynthesisUtterance(i),n=Dy();n&&(t.voice=n),t.lang="it-IT",e==="custode"?(t.rate=.92,t.pitch=.7):(t.rate=1,t.pitch=1),window.speechSynthesis.speak(t)}const jd="14.9.17",Oh=(i,e,t)=>({endTime:e,insertTime:t,type:"exponentialRampToValue",value:i}),Uh=(i,e,t)=>({endTime:e,insertTime:t,type:"linearRampToValue",value:i}),Yc=(i,e)=>({startTime:e,type:"setValue",value:i}),Yd=(i,e,t)=>({duration:t,startTime:e,type:"setValueCurve",values:i}),$d=(i,e,{startTime:t,target:n,timeConstant:s})=>n+(e-n)*Math.exp((t-i)/s),Ls=i=>i.type==="exponentialRampToValue",Wo=i=>i.type==="linearRampToValue",vi=i=>Ls(i)||Wo(i),wl=i=>i.type==="setValue",Qn=i=>i.type==="setValueCurve",qo=(i,e,t,n)=>{const s=i[e];return s===void 0?n:vi(s)||wl(s)?s.value:Qn(s)?s.values[s.values.length-1]:$d(t,qo(i,e-1,s.startTime,n),s)},Fh=(i,e,t,n,s)=>t===void 0?[n.insertTime,s]:vi(t)?[t.endTime,t.value]:wl(t)?[t.startTime,t.value]:Qn(t)?[t.startTime+t.duration,t.values[t.values.length-1]]:[t.startTime,qo(i,e-1,t.startTime,s)],$c=i=>i.type==="cancelAndHold",Zc=i=>i.type==="cancelScheduledValues",_i=i=>$c(i)||Zc(i)?i.cancelTime:Ls(i)||Wo(i)?i.endTime:i.startTime,kh=(i,e,t,{endTime:n,value:s})=>t===s?s:0<t&&0<s||t<0&&s<0?t*(s/t)**((i-e)/(n-e)):i<n?t:s,Bh=(i,e,t,{endTime:n,value:s})=>t+(i-e)/(n-e)*(s-t),Zd=(i,e)=>{const t=Math.floor(e);if(t===e)return i[t];const n=Math.ceil(e);return(1-(e-t))*i[t]+(1-(n-e))*i[n]},Ly=(i,{duration:e,startTime:t,values:n})=>{const s=(i-t)/e*(n.length-1);return Zd(n,s)},Oy=(i,e,t)=>{const n=i.length,s=Math.max(1,Math.floor(t/e*n))+1,r=i instanceof Float32Array?new Float32Array(s):i.slice(0,s);for(let o=0;o<s;o+=1){const c=o/(s-1)*t/e*(n-1);r[o]=Zd(i,c)}return r},bo=i=>i.type==="setTarget";class Uy{constructor(e){this._automationEvents=[],this._currenTime=0,this._defaultValue=e}[Symbol.iterator](){return this._automationEvents[Symbol.iterator]()}add(e){const t=_i(e);if($c(e)||Zc(e)){const n=this._automationEvents.findIndex(r=>Zc(e)&&Qn(r)?r.startTime+r.duration>=t:_i(r)>=t),s=this._automationEvents[n];if(n!==-1&&(this._automationEvents=this._automationEvents.slice(0,n)),$c(e)){const r=this._automationEvents[this._automationEvents.length-1];if(s!==void 0&&vi(s)){if(r!==void 0&&bo(r))throw new Error("The internal list is malformed.");const o=r===void 0?s.insertTime:Qn(r)?r.startTime+r.duration:_i(r),a=r===void 0?this._defaultValue:Qn(r)?r.values[r.values.length-1]:r.value,c=Ls(s)?kh(t,o,a,s):Bh(t,o,a,s),l=Ls(s)?Oh(c,t,this._currenTime):Uh(c,t,this._currenTime);this._automationEvents.push(l)}if(r!==void 0&&bo(r)&&this._automationEvents.push(Yc(this.getValue(t),t)),r!==void 0&&Qn(r)&&r.startTime+r.duration>t){const o=t-r.startTime;this._automationEvents[this._automationEvents.length-1]=Yd(Oy(r.values,r.duration,o),r.startTime,o)}}}else{const n=this._automationEvents.findIndex(o=>_i(o)>t),s=n===-1?this._automationEvents[this._automationEvents.length-1]:this._automationEvents[n-1];if(s!==void 0&&Qn(s)&&_i(s)+s.duration>t)return!1;const r=Ls(e)?Oh(e.value,e.endTime,this._currenTime):Wo(e)?Uh(e.value,t,this._currenTime):e;if(n===-1)this._automationEvents.push(r);else{if(Qn(e)&&t+e.duration>_i(this._automationEvents[n]))return!1;this._automationEvents.splice(n,0,r)}}return!0}flush(e){const t=this._automationEvents.findIndex(n=>_i(n)>e);if(t>1){const n=this._automationEvents.slice(t-1),s=n[0];bo(s)&&n.unshift(Yc(qo(this._automationEvents,t-2,s.startTime,this._defaultValue),s.startTime)),this._automationEvents=n}}getValue(e){if(this._automationEvents.length===0)return this._defaultValue;const t=this._automationEvents.findIndex(o=>_i(o)>e),n=this._automationEvents[t],s=(t===-1?this._automationEvents.length:t)-1,r=this._automationEvents[s];if(r!==void 0&&bo(r)&&(n===void 0||!vi(n)||n.insertTime>e))return $d(e,qo(this._automationEvents,s-1,r.startTime,this._defaultValue),r);if(r!==void 0&&wl(r)&&(n===void 0||!vi(n)))return r.value;if(r!==void 0&&Qn(r)&&(n===void 0||!vi(n)||r.startTime+r.duration>e))return e<r.startTime+r.duration?Ly(e,r):r.values[r.values.length-1];if(r!==void 0&&vi(r)&&(n===void 0||!vi(n)))return r.value;if(n!==void 0&&Ls(n)){const[o,a]=Fh(this._automationEvents,s,r,n,this._defaultValue);return kh(e,o,a,n)}if(n!==void 0&&Wo(n)){const[o,a]=Fh(this._automationEvents,s,r,n,this._defaultValue);return Bh(e,o,a,n)}return this._defaultValue}}const Fy=i=>({cancelTime:i,type:"cancelAndHold"}),ky=i=>({cancelTime:i,type:"cancelScheduledValues"}),By=(i,e)=>({endTime:e,type:"exponentialRampToValue",value:i}),Vy=(i,e)=>({endTime:e,type:"linearRampToValue",value:i}),zy=(i,e,t)=>({startTime:e,target:i,timeConstant:t,type:"setTarget"}),Hy=()=>new DOMException("","AbortError"),Gy=i=>(e,t,[n,s,r],o)=>{i(e[s],[t,n,r],a=>a[0]===t&&a[1]===n,o)},Wy=i=>(e,t,n)=>{const s=[];for(let r=0;r<n.numberOfInputs;r+=1)s.push(new Set);i.set(e,{activeInputs:s,outputs:new Set,passiveInputs:new WeakMap,renderer:t})},qy=i=>(e,t)=>{i.set(e,{activeInputs:new Set,passiveInputs:new WeakMap,renderer:t})},Xs=new WeakSet,Kd=new WeakMap,Al=new WeakMap,Qd=new WeakMap,Cl=new WeakMap,Fa=new WeakMap,Jd=new WeakMap,Kc=new WeakMap,Qc=new WeakMap,Jc=new WeakMap,ef={construct(){return ef}},Xy=i=>{try{const e=new Proxy(i,ef);new e}catch{return!1}return!0},Vh=/^import(?:(?:[\s]+[\w]+|(?:[\s]+[\w]+[\s]*,)?[\s]*\{[\s]*[\w]+(?:[\s]+as[\s]+[\w]+)?(?:[\s]*,[\s]*[\w]+(?:[\s]+as[\s]+[\w]+)?)*[\s]*}|(?:[\s]+[\w]+[\s]*,)?[\s]*\*[\s]+as[\s]+[\w]+)[\s]+from)?(?:[\s]*)("([^"\\]|\\.)+"|'([^'\\]|\\.)+')(?:[\s]*);?/,zh=(i,e)=>{const t=[];let n=i.replace(/^[\s]+/,""),s=n.match(Vh);for(;s!==null;){const r=s[1].slice(1,-1),o=s[0].replace(/([\s]+)?;?$/,"").replace(r,new URL(r,e).toString());t.push(o),n=n.slice(s[0].length).replace(/^[\s]+/,""),s=n.match(Vh)}return[t.join(";"),n]},Hh=i=>{if(i!==void 0&&!Array.isArray(i))throw new TypeError("The parameterDescriptors property of given value for processorCtor is not an array.")},Gh=i=>{if(!Xy(i))throw new TypeError("The given value for processorCtor should be a constructor.");if(i.prototype===null||typeof i.prototype!="object")throw new TypeError("The given value for processorCtor should have a prototype.")},jy=(i,e,t,n,s,r,o,a,c,l,u,h,d)=>{let f=0;return(g,_,m={credentials:"omit"})=>{const p=u.get(g);if(p!==void 0&&p.has(_))return Promise.resolve();const y=l.get(g);if(y!==void 0){const E=y.get(_);if(E!==void 0)return E}const x=r(g),M=x.audioWorklet===void 0?s(_).then(([E,T])=>{const[b,A]=zh(E,T),S=`${b};((a,b)=>{(a[b]=a[b]||[]).push((AudioWorkletProcessor,global,registerProcessor,sampleRate,self,window)=>{${A}
})})(window,'_AWGS')`;return t(S)}).then(()=>{const E=d._AWGS.pop();if(E===void 0)throw new SyntaxError;n(x.currentTime,x.sampleRate,()=>E(class{},void 0,(T,b)=>{if(T.trim()==="")throw e();const A=Qc.get(x);if(A!==void 0){if(A.has(T))throw e();Gh(b),Hh(b.parameterDescriptors),A.set(T,b)}else Gh(b),Hh(b.parameterDescriptors),Qc.set(x,new Map([[T,b]]))},x.sampleRate,void 0,void 0))}):Promise.all([s(_),Promise.resolve(i(h,h))]).then(([[E,T],b])=>{const A=f+1;f=A;const[S,v]=zh(E,T),O=`${S};((AudioWorkletProcessor,registerProcessor)=>{${v}
})(${b?"AudioWorkletProcessor":"class extends AudioWorkletProcessor {__b=new WeakSet();constructor(){super();(p=>p.postMessage=(q=>(m,t)=>q.call(p,m,t?t.filter(u=>!this.__b.has(u)):t))(p.postMessage))(this.port)}}"},(n,p)=>registerProcessor(n,class extends p{${b?"":"__c = (a) => a.forEach(e=>this.__b.add(e.buffer));"}process(i,o,p){${b?"":"i.forEach(this.__c);o.forEach(this.__c);this.__c(Object.values(p));"}return super.process(i.map(j=>j.some(k=>k.length===0)?[]:j),o,p)}}));registerProcessor('__sac${A}',class extends AudioWorkletProcessor{process(){return !1}})`,B=new Blob([O],{type:"application/javascript; charset=utf-8"}),U=URL.createObjectURL(B);return x.audioWorklet.addModule(U,m).then(()=>{if(a(x))return x;const H=o(x);return H.audioWorklet.addModule(U,m).then(()=>H)}).then(H=>{if(c===null)throw new SyntaxError;try{new c(H,`__sac${A}`)}catch{throw new SyntaxError}}).finally(()=>URL.revokeObjectURL(U))});return y===void 0?l.set(g,new Map([[_,M]])):y.set(_,M),M.then(()=>{const E=u.get(g);E===void 0?u.set(g,new Set([_])):E.add(_)}).finally(()=>{const E=l.get(g);E!==void 0&&E.delete(_)}),M}},Mn=(i,e)=>{const t=i.get(e);if(t===void 0)throw new Error("A value with the given key could not be found.");return t},ka=(i,e)=>{const t=Array.from(i).filter(e);if(t.length>1)throw Error("More than one element was found.");if(t.length===0)throw Error("No element was found.");const[n]=t;return i.delete(n),n},tf=(i,e,t,n)=>{const s=Mn(i,e),r=ka(s,o=>o[0]===t&&o[1]===n);return s.size===0&&i.delete(e),r},Vr=i=>Mn(Jd,i),js=i=>{if(Xs.has(i))throw new Error("The AudioNode is already stored.");Xs.add(i),Vr(i).forEach(e=>e(!0))},nf=i=>"port"in i,zr=i=>{if(!Xs.has(i))throw new Error("The AudioNode is not stored.");Xs.delete(i),Vr(i).forEach(e=>e(!1))},el=(i,e)=>{!nf(i)&&e.every(t=>t.size===0)&&zr(i)},Yy=(i,e,t,n,s,r,o,a,c,l,u,h,d)=>{const f=new WeakMap;return(g,_,m,p,y)=>{const{activeInputs:x,passiveInputs:M}=r(_),{outputs:E}=r(g),T=a(g),b=A=>{const S=c(_),v=c(g);if(A){const R=tf(M,g,m,p);i(x,g,R,!1),!y&&!h(g)&&t(v,S,m,p),d(_)&&js(_)}else{const R=n(x,g,m,p);e(M,p,R,!1),!y&&!h(g)&&s(v,S,m,p);const P=o(_);if(P===0)u(_)&&el(_,x);else{const D=f.get(_);D!==void 0&&clearTimeout(D),f.set(_,setTimeout(()=>{u(_)&&el(_,x)},P*1e3))}}};return l(E,[_,m,p],A=>A[0]===_&&A[1]===m&&A[2]===p,!0)?(T.add(b),u(g)?i(x,g,[m,p,b],!0):e(M,p,[g,m,b],!0),!0):!1}},$y=i=>(e,t,[n,s,r],o)=>{const a=e.get(n);a===void 0?e.set(n,new Set([[s,t,r]])):i(a,[s,t,r],c=>c[0]===s&&c[1]===t,o)},Zy=i=>(e,t)=>{const n=i(e,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",gain:0});t.connect(n).connect(e.destination);const s=()=>{t.removeEventListener("ended",s),t.disconnect(n),n.disconnect()};t.addEventListener("ended",s)},Ky=i=>(e,t)=>{i(e).add(t)},Qy={channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",fftSize:2048,maxDecibels:-30,minDecibels:-100,smoothingTimeConstant:.8},Jy=(i,e,t,n,s,r)=>class extends i{constructor(a,c){const l=s(a),u={...Qy,...c},h=n(l,u),d=r(l)?e():null;super(a,!1,h,d),this._nativeAnalyserNode=h}get fftSize(){return this._nativeAnalyserNode.fftSize}set fftSize(a){this._nativeAnalyserNode.fftSize=a}get frequencyBinCount(){return this._nativeAnalyserNode.frequencyBinCount}get maxDecibels(){return this._nativeAnalyserNode.maxDecibels}set maxDecibels(a){const c=this._nativeAnalyserNode.maxDecibels;if(this._nativeAnalyserNode.maxDecibels=a,!(a>this._nativeAnalyserNode.minDecibels))throw this._nativeAnalyserNode.maxDecibels=c,t()}get minDecibels(){return this._nativeAnalyserNode.minDecibels}set minDecibels(a){const c=this._nativeAnalyserNode.minDecibels;if(this._nativeAnalyserNode.minDecibels=a,!(this._nativeAnalyserNode.maxDecibels>a))throw this._nativeAnalyserNode.minDecibels=c,t()}get smoothingTimeConstant(){return this._nativeAnalyserNode.smoothingTimeConstant}set smoothingTimeConstant(a){this._nativeAnalyserNode.smoothingTimeConstant=a}getByteFrequencyData(a){this._nativeAnalyserNode.getByteFrequencyData(a)}getByteTimeDomainData(a){this._nativeAnalyserNode.getByteTimeDomainData(a)}getFloatFrequencyData(a){this._nativeAnalyserNode.getFloatFrequencyData(a)}getFloatTimeDomainData(a){this._nativeAnalyserNode.getFloatTimeDomainData(a)}},zt=(i,e)=>i.context===e,eS=(i,e,t)=>()=>{const n=new WeakMap,s=async(r,o)=>{let a=e(r);if(!zt(a,o)){const l={channelCount:a.channelCount,channelCountMode:a.channelCountMode,channelInterpretation:a.channelInterpretation,fftSize:a.fftSize,maxDecibels:a.maxDecibels,minDecibels:a.minDecibels,smoothingTimeConstant:a.smoothingTimeConstant};a=i(o,l)}return n.set(o,a),await t(r,o,a),a};return{render(r,o){const a=n.get(o);return a!==void 0?Promise.resolve(a):s(r,o)}}},Xo=i=>{try{i.copyToChannel(new Float32Array(1),0,-1)}catch{return!1}return!0},Vn=()=>new DOMException("","IndexSizeError"),Rl=i=>{i.getChannelData=(e=>t=>{try{return e.call(i,t)}catch(n){throw n.code===12?Vn():n}})(i.getChannelData)},tS={numberOfChannels:1},nS=(i,e,t,n,s,r,o,a)=>{let c=null;return class sf{constructor(u){if(s===null)throw new Error("Missing the native OfflineAudioContext constructor.");const{length:h,numberOfChannels:d,sampleRate:f}={...tS,...u};c===null&&(c=new s(1,1,44100));const g=n!==null&&e(r,r)?new n({length:h,numberOfChannels:d,sampleRate:f}):c.createBuffer(d,h,f);if(g.numberOfChannels===0)throw t();return typeof g.copyFromChannel!="function"?(o(g),Rl(g)):e(Xo,()=>Xo(g))||a(g),i.add(g),g}static[Symbol.hasInstance](u){return u!==null&&typeof u=="object"&&Object.getPrototypeOf(u)===sf.prototype||i.has(u)}}},Zt=-34028234663852886e22,Wt=-Zt,ni=i=>Xs.has(i),iS={buffer:null,channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",loop:!1,loopEnd:0,loopStart:0,playbackRate:1},sS=(i,e,t,n,s,r,o,a)=>class extends i{constructor(l,u){const h=r(l),d={...iS,...u},f=s(h,d),g=o(h),_=g?e():null;super(l,!1,f,_),this._audioBufferSourceNodeRenderer=_,this._isBufferNullified=!1,this._isBufferSet=d.buffer!==null,this._nativeAudioBufferSourceNode=f,this._onended=null,this._playbackRate=t(this,g,f.playbackRate,Wt,Zt)}get buffer(){return this._isBufferNullified?null:this._nativeAudioBufferSourceNode.buffer}set buffer(l){if(this._nativeAudioBufferSourceNode.buffer=l,l!==null){if(this._isBufferSet)throw n();this._isBufferSet=!0}}get loop(){return this._nativeAudioBufferSourceNode.loop}set loop(l){this._nativeAudioBufferSourceNode.loop=l}get loopEnd(){return this._nativeAudioBufferSourceNode.loopEnd}set loopEnd(l){this._nativeAudioBufferSourceNode.loopEnd=l}get loopStart(){return this._nativeAudioBufferSourceNode.loopStart}set loopStart(l){this._nativeAudioBufferSourceNode.loopStart=l}get onended(){return this._onended}set onended(l){const u=typeof l=="function"?a(this,l):null;this._nativeAudioBufferSourceNode.onended=u;const h=this._nativeAudioBufferSourceNode.onended;this._onended=h!==null&&h===u?l:h}get playbackRate(){return this._playbackRate}start(l=0,u=0,h){if(this._nativeAudioBufferSourceNode.start(l,u,h),this._audioBufferSourceNodeRenderer!==null&&(this._audioBufferSourceNodeRenderer.start=h===void 0?[l,u]:[l,u,h]),this.context.state!=="closed"){js(this);const d=()=>{this._nativeAudioBufferSourceNode.removeEventListener("ended",d),ni(this)&&zr(this)};this._nativeAudioBufferSourceNode.addEventListener("ended",d)}}stop(l=0){this._nativeAudioBufferSourceNode.stop(l),this._audioBufferSourceNodeRenderer!==null&&(this._audioBufferSourceNodeRenderer.stop=l)}},rS=(i,e,t,n,s)=>()=>{const r=new WeakMap;let o=null,a=null;const c=async(l,u)=>{let h=t(l);const d=zt(h,u);if(!d){const f={buffer:h.buffer,channelCount:h.channelCount,channelCountMode:h.channelCountMode,channelInterpretation:h.channelInterpretation,loop:h.loop,loopEnd:h.loopEnd,loopStart:h.loopStart,playbackRate:h.playbackRate.value};h=e(u,f),o!==null&&h.start(...o),a!==null&&h.stop(a)}return r.set(u,h),d?await i(u,l.playbackRate,h.playbackRate):await n(u,l.playbackRate,h.playbackRate),await s(l,u,h),h};return{set start(l){o=l},set stop(l){a=l},render(l,u){const h=r.get(u);return h!==void 0?Promise.resolve(h):c(l,u)}}},oS=i=>"playbackRate"in i,aS=i=>"frequency"in i&&"gain"in i,cS=i=>"offset"in i,lS=i=>!("frequency"in i)&&"gain"in i,uS=i=>"detune"in i&&"frequency"in i&&!("gain"in i),hS=i=>"pan"in i,qt=i=>Mn(Kd,i),Hr=i=>Mn(Qd,i),tl=(i,e)=>{const{activeInputs:t}=qt(i);t.forEach(s=>s.forEach(([r])=>{e.includes(i)||tl(r,[...e,i])}));const n=oS(i)?[i.playbackRate]:nf(i)?Array.from(i.parameters.values()):aS(i)?[i.Q,i.detune,i.frequency,i.gain]:cS(i)?[i.offset]:lS(i)?[i.gain]:uS(i)?[i.detune,i.frequency]:hS(i)?[i.pan]:[];for(const s of n){const r=Hr(s);r!==void 0&&r.activeInputs.forEach(([o])=>tl(o,e))}ni(i)&&zr(i)},rf=i=>{tl(i.destination,[])},dS=i=>i===void 0||typeof i=="number"||typeof i=="string"&&(i==="balanced"||i==="interactive"||i==="playback"),fS=(i,e,t,n,s,r,o,a,c)=>class extends i{constructor(u={}){if(c===null)throw new Error("Missing the native AudioContext constructor.");let h;try{h=new c(u)}catch(g){throw g.code===12&&g.message==="sampleRate is not in range"?t():g}if(h===null)throw n();if(!dS(u.latencyHint))throw new TypeError(`The provided value '${u.latencyHint}' is not a valid enum value of type AudioContextLatencyCategory.`);if(u.sampleRate!==void 0&&h.sampleRate!==u.sampleRate)throw t();super(h,2);const{latencyHint:d}=u,{sampleRate:f}=h;if(this._baseLatency=typeof h.baseLatency=="number"?h.baseLatency:d==="balanced"?512/f:d==="interactive"||d===void 0?256/f:d==="playback"?1024/f:Math.max(2,Math.min(128,Math.round(d*f/128)))*128/f,this._nativeAudioContext=h,c.name==="webkitAudioContext"?(this._nativeGainNode=h.createGain(),this._nativeOscillatorNode=h.createOscillator(),this._nativeGainNode.gain.value=1e-37,this._nativeOscillatorNode.connect(this._nativeGainNode).connect(h.destination),this._nativeOscillatorNode.start()):(this._nativeGainNode=null,this._nativeOscillatorNode=null),this._state=null,h.state==="running"){this._state="suspended";const g=()=>{this._state==="suspended"&&(this._state=null),h.removeEventListener("statechange",g)};h.addEventListener("statechange",g)}}get baseLatency(){return this._baseLatency}get state(){return this._state!==null?this._state:this._nativeAudioContext.state}close(){return this.state==="closed"?this._nativeAudioContext.close().then(()=>{throw e()}):(this._state==="suspended"&&(this._state=null),this._nativeAudioContext.close().then(()=>{this._nativeGainNode!==null&&this._nativeOscillatorNode!==null&&(this._nativeOscillatorNode.stop(),this._nativeGainNode.disconnect(),this._nativeOscillatorNode.disconnect()),rf(this)}))}createMediaElementSource(u){return new s(this,{mediaElement:u})}createMediaStreamDestination(){return new r(this)}createMediaStreamSource(u){return new o(this,{mediaStream:u})}createMediaStreamTrackSource(u){return new a(this,{mediaStreamTrack:u})}resume(){return this._state==="suspended"?new Promise((u,h)=>{const d=()=>{this._nativeAudioContext.removeEventListener("statechange",d),this._nativeAudioContext.state==="running"?u():this.resume().then(u,h)};this._nativeAudioContext.addEventListener("statechange",d)}):this._nativeAudioContext.resume().catch(u=>{throw u===void 0||u.code===15?e():u})}suspend(){return this._nativeAudioContext.suspend().catch(u=>{throw u===void 0?e():u})}},pS=(i,e,t,n,s,r,o,a)=>class extends i{constructor(l,u){const h=r(l),d=o(h),f=s(h,u,d),g=d?e(a):null;super(l,!1,f,g),this._isNodeOfNativeOfflineAudioContext=d,this._nativeAudioDestinationNode=f}get channelCount(){return this._nativeAudioDestinationNode.channelCount}set channelCount(l){if(this._isNodeOfNativeOfflineAudioContext)throw n();if(l>this._nativeAudioDestinationNode.maxChannelCount)throw t();this._nativeAudioDestinationNode.channelCount=l}get channelCountMode(){return this._nativeAudioDestinationNode.channelCountMode}set channelCountMode(l){if(this._isNodeOfNativeOfflineAudioContext)throw n();this._nativeAudioDestinationNode.channelCountMode=l}get maxChannelCount(){return this._nativeAudioDestinationNode.maxChannelCount}},mS=i=>{const e=new WeakMap,t=async(n,s)=>{const r=s.destination;return e.set(s,r),await i(n,s,r),r};return{render(n,s){const r=e.get(s);return r!==void 0?Promise.resolve(r):t(n,s)}}},gS=(i,e,t,n,s,r,o,a)=>(c,l)=>{const u=l.listener,h=()=>{const E=new Float32Array(1),T=e(l,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:9}),b=o(l);let A=!1,S=[0,0,-1,0,1,0],v=[0,0,0];const R=()=>{if(A)return;A=!0;const B=n(l,256,9,0);B.onaudioprocess=({inputBuffer:U})=>{const H=[r(U,E,0),r(U,E,1),r(U,E,2),r(U,E,3),r(U,E,4),r(U,E,5)];H.some((Z,ee)=>Z!==S[ee])&&(u.setOrientation(...H),S=H);const z=[r(U,E,6),r(U,E,7),r(U,E,8)];z.some((Z,ee)=>Z!==v[ee])&&(u.setPosition(...z),v=z)},T.connect(B)},P=B=>U=>{U!==S[B]&&(S[B]=U,u.setOrientation(...S))},D=B=>U=>{U!==v[B]&&(v[B]=U,u.setPosition(...v))},O=(B,U,H)=>{const z=t(l,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",offset:U});z.connect(T,0,B),z.start(),Object.defineProperty(z.offset,"defaultValue",{get(){return U}});const Z=i({context:c},b,z.offset,Wt,Zt);return a(Z,"value",ee=>()=>ee.call(Z),ee=>te=>{try{ee.call(Z,te)}catch(ve){if(ve.code!==9)throw ve}R(),b&&H(te)}),Z.cancelAndHoldAtTime=(ee=>b?()=>{throw s()}:(...te)=>{const ve=ee.apply(Z,te);return R(),ve})(Z.cancelAndHoldAtTime),Z.cancelScheduledValues=(ee=>b?()=>{throw s()}:(...te)=>{const ve=ee.apply(Z,te);return R(),ve})(Z.cancelScheduledValues),Z.exponentialRampToValueAtTime=(ee=>b?()=>{throw s()}:(...te)=>{const ve=ee.apply(Z,te);return R(),ve})(Z.exponentialRampToValueAtTime),Z.linearRampToValueAtTime=(ee=>b?()=>{throw s()}:(...te)=>{const ve=ee.apply(Z,te);return R(),ve})(Z.linearRampToValueAtTime),Z.setTargetAtTime=(ee=>b?()=>{throw s()}:(...te)=>{const ve=ee.apply(Z,te);return R(),ve})(Z.setTargetAtTime),Z.setValueAtTime=(ee=>b?()=>{throw s()}:(...te)=>{const ve=ee.apply(Z,te);return R(),ve})(Z.setValueAtTime),Z.setValueCurveAtTime=(ee=>b?()=>{throw s()}:(...te)=>{const ve=ee.apply(Z,te);return R(),ve})(Z.setValueCurveAtTime),Z};return{forwardX:O(0,0,P(0)),forwardY:O(1,0,P(1)),forwardZ:O(2,-1,P(2)),positionX:O(6,0,D(0)),positionY:O(7,0,D(1)),positionZ:O(8,0,D(2)),upX:O(3,0,P(3)),upY:O(4,1,P(4)),upZ:O(5,0,P(5))}},{forwardX:d,forwardY:f,forwardZ:g,positionX:_,positionY:m,positionZ:p,upX:y,upY:x,upZ:M}=u.forwardX===void 0?h():u;return{get forwardX(){return d},get forwardY(){return f},get forwardZ(){return g},get positionX(){return _},get positionY(){return m},get positionZ(){return p},get upX(){return y},get upY(){return x},get upZ(){return M}}},jo=i=>"context"in i,Gr=i=>jo(i[0]),us=(i,e,t,n)=>{for(const s of i)if(t(s)){if(n)return!1;throw Error("The set contains at least one similar element.")}return i.add(e),!0},Wh=(i,e,[t,n],s)=>{us(i,[e,t,n],r=>r[0]===e&&r[1]===t,s)},qh=(i,[e,t,n],s)=>{const r=i.get(e);r===void 0?i.set(e,new Set([[t,n]])):us(r,[t,n],o=>o[0]===t,s)},rr=i=>"inputs"in i,Yo=(i,e,t,n)=>{if(rr(e)){const s=e.inputs[n];return i.connect(s,t,0),[s,t,0]}return i.connect(e,t,n),[e,t,n]},of=(i,e,t)=>{for(const n of i)if(n[0]===e&&n[1]===t)return i.delete(n),n;return null},_S=(i,e,t)=>ka(i,n=>n[0]===e&&n[1]===t),af=(i,e)=>{if(!Vr(i).delete(e))throw new Error("Missing the expected event listener.")},cf=(i,e,t)=>{const n=Mn(i,e),s=ka(n,r=>r[0]===t);return n.size===0&&i.delete(e),s},$o=(i,e,t,n)=>{rr(e)?i.disconnect(e.inputs[n],t,0):i.disconnect(e,t,n)},ht=i=>Mn(Al,i),Sr=i=>Mn(Cl,i),is=i=>Kc.has(i),Po=i=>!Xs.has(i),Xh=(i,e)=>new Promise(t=>{if(e!==null)t(!0);else{const n=i.createScriptProcessor(256,1,1),s=i.createGain(),r=i.createBuffer(1,2,44100),o=r.getChannelData(0);o[0]=1,o[1]=1;const a=i.createBufferSource();a.buffer=r,a.loop=!0,a.connect(n).connect(i.destination),a.connect(s),a.disconnect(s),n.onaudioprocess=c=>{const l=c.inputBuffer.getChannelData(0);Array.prototype.some.call(l,u=>u===1)?t(!0):t(!1),a.stop(),n.onaudioprocess=null,a.disconnect(n),n.disconnect(i.destination)},a.start()}}),Oc=(i,e)=>{const t=new Map;for(const n of i)for(const s of n){const r=t.get(s);t.set(s,r===void 0?1:r+1)}t.forEach((n,s)=>e(s,n))},Zo=i=>"context"in i,vS=i=>{const e=new Map;i.connect=(t=>(n,s=0,r=0)=>{const o=Zo(n)?t(n,s,r):t(n,s),a=e.get(n);return a===void 0?e.set(n,[{input:r,output:s}]):a.every(c=>c.input!==r||c.output!==s)&&a.push({input:r,output:s}),o})(i.connect.bind(i)),i.disconnect=(t=>(n,s,r)=>{if(t.apply(i),n===void 0)e.clear();else if(typeof n=="number")for(const[o,a]of e){const c=a.filter(l=>l.output!==n);c.length===0?e.delete(o):e.set(o,c)}else if(e.has(n))if(s===void 0)e.delete(n);else{const o=e.get(n);if(o!==void 0){const a=o.filter(c=>c.output!==s&&(c.input!==r||r===void 0));a.length===0?e.delete(n):e.set(n,a)}}for(const[o,a]of e)a.forEach(c=>{Zo(o)?i.connect(o,c.output,c.input):i.connect(o,c.output)})})(i.disconnect)},xS=(i,e,t,n)=>{const{activeInputs:s,passiveInputs:r}=Hr(e),{outputs:o}=qt(i),a=Vr(i),c=l=>{const u=ht(i),h=Sr(e);if(l){const d=cf(r,i,t);Wh(s,i,d,!1),!n&&!is(i)&&u.connect(h,t)}else{const d=_S(s,i,t);qh(r,d,!1),!n&&!is(i)&&u.disconnect(h,t)}};return us(o,[e,t],l=>l[0]===e&&l[1]===t,!0)?(a.add(c),ni(i)?Wh(s,i,[t,c],!0):qh(r,[i,t,c],!0),!0):!1},yS=(i,e,t,n)=>{const{activeInputs:s,passiveInputs:r}=qt(e),o=of(s[n],i,t);return o===null?[tf(r,i,t,n)[2],!1]:[o[2],!0]},SS=(i,e,t)=>{const{activeInputs:n,passiveInputs:s}=Hr(e),r=of(n,i,t);return r===null?[cf(s,i,t)[1],!1]:[r[2],!0]},Il=(i,e,t,n,s)=>{const[r,o]=yS(i,t,n,s);if(r!==null&&(af(i,r),o&&!e&&!is(i)&&$o(ht(i),ht(t),n,s)),ni(t)){const{activeInputs:a}=qt(t);el(t,a)}},Pl=(i,e,t,n)=>{const[s,r]=SS(i,t,n);s!==null&&(af(i,s),r&&!e&&!is(i)&&ht(i).disconnect(Sr(t),n))},MS=(i,e)=>{const t=qt(i),n=[];for(const s of t.outputs)Gr(s)?Il(i,e,...s):Pl(i,e,...s),n.push(s[0]);return t.outputs.clear(),n},TS=(i,e,t)=>{const n=qt(i),s=[];for(const r of n.outputs)r[1]===t&&(Gr(r)?Il(i,e,...r):Pl(i,e,...r),s.push(r[0]),n.outputs.delete(r));return s},bS=(i,e,t,n,s)=>{const r=qt(i);return Array.from(r.outputs).filter(o=>o[0]===t&&(n===void 0||o[1]===n)&&(s===void 0||o[2]===s)).map(o=>(Gr(o)?Il(i,e,...o):Pl(i,e,...o),r.outputs.delete(o),o[0]))},ES=(i,e,t,n,s,r,o,a,c,l,u,h,d,f,g,_)=>class extends l{constructor(p,y,x,M){super(x),this._context=p,this._nativeAudioNode=x;const E=u(p);h(E)&&t(Xh,()=>Xh(E,_))!==!0&&vS(x),Al.set(this,x),Jd.set(this,new Set),p.state!=="closed"&&y&&js(this),i(this,M,x)}get channelCount(){return this._nativeAudioNode.channelCount}set channelCount(p){this._nativeAudioNode.channelCount=p}get channelCountMode(){return this._nativeAudioNode.channelCountMode}set channelCountMode(p){this._nativeAudioNode.channelCountMode=p}get channelInterpretation(){return this._nativeAudioNode.channelInterpretation}set channelInterpretation(p){this._nativeAudioNode.channelInterpretation=p}get context(){return this._context}get numberOfInputs(){return this._nativeAudioNode.numberOfInputs}get numberOfOutputs(){return this._nativeAudioNode.numberOfOutputs}connect(p,y=0,x=0){if(y<0||y>=this._nativeAudioNode.numberOfOutputs)throw s();const M=u(this._context),E=g(M);if(d(p)||f(p))throw r();if(jo(p)){const A=ht(p);try{const v=Yo(this._nativeAudioNode,A,y,x),R=Po(this);(E||R)&&this._nativeAudioNode.disconnect(...v),this.context.state!=="closed"&&!R&&Po(p)&&js(p)}catch(v){throw v.code===12?r():v}if(e(this,p,y,x,E)){const v=c([this],p);Oc(v,n(E))}return p}const T=Sr(p);if(T.name==="playbackRate"&&T.maxValue===1024)throw o();try{this._nativeAudioNode.connect(T,y),(E||Po(this))&&this._nativeAudioNode.disconnect(T,y)}catch(A){throw A.code===12?r():A}if(xS(this,p,y,E)){const A=c([this],p);Oc(A,n(E))}}disconnect(p,y,x){let M;const E=u(this._context),T=g(E);if(p===void 0)M=MS(this,T);else if(typeof p=="number"){if(p<0||p>=this.numberOfOutputs)throw s();M=TS(this,T,p)}else{if(y!==void 0&&(y<0||y>=this.numberOfOutputs)||jo(p)&&x!==void 0&&(x<0||x>=p.numberOfInputs))throw s();if(M=bS(this,T,p,y,x),M.length===0)throw r()}for(const b of M){const A=c([this],b);Oc(A,a)}}},wS=(i,e,t,n,s,r,o,a,c,l,u,h,d)=>(f,g,_,m=null,p=null)=>{const y=_.value,x=new Uy(y),M=g?n(x):null,E={get defaultValue(){return y},get maxValue(){return m===null?_.maxValue:m},get minValue(){return p===null?_.minValue:p},get value(){return _.value},set value(T){_.value=T,E.setValueAtTime(T,f.context.currentTime)},cancelAndHoldAtTime(T){if(typeof _.cancelAndHoldAtTime=="function")M===null&&x.flush(f.context.currentTime),x.add(s(T)),_.cancelAndHoldAtTime(T);else{const b=Array.from(x).pop();M===null&&x.flush(f.context.currentTime),x.add(s(T));const A=Array.from(x).pop();_.cancelScheduledValues(T),b!==A&&A!==void 0&&(A.type==="exponentialRampToValue"?_.exponentialRampToValueAtTime(A.value,A.endTime):A.type==="linearRampToValue"?_.linearRampToValueAtTime(A.value,A.endTime):A.type==="setValue"?_.setValueAtTime(A.value,A.startTime):A.type==="setValueCurve"&&_.setValueCurveAtTime(A.values,A.startTime,A.duration))}return E},cancelScheduledValues(T){return M===null&&x.flush(f.context.currentTime),x.add(r(T)),_.cancelScheduledValues(T),E},exponentialRampToValueAtTime(T,b){if(T===0)throw new RangeError;if(!Number.isFinite(b)||b<0)throw new RangeError;const A=f.context.currentTime;return M===null&&x.flush(A),Array.from(x).length===0&&(x.add(l(y,A)),_.setValueAtTime(y,A)),x.add(o(T,b)),_.exponentialRampToValueAtTime(T,b),E},linearRampToValueAtTime(T,b){const A=f.context.currentTime;return M===null&&x.flush(A),Array.from(x).length===0&&(x.add(l(y,A)),_.setValueAtTime(y,A)),x.add(a(T,b)),_.linearRampToValueAtTime(T,b),E},setTargetAtTime(T,b,A){return M===null&&x.flush(f.context.currentTime),x.add(c(T,b,A)),_.setTargetAtTime(T,b,A),E},setValueAtTime(T,b){return M===null&&x.flush(f.context.currentTime),x.add(l(T,b)),_.setValueAtTime(T,b),E},setValueCurveAtTime(T,b,A){const S=T instanceof Float32Array?T:new Float32Array(T);if(h!==null&&h.name==="webkitAudioContext"){const v=b+A,R=f.context.sampleRate,P=Math.ceil(b*R),D=Math.floor(v*R),O=D-P,B=new Float32Array(O);for(let H=0;H<O;H+=1){const z=(S.length-1)/A*((P+H)/R-b),Z=Math.floor(z),ee=Math.ceil(z);B[H]=Z===ee?S[Z]:(1-(z-Z))*S[Z]+(1-(ee-z))*S[ee]}M===null&&x.flush(f.context.currentTime),x.add(u(B,b,A)),_.setValueCurveAtTime(B,b,A);const U=D/R;U<v&&d(E,B[B.length-1],U),d(E,S[S.length-1],v)}else M===null&&x.flush(f.context.currentTime),x.add(u(S,b,A)),_.setValueCurveAtTime(S,b,A);return E}};return t.set(E,_),e.set(E,f),i(E,M),E},AS=i=>({replay(e){for(const t of i)if(t.type==="exponentialRampToValue"){const{endTime:n,value:s}=t;e.exponentialRampToValueAtTime(s,n)}else if(t.type==="linearRampToValue"){const{endTime:n,value:s}=t;e.linearRampToValueAtTime(s,n)}else if(t.type==="setTarget"){const{startTime:n,target:s,timeConstant:r}=t;e.setTargetAtTime(s,n,r)}else if(t.type==="setValue"){const{startTime:n,value:s}=t;e.setValueAtTime(s,n)}else if(t.type==="setValueCurve"){const{duration:n,startTime:s,values:r}=t;e.setValueCurveAtTime(r,s,n)}else throw new Error("Can't apply an unknown automation.")}});class lf{constructor(e){this._map=new Map(e)}get size(){return this._map.size}entries(){return this._map.entries()}forEach(e,t=null){return this._map.forEach((n,s)=>e.call(t,n,s,this))}get(e){return this._map.get(e)}has(e){return this._map.has(e)}keys(){return this._map.keys()}values(){return this._map.values()}}const CS={channelCount:2,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:1,numberOfOutputs:1,parameterData:{},processorOptions:{}},RS=(i,e,t,n,s,r,o,a,c,l,u,h,d,f)=>class extends e{constructor(_,m,p){var y;const x=a(_),M=c(x),E=u({...CS,...p});d(E);const T=Qc.get(x),b=T==null?void 0:T.get(m),A=M||x.state!=="closed"?x:(y=o(x))!==null&&y!==void 0?y:x,S=s(A,M?null:_.baseLatency,l,m,b,E),v=M?n(m,E,b):null;super(_,!0,S,v);const R=[];S.parameters.forEach((D,O)=>{const B=t(this,M,D);R.push([O,B])}),this._nativeAudioWorkletNode=S,this._onprocessorerror=null,this._parameters=new lf(R),M&&i(x,this);const{activeInputs:P}=r(this);h(S,P)}get onprocessorerror(){return this._onprocessorerror}set onprocessorerror(_){const m=typeof _=="function"?f(this,_):null;this._nativeAudioWorkletNode.onprocessorerror=m;const p=this._nativeAudioWorkletNode.onprocessorerror;this._onprocessorerror=p!==null&&p===m?_:p}get parameters(){return this._parameters===null?this._nativeAudioWorkletNode.parameters:this._parameters}get port(){return this._nativeAudioWorkletNode.port}};function Ko(i,e,t,n,s){if(typeof i.copyFromChannel=="function")e[t].byteLength===0&&(e[t]=new Float32Array(128)),i.copyFromChannel(e[t],n,s);else{const r=i.getChannelData(n);if(e[t].byteLength===0)e[t]=r.slice(s,s+128);else{const o=new Float32Array(r.buffer,s*Float32Array.BYTES_PER_ELEMENT,128);e[t].set(o)}}}const uf=(i,e,t,n,s)=>{typeof i.copyToChannel=="function"?e[t].byteLength!==0&&i.copyToChannel(e[t],n,s):e[t].byteLength!==0&&i.getChannelData(n).set(e[t],s)},Qo=(i,e)=>{const t=[];for(let n=0;n<i;n+=1){const s=[],r=typeof e=="number"?e:e[n];for(let o=0;o<r;o+=1)s.push(new Float32Array(128));t.push(s)}return t},IS=(i,e)=>{const t=Mn(Jc,i),n=ht(e);return Mn(t,n)},PS=async(i,e,t,n,s,r,o)=>{const a=e===null?Math.ceil(i.context.length/128)*128:e.length,c=n.channelCount*n.numberOfInputs,l=s.reduce((m,p)=>m+p,0),u=l===0?null:t.createBuffer(l,a,t.sampleRate);if(r===void 0)throw new Error("Missing the processor constructor.");const h=qt(i),d=await IS(t,i),f=Qo(n.numberOfInputs,n.channelCount),g=Qo(n.numberOfOutputs,s),_=Array.from(i.parameters.keys()).reduce((m,p)=>({...m,[p]:new Float32Array(128)}),{});for(let m=0;m<a;m+=128){if(n.numberOfInputs>0&&e!==null)for(let p=0;p<n.numberOfInputs;p+=1)for(let y=0;y<n.channelCount;y+=1)Ko(e,f[p],y,y,m);r.parameterDescriptors!==void 0&&e!==null&&r.parameterDescriptors.forEach(({name:p},y)=>{Ko(e,_,p,c+y,m)});for(let p=0;p<n.numberOfInputs;p+=1)for(let y=0;y<s[p];y+=1)g[p][y].byteLength===0&&(g[p][y]=new Float32Array(128));try{const p=f.map((x,M)=>h.activeInputs[M].size===0?[]:x),y=o(m/t.sampleRate,t.sampleRate,()=>d.process(p,g,_));if(u!==null)for(let x=0,M=0;x<n.numberOfOutputs;x+=1){for(let E=0;E<s[x];E+=1)uf(u,g[x],E,M+E,m);M+=s[x]}if(!y)break}catch(p){i.dispatchEvent(new ErrorEvent("processorerror",{colno:p.colno,filename:p.filename,lineno:p.lineno,message:p.message}));break}}return u},DS=(i,e,t,n,s,r,o,a,c,l,u,h,d,f,g,_)=>(m,p,y)=>{const x=new WeakMap;let M=null;const E=async(T,b)=>{let A=u(T),S=null;const v=zt(A,b),R=Array.isArray(p.outputChannelCount)?p.outputChannelCount:Array.from(p.outputChannelCount);if(h===null){const P=R.reduce((U,H)=>U+H,0),D=s(b,{channelCount:Math.max(1,P),channelCountMode:"explicit",channelInterpretation:"discrete",numberOfOutputs:Math.max(1,P)}),O=[];for(let U=0;U<T.numberOfOutputs;U+=1)O.push(n(b,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:R[U]}));const B=o(b,{channelCount:p.channelCount,channelCountMode:p.channelCountMode,channelInterpretation:p.channelInterpretation,gain:1});B.connect=e.bind(null,O),B.disconnect=c.bind(null,O),S=[D,O,B]}else v||(A=new h(b,m));if(x.set(b,S===null?A:S[2]),S!==null){if(M===null){if(y===void 0)throw new Error("Missing the processor constructor.");if(d===null)throw new Error("Missing the native OfflineAudioContext constructor.");const H=T.channelCount*T.numberOfInputs,z=y.parameterDescriptors===void 0?0:y.parameterDescriptors.length,Z=H+z;M=PS(T,Z===0?null:await(async()=>{const te=new d(Z,Math.ceil(T.context.length/128)*128,b.sampleRate),ve=[],Oe=[];for(let oe=0;oe<p.numberOfInputs;oe+=1)ve.push(o(te,{channelCount:p.channelCount,channelCountMode:p.channelCountMode,channelInterpretation:p.channelInterpretation,gain:1})),Oe.push(s(te,{channelCount:p.channelCount,channelCountMode:"explicit",channelInterpretation:"discrete",numberOfOutputs:p.channelCount}));const X=await Promise.all(Array.from(T.parameters.values()).map(async oe=>{const re=r(te,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",offset:oe.value});return await f(te,oe,re.offset),re})),j=n(te,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:Math.max(1,H+z)});for(let oe=0;oe<p.numberOfInputs;oe+=1){ve[oe].connect(Oe[oe]);for(let re=0;re<p.channelCount;re+=1)Oe[oe].connect(j,re,oe*p.channelCount+re)}for(const[oe,re]of X.entries())re.connect(j,0,H+oe),re.start(0);return j.connect(te.destination),await Promise.all(ve.map(oe=>g(T,te,oe))),_(te)})(),b,p,R,y,l)}const P=await M,D=t(b,{buffer:null,channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",loop:!1,loopEnd:0,loopStart:0,playbackRate:1}),[O,B,U]=S;P!==null&&(D.buffer=P,D.start(0)),D.connect(O);for(let H=0,z=0;H<T.numberOfOutputs;H+=1){const Z=B[H];for(let ee=0;ee<R[H];ee+=1)O.connect(Z,z+ee,ee);z+=R[H]}return U}if(v)for(const[P,D]of T.parameters.entries())await i(b,D,A.parameters.get(P));else for(const[P,D]of T.parameters.entries())await f(b,D,A.parameters.get(P));return await g(T,b,A),A};return{render(T,b){a(b,T);const A=x.get(b);return A!==void 0?Promise.resolve(A):E(T,b)}}},NS=(i,e,t,n,s,r,o,a,c,l,u,h,d,f,g,_,m,p,y,x)=>class extends g{constructor(E,T){super(E,T),this._nativeContext=E,this._audioWorklet=i===void 0?void 0:{addModule:(b,A)=>i(this,b,A)}}get audioWorklet(){return this._audioWorklet}createAnalyser(){return new e(this)}createBiquadFilter(){return new s(this)}createBuffer(E,T,b){return new t({length:T,numberOfChannels:E,sampleRate:b})}createBufferSource(){return new n(this)}createChannelMerger(E=6){return new r(this,{numberOfInputs:E})}createChannelSplitter(E=6){return new o(this,{numberOfOutputs:E})}createConstantSource(){return new a(this)}createConvolver(){return new c(this)}createDelay(E=1){return new u(this,{maxDelayTime:E})}createDynamicsCompressor(){return new h(this)}createGain(){return new d(this)}createIIRFilter(E,T){return new f(this,{feedback:T,feedforward:E})}createOscillator(){return new _(this)}createPanner(){return new m(this)}createPeriodicWave(E,T,b={disableNormalization:!1}){return new p(this,{...b,imag:T,real:E})}createStereoPanner(){return new y(this)}createWaveShaper(){return new x(this)}decodeAudioData(E,T,b){return l(this._nativeContext,E).then(A=>(typeof T=="function"&&T(A),A),A=>{throw typeof b=="function"&&b(A),A})}},LS={Q:1,channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",detune:0,frequency:350,gain:0,type:"lowpass"},OS=(i,e,t,n,s,r,o,a)=>class extends i{constructor(l,u){const h=r(l),d={...LS,...u},f=s(h,d),g=o(h),_=g?t():null;super(l,!1,f,_),this._Q=e(this,g,f.Q,Wt,Zt),this._detune=e(this,g,f.detune,1200*Math.log2(Wt),-1200*Math.log2(Wt)),this._frequency=e(this,g,f.frequency,l.sampleRate/2,0),this._gain=e(this,g,f.gain,40*Math.log10(Wt),Zt),this._nativeBiquadFilterNode=f,a(this,1)}get detune(){return this._detune}get frequency(){return this._frequency}get gain(){return this._gain}get Q(){return this._Q}get type(){return this._nativeBiquadFilterNode.type}set type(l){this._nativeBiquadFilterNode.type=l}getFrequencyResponse(l,u,h){try{this._nativeBiquadFilterNode.getFrequencyResponse(l,u,h)}catch(d){throw d.code===11?n():d}if(l.length!==u.length||u.length!==h.length)throw n()}},US=(i,e,t,n,s)=>()=>{const r=new WeakMap,o=async(a,c)=>{let l=t(a);const u=zt(l,c);if(!u){const h={Q:l.Q.value,channelCount:l.channelCount,channelCountMode:l.channelCountMode,channelInterpretation:l.channelInterpretation,detune:l.detune.value,frequency:l.frequency.value,gain:l.gain.value,type:l.type};l=e(c,h)}return r.set(c,l),u?(await i(c,a.Q,l.Q),await i(c,a.detune,l.detune),await i(c,a.frequency,l.frequency),await i(c,a.gain,l.gain)):(await n(c,a.Q,l.Q),await n(c,a.detune,l.detune),await n(c,a.frequency,l.frequency),await n(c,a.gain,l.gain)),await s(a,c,l),l};return{render(a,c){const l=r.get(c);return l!==void 0?Promise.resolve(l):o(a,c)}}},FS=(i,e)=>(t,n)=>{const s=e.get(t);if(s!==void 0)return s;const r=i.get(t);if(r!==void 0)return r;try{const o=n();return o instanceof Promise?(i.set(t,o),o.catch(()=>!1).then(a=>(i.delete(t),e.set(t,a),a))):(e.set(t,o),o)}catch{return e.set(t,!1),!1}},kS={channelCount:1,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:6},BS=(i,e,t,n,s)=>class extends i{constructor(o,a){const c=n(o),l={...kS,...a},u=t(c,l),h=s(c)?e():null;super(o,!1,u,h)}},VS=(i,e,t)=>()=>{const n=new WeakMap,s=async(r,o)=>{let a=e(r);if(!zt(a,o)){const l={channelCount:a.channelCount,channelCountMode:a.channelCountMode,channelInterpretation:a.channelInterpretation,numberOfInputs:a.numberOfInputs};a=i(o,l)}return n.set(o,a),await t(r,o,a),a};return{render(r,o){const a=n.get(o);return a!==void 0?Promise.resolve(a):s(r,o)}}},zS={channelCount:6,channelCountMode:"explicit",channelInterpretation:"discrete",numberOfOutputs:6},HS=(i,e,t,n,s,r)=>class extends i{constructor(a,c){const l=n(a),u=r({...zS,...c}),h=t(l,u),d=s(l)?e():null;super(a,!1,h,d)}},GS=(i,e,t)=>()=>{const n=new WeakMap,s=async(r,o)=>{let a=e(r);if(!zt(a,o)){const l={channelCount:a.channelCount,channelCountMode:a.channelCountMode,channelInterpretation:a.channelInterpretation,numberOfOutputs:a.numberOfOutputs};a=i(o,l)}return n.set(o,a),await t(r,o,a),a};return{render(r,o){const a=n.get(o);return a!==void 0?Promise.resolve(a):s(r,o)}}},WS=i=>(e,t,n)=>i(t,e,n),qS=i=>(e,t,n=0,s=0)=>{const r=e[n];if(r===void 0)throw i();return Zo(t)?r.connect(t,0,s):r.connect(t,0)},XS=i=>(e,t)=>{const n=i(e,{buffer:null,channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",loop:!1,loopEnd:0,loopStart:0,playbackRate:1}),s=e.createBuffer(1,2,44100);return n.buffer=s,n.loop=!0,n.connect(t),n.start(),()=>{n.stop(),n.disconnect(t)}},jS={channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",offset:1},YS=(i,e,t,n,s,r,o)=>class extends i{constructor(c,l){const u=s(c),h={...jS,...l},d=n(u,h),f=r(u),g=f?t():null;super(c,!1,d,g),this._constantSourceNodeRenderer=g,this._nativeConstantSourceNode=d,this._offset=e(this,f,d.offset,Wt,Zt),this._onended=null}get offset(){return this._offset}get onended(){return this._onended}set onended(c){const l=typeof c=="function"?o(this,c):null;this._nativeConstantSourceNode.onended=l;const u=this._nativeConstantSourceNode.onended;this._onended=u!==null&&u===l?c:u}start(c=0){if(this._nativeConstantSourceNode.start(c),this._constantSourceNodeRenderer!==null&&(this._constantSourceNodeRenderer.start=c),this.context.state!=="closed"){js(this);const l=()=>{this._nativeConstantSourceNode.removeEventListener("ended",l),ni(this)&&zr(this)};this._nativeConstantSourceNode.addEventListener("ended",l)}}stop(c=0){this._nativeConstantSourceNode.stop(c),this._constantSourceNodeRenderer!==null&&(this._constantSourceNodeRenderer.stop=c)}},$S=(i,e,t,n,s)=>()=>{const r=new WeakMap;let o=null,a=null;const c=async(l,u)=>{let h=t(l);const d=zt(h,u);if(!d){const f={channelCount:h.channelCount,channelCountMode:h.channelCountMode,channelInterpretation:h.channelInterpretation,offset:h.offset.value};h=e(u,f),o!==null&&h.start(o),a!==null&&h.stop(a)}return r.set(u,h),d?await i(u,l.offset,h.offset):await n(u,l.offset,h.offset),await s(l,u,h),h};return{set start(l){o=l},set stop(l){a=l},render(l,u){const h=r.get(u);return h!==void 0?Promise.resolve(h):c(l,u)}}},ZS=i=>e=>(i[0]=e,i[0]),KS={buffer:null,channelCount:2,channelCountMode:"clamped-max",channelInterpretation:"speakers",disableNormalization:!1},QS=(i,e,t,n,s,r)=>class extends i{constructor(a,c){const l=n(a),u={...KS,...c},h=t(l,u),f=s(l)?e():null;super(a,!1,h,f),this._isBufferNullified=!1,this._nativeConvolverNode=h,u.buffer!==null&&r(this,u.buffer.duration)}get buffer(){return this._isBufferNullified?null:this._nativeConvolverNode.buffer}set buffer(a){if(this._nativeConvolverNode.buffer=a,a===null&&this._nativeConvolverNode.buffer!==null){const c=this._nativeConvolverNode.context;this._nativeConvolverNode.buffer=c.createBuffer(1,1,c.sampleRate),this._isBufferNullified=!0,r(this,0)}else this._isBufferNullified=!1,r(this,this._nativeConvolverNode.buffer===null?0:this._nativeConvolverNode.buffer.duration)}get normalize(){return this._nativeConvolverNode.normalize}set normalize(a){this._nativeConvolverNode.normalize=a}},JS=(i,e,t)=>()=>{const n=new WeakMap,s=async(r,o)=>{let a=e(r);if(!zt(a,o)){const l={buffer:a.buffer,channelCount:a.channelCount,channelCountMode:a.channelCountMode,channelInterpretation:a.channelInterpretation,disableNormalization:!a.normalize};a=i(o,l)}return n.set(o,a),rr(a)?await t(r,o,a.inputs[0]):await t(r,o,a),a};return{render(r,o){const a=n.get(o);return a!==void 0?Promise.resolve(a):s(r,o)}}},eM=(i,e)=>(t,n,s)=>{if(e===null)throw new Error("Missing the native OfflineAudioContext constructor.");try{return new e(t,n,s)}catch(r){throw r.name==="SyntaxError"?i():r}},tM=()=>new DOMException("","DataCloneError"),jh=i=>{const{port1:e,port2:t}=new MessageChannel;return new Promise(n=>{const s=()=>{t.onmessage=null,e.close(),t.close(),n()};t.onmessage=()=>s();try{e.postMessage(i,[i])}catch{}finally{s()}})},nM=(i,e,t,n,s,r,o,a,c,l,u)=>(h,d)=>{const f=o(h)?h:r(h);if(s.has(d)){const g=t();return Promise.reject(g)}try{s.add(d)}catch{}return e(c,()=>c(f))?f.decodeAudioData(d).then(g=>(jh(d).catch(()=>{}),e(a,()=>a(g))||u(g),i.add(g),g)):new Promise((g,_)=>{const m=async()=>{try{await jh(d)}catch{}},p=y=>{_(y),m()};try{f.decodeAudioData(d,y=>{typeof y.copyFromChannel!="function"&&(l(y),Rl(y)),i.add(y),m().then(()=>g(y))},y=>{p(y===null?n():y)})}catch(y){p(y)}})},iM=(i,e,t,n,s,r,o,a)=>(c,l)=>{const u=e.get(c);if(u===void 0)throw new Error("Missing the expected cycle count.");const h=r(c.context),d=a(h);if(u===l){if(e.delete(c),!d&&o(c)){const f=n(c),{outputs:g}=t(c);for(const _ of g)if(Gr(_)){const m=n(_[0]);i(f,m,_[1],_[2])}else{const m=s(_[0]);f.connect(m,_[1])}}}else e.set(c,u-l)},sM={channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",delayTime:0,maxDelayTime:1},rM=(i,e,t,n,s,r,o)=>class extends i{constructor(c,l){const u=s(c),h={...sM,...l},d=n(u,h),f=r(u),g=f?t(h.maxDelayTime):null;super(c,!1,d,g),this._delayTime=e(this,f,d.delayTime),o(this,h.maxDelayTime)}get delayTime(){return this._delayTime}},oM=(i,e,t,n,s)=>r=>{const o=new WeakMap,a=async(c,l)=>{let u=t(c);const h=zt(u,l);if(!h){const d={channelCount:u.channelCount,channelCountMode:u.channelCountMode,channelInterpretation:u.channelInterpretation,delayTime:u.delayTime.value,maxDelayTime:r};u=e(l,d)}return o.set(l,u),h?await i(l,c.delayTime,u.delayTime):await n(l,c.delayTime,u.delayTime),await s(c,l,u),u};return{render(c,l){const u=o.get(l);return u!==void 0?Promise.resolve(u):a(c,l)}}},aM=i=>(e,t,n,s)=>i(e[s],r=>r[0]===t&&r[1]===n),cM=i=>(e,t)=>{i(e).delete(t)},lM=i=>"delayTime"in i,uM=(i,e,t)=>function n(s,r){const o=jo(r)?r:t(i,r);if(lM(o))return[];if(s[0]===o)return[s];if(s.includes(o))return[];const{outputs:a}=e(o);return Array.from(a).map(c=>n([...s,o],c[0])).reduce((c,l)=>c.concat(l),[])},Eo=(i,e,t)=>{const n=e[t];if(n===void 0)throw i();return n},hM=i=>(e,t=void 0,n=void 0,s=0)=>t===void 0?e.forEach(r=>r.disconnect()):typeof t=="number"?Eo(i,e,t).disconnect():Zo(t)?n===void 0?e.forEach(r=>r.disconnect(t)):s===void 0?Eo(i,e,n).disconnect(t,0):Eo(i,e,n).disconnect(t,0,s):n===void 0?e.forEach(r=>r.disconnect(t)):Eo(i,e,n).disconnect(t,0),dM={attack:.003,channelCount:2,channelCountMode:"clamped-max",channelInterpretation:"speakers",knee:30,ratio:12,release:.25,threshold:-24},fM=(i,e,t,n,s,r,o,a)=>class extends i{constructor(l,u){const h=r(l),d={...dM,...u},f=n(h,d),g=o(h),_=g?t():null;super(l,!1,f,_),this._attack=e(this,g,f.attack),this._knee=e(this,g,f.knee),this._nativeDynamicsCompressorNode=f,this._ratio=e(this,g,f.ratio),this._release=e(this,g,f.release),this._threshold=e(this,g,f.threshold),a(this,.006)}get attack(){return this._attack}get channelCount(){return this._nativeDynamicsCompressorNode.channelCount}set channelCount(l){const u=this._nativeDynamicsCompressorNode.channelCount;if(this._nativeDynamicsCompressorNode.channelCount=l,l>2)throw this._nativeDynamicsCompressorNode.channelCount=u,s()}get channelCountMode(){return this._nativeDynamicsCompressorNode.channelCountMode}set channelCountMode(l){const u=this._nativeDynamicsCompressorNode.channelCountMode;if(this._nativeDynamicsCompressorNode.channelCountMode=l,l==="max")throw this._nativeDynamicsCompressorNode.channelCountMode=u,s()}get knee(){return this._knee}get ratio(){return this._ratio}get reduction(){return typeof this._nativeDynamicsCompressorNode.reduction.value=="number"?this._nativeDynamicsCompressorNode.reduction.value:this._nativeDynamicsCompressorNode.reduction}get release(){return this._release}get threshold(){return this._threshold}},pM=(i,e,t,n,s)=>()=>{const r=new WeakMap,o=async(a,c)=>{let l=t(a);const u=zt(l,c);if(!u){const h={attack:l.attack.value,channelCount:l.channelCount,channelCountMode:l.channelCountMode,channelInterpretation:l.channelInterpretation,knee:l.knee.value,ratio:l.ratio.value,release:l.release.value,threshold:l.threshold.value};l=e(c,h)}return r.set(c,l),u?(await i(c,a.attack,l.attack),await i(c,a.knee,l.knee),await i(c,a.ratio,l.ratio),await i(c,a.release,l.release),await i(c,a.threshold,l.threshold)):(await n(c,a.attack,l.attack),await n(c,a.knee,l.knee),await n(c,a.ratio,l.ratio),await n(c,a.release,l.release),await n(c,a.threshold,l.threshold)),await s(a,c,l),l};return{render(a,c){const l=r.get(c);return l!==void 0?Promise.resolve(l):o(a,c)}}},mM=()=>new DOMException("","EncodingError"),gM=i=>e=>new Promise((t,n)=>{if(i===null){n(new SyntaxError);return}const s=i.document.head;if(s===null)n(new SyntaxError);else{const r=i.document.createElement("script"),o=new Blob([e],{type:"application/javascript"}),a=URL.createObjectURL(o),c=i.onerror,l=()=>{i.onerror=c,URL.revokeObjectURL(a)};i.onerror=(u,h,d,f,g)=>{if(h===a||h===i.location.href&&d===1&&f===1)return l(),n(g),!1;if(c!==null)return c(u,h,d,f,g)},r.onerror=()=>{l(),n(new SyntaxError)},r.onload=()=>{l(),t()},r.src=a,r.type="module",s.appendChild(r)}}),_M=i=>class{constructor(t){this._nativeEventTarget=t,this._listeners=new WeakMap}addEventListener(t,n,s){if(n!==null){let r=this._listeners.get(n);r===void 0&&(r=i(this,n),typeof n=="function"&&this._listeners.set(n,r)),this._nativeEventTarget.addEventListener(t,r,s)}}dispatchEvent(t){return this._nativeEventTarget.dispatchEvent(t)}removeEventListener(t,n,s){const r=n===null?void 0:this._listeners.get(n);this._nativeEventTarget.removeEventListener(t,r===void 0?null:r,s)}},vM=i=>(e,t,n)=>{Object.defineProperties(i,{currentFrame:{configurable:!0,get(){return Math.round(e*t)}},currentTime:{configurable:!0,get(){return e}}});try{return n()}finally{i!==null&&(delete i.currentFrame,delete i.currentTime)}},xM=i=>async e=>{try{const t=await fetch(e);if(t.ok)return[await t.text(),t.url]}catch{}throw i()},yM={channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",gain:1},SM=(i,e,t,n,s,r)=>class extends i{constructor(a,c){const l=s(a),u={...yM,...c},h=n(l,u),d=r(l),f=d?t():null;super(a,!1,h,f),this._gain=e(this,d,h.gain,Wt,Zt)}get gain(){return this._gain}},MM=(i,e,t,n,s)=>()=>{const r=new WeakMap,o=async(a,c)=>{let l=t(a);const u=zt(l,c);if(!u){const h={channelCount:l.channelCount,channelCountMode:l.channelCountMode,channelInterpretation:l.channelInterpretation,gain:l.gain.value};l=e(c,h)}return r.set(c,l),u?await i(c,a.gain,l.gain):await n(c,a.gain,l.gain),await s(a,c,l),l};return{render(a,c){const l=r.get(c);return l!==void 0?Promise.resolve(l):o(a,c)}}},TM=(i,e)=>t=>e(i,t),bM=i=>e=>{const t=i(e);if(t.renderer===null)throw new Error("Missing the renderer of the given AudioNode in the audio graph.");return t.renderer},EM=i=>e=>{var t;return(t=i.get(e))!==null&&t!==void 0?t:0},wM=i=>e=>{const t=i(e);if(t.renderer===null)throw new Error("Missing the renderer of the given AudioParam in the audio graph.");return t.renderer},AM=i=>e=>i.get(e),Nt=()=>new DOMException("","InvalidStateError"),CM=i=>e=>{const t=i.get(e);if(t===void 0)throw Nt();return t},RM=(i,e)=>t=>{let n=i.get(t);if(n!==void 0)return n;if(e===null)throw new Error("Missing the native OfflineAudioContext constructor.");return n=new e(1,1,44100),i.set(t,n),n},IM=i=>e=>{const t=i.get(e);if(t===void 0)throw new Error("The context has no set of AudioWorkletNodes.");return t},Ba=()=>new DOMException("","InvalidAccessError"),PM=i=>{i.getFrequencyResponse=(e=>(t,n,s)=>{if(t.length!==n.length||n.length!==s.length)throw Ba();return e.call(i,t,n,s)})(i.getFrequencyResponse)},DM={channelCount:2,channelCountMode:"max",channelInterpretation:"speakers"},NM=(i,e,t,n,s,r)=>class extends i{constructor(a,c){const l=n(a),u=s(l),h={...DM,...c},d=e(l,u?null:a.baseLatency,h),f=u?t(h.feedback,h.feedforward):null;super(a,!1,d,f),PM(d),this._nativeIIRFilterNode=d,r(this,1)}getFrequencyResponse(a,c,l){return this._nativeIIRFilterNode.getFrequencyResponse(a,c,l)}},hf=(i,e,t,n,s,r,o,a,c,l,u)=>{const h=l.length;let d=a;for(let f=0;f<h;f+=1){let g=t[0]*l[f];for(let _=1;_<s;_+=1){const m=d-_&c-1;g+=t[_]*r[m],g-=i[_]*o[m]}for(let _=s;_<n;_+=1)g+=t[_]*r[d-_&c-1];for(let _=s;_<e;_+=1)g-=i[_]*o[d-_&c-1];r[d]=l[f],o[d]=g,d=d+1&c-1,u[f]=g}return d},LM=(i,e,t,n)=>{const s=t instanceof Float64Array?t:new Float64Array(t),r=n instanceof Float64Array?n:new Float64Array(n),o=s.length,a=r.length,c=Math.min(o,a);if(s[0]!==1){for(let g=0;g<o;g+=1)r[g]/=s[0];for(let g=1;g<a;g+=1)s[g]/=s[0]}const l=32,u=new Float32Array(l),h=new Float32Array(l),d=e.createBuffer(i.numberOfChannels,i.length,i.sampleRate),f=i.numberOfChannels;for(let g=0;g<f;g+=1){const _=i.getChannelData(g),m=d.getChannelData(g);u.fill(0),h.fill(0),hf(s,o,r,a,c,u,h,0,l,_,m)}return d},OM=(i,e,t,n,s)=>(r,o)=>{const a=new WeakMap;let c=null;const l=async(u,h)=>{let d=null,f=e(u);const g=zt(f,h);if(h.createIIRFilter===void 0?d=i(h,{buffer:null,channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",loop:!1,loopEnd:0,loopStart:0,playbackRate:1}):g||(f=h.createIIRFilter(o,r)),a.set(h,d===null?f:d),d!==null){if(c===null){if(t===null)throw new Error("Missing the native OfflineAudioContext constructor.");const m=new t(u.context.destination.channelCount,u.context.length,h.sampleRate);c=(async()=>{await n(u,m,m.destination);const p=await s(m);return LM(p,h,r,o)})()}const _=await c;return d.buffer=_,d.start(0),d}return await n(u,h,f),f};return{render(u,h){const d=a.get(h);return d!==void 0?Promise.resolve(d):l(u,h)}}},UM=(i,e,t,n,s,r)=>o=>(a,c)=>{const l=i.get(a);if(l===void 0){if(!o&&r(a)){const u=n(a),{outputs:h}=t(a);for(const d of h)if(Gr(d)){const f=n(d[0]);e(u,f,d[1],d[2])}else{const f=s(d[0]);u.disconnect(f,d[1])}}i.set(a,c)}else i.set(a,l+c)},FM=(i,e)=>t=>{const n=i.get(t);return e(n)||e(t)},kM=(i,e)=>t=>i.has(t)||e(t),BM=(i,e)=>t=>i.has(t)||e(t),VM=(i,e)=>t=>{const n=i.get(t);return e(n)||e(t)},zM=i=>e=>i!==null&&e instanceof i,HM=i=>e=>i!==null&&typeof i.AudioNode=="function"&&e instanceof i.AudioNode,GM=i=>e=>i!==null&&typeof i.AudioParam=="function"&&e instanceof i.AudioParam,WM=(i,e)=>t=>i(t)||e(t),qM=i=>e=>i!==null&&e instanceof i,XM=i=>i!==null&&i.isSecureContext,jM=(i,e,t,n)=>class extends i{constructor(r,o){const a=t(r),c=e(a,o);if(n(a))throw TypeError();super(r,!0,c,null),this._nativeMediaElementAudioSourceNode=c}get mediaElement(){return this._nativeMediaElementAudioSourceNode.mediaElement}},YM={channelCount:2,channelCountMode:"explicit",channelInterpretation:"speakers"},$M=(i,e,t,n)=>class extends i{constructor(r,o){const a=t(r);if(n(a))throw new TypeError;const c={...YM,...o},l=e(a,c);super(r,!1,l,null),this._nativeMediaStreamAudioDestinationNode=l}get stream(){return this._nativeMediaStreamAudioDestinationNode.stream}},ZM=(i,e,t,n)=>class extends i{constructor(r,o){const a=t(r),c=e(a,o);if(n(a))throw new TypeError;super(r,!0,c,null),this._nativeMediaStreamAudioSourceNode=c}get mediaStream(){return this._nativeMediaStreamAudioSourceNode.mediaStream}},KM=(i,e,t)=>class extends i{constructor(s,r){const o=t(s),a=e(o,r);super(s,!0,a,null)}},QM=(i,e,t,n,s,r)=>class extends t{constructor(a,c){super(a),this._nativeContext=a,Fa.set(this,a),n(a)&&s.set(a,new Set),this._destination=new i(this,c),this._listener=e(this,a),this._onstatechange=null}get currentTime(){return this._nativeContext.currentTime}get destination(){return this._destination}get listener(){return this._listener}get onstatechange(){return this._onstatechange}set onstatechange(a){const c=typeof a=="function"?r(this,a):null;this._nativeContext.onstatechange=c;const l=this._nativeContext.onstatechange;this._onstatechange=l!==null&&l===c?a:l}get sampleRate(){return this._nativeContext.sampleRate}get state(){return this._nativeContext.state}},Mr=i=>{const e=new Uint32Array([1179011410,40,1163280727,544501094,16,131073,44100,176400,1048580,1635017060,4,0]);try{const t=i.decodeAudioData(e.buffer,()=>{});return t===void 0?!1:(t.catch(()=>{}),!0)}catch{}return!1},JM=(i,e)=>(t,n,s)=>{const r=new Set;return t.connect=(o=>(a,c=0,l=0)=>{const u=r.size===0;if(e(a))return o.call(t,a,c,l),i(r,[a,c,l],h=>h[0]===a&&h[1]===c&&h[2]===l,!0),u&&n(),a;o.call(t,a,c),i(r,[a,c],h=>h[0]===a&&h[1]===c,!0),u&&n()})(t.connect),t.disconnect=(o=>(a,c,l)=>{const u=r.size>0;if(a===void 0)o.apply(t),r.clear();else if(typeof a=="number"){o.call(t,a);for(const d of r)d[1]===a&&r.delete(d)}else{e(a)?o.call(t,a,c,l):o.call(t,a,c);for(const d of r)d[0]===a&&(c===void 0||d[1]===c)&&(l===void 0||d[2]===l)&&r.delete(d)}const h=r.size===0;u&&h&&s()})(t.disconnect),t},dt=(i,e,t)=>{const n=e[t];n!==void 0&&n!==i[t]&&(i[t]=n)},Ct=(i,e)=>{dt(i,e,"channelCount"),dt(i,e,"channelCountMode"),dt(i,e,"channelInterpretation")},Yh=i=>typeof i.getFloatTimeDomainData=="function",eT=i=>{i.getFloatTimeDomainData=e=>{const t=new Uint8Array(e.length);i.getByteTimeDomainData(t);const n=Math.max(t.length,i.fftSize);for(let s=0;s<n;s+=1)e[s]=(t[s]-128)*.0078125;return e}},tT=(i,e)=>(t,n)=>{const s=t.createAnalyser();if(Ct(s,n),!(n.maxDecibels>n.minDecibels))throw e();return dt(s,n,"fftSize"),dt(s,n,"maxDecibels"),dt(s,n,"minDecibels"),dt(s,n,"smoothingTimeConstant"),i(Yh,()=>Yh(s))||eT(s),s},nT=i=>i===null?null:i.hasOwnProperty("AudioBuffer")?i.AudioBuffer:null,mt=(i,e,t)=>{const n=e[t];n!==void 0&&n!==i[t].value&&(i[t].value=n)},iT=i=>{i.start=(e=>{let t=!1;return(n=0,s=0,r)=>{if(t)throw Nt();e.call(i,n,s,r),t=!0}})(i.start)},Dl=i=>{i.start=(e=>(t=0,n=0,s)=>{if(typeof s=="number"&&s<0||n<0||t<0)throw new RangeError("The parameters can't be negative.");e.call(i,t,n,s)})(i.start)},Nl=i=>{i.stop=(e=>(t=0)=>{if(t<0)throw new RangeError("The parameter can't be negative.");e.call(i,t)})(i.stop)},sT=(i,e,t,n,s,r,o,a,c,l,u)=>(h,d)=>{const f=h.createBufferSource();return Ct(f,d),mt(f,d,"playbackRate"),dt(f,d,"buffer"),dt(f,d,"loop"),dt(f,d,"loopEnd"),dt(f,d,"loopStart"),e(t,()=>t(h))||iT(f),e(n,()=>n(h))||c(f),e(s,()=>s(h))||l(f,h),e(r,()=>r(h))||Dl(f),e(o,()=>o(h))||u(f,h),e(a,()=>a(h))||Nl(f),i(h,f),f},rT=i=>i===null?null:i.hasOwnProperty("AudioContext")?i.AudioContext:i.hasOwnProperty("webkitAudioContext")?i.webkitAudioContext:null,oT=(i,e)=>(t,n,s)=>{const r=t.destination;if(r.channelCount!==n)try{r.channelCount=n}catch{}s&&r.channelCountMode!=="explicit"&&(r.channelCountMode="explicit"),r.maxChannelCount===0&&Object.defineProperty(r,"maxChannelCount",{value:n});const o=i(t,{channelCount:n,channelCountMode:r.channelCountMode,channelInterpretation:r.channelInterpretation,gain:1});return e(o,"channelCount",a=>()=>a.call(o),a=>c=>{a.call(o,c);try{r.channelCount=c}catch(l){if(c>r.maxChannelCount)throw l}}),e(o,"channelCountMode",a=>()=>a.call(o),a=>c=>{a.call(o,c),r.channelCountMode=c}),e(o,"channelInterpretation",a=>()=>a.call(o),a=>c=>{a.call(o,c),r.channelInterpretation=c}),Object.defineProperty(o,"maxChannelCount",{get:()=>r.maxChannelCount}),o.connect(r),o},aT=i=>i===null?null:i.hasOwnProperty("AudioWorkletNode")?i.AudioWorkletNode:null,cT=i=>{const{port1:e}=new MessageChannel;try{e.postMessage(i)}finally{e.close()}},lT=(i,e,t,n,s)=>(r,o,a,c,l,u)=>{if(a!==null)try{const h=new a(r,c,u),d=new Map;let f=null;if(Object.defineProperties(h,{channelCount:{get:()=>u.channelCount,set:()=>{throw i()}},channelCountMode:{get:()=>"explicit",set:()=>{throw i()}},onprocessorerror:{get:()=>f,set:g=>{typeof f=="function"&&h.removeEventListener("processorerror",f),f=typeof g=="function"?g:null,typeof f=="function"&&h.addEventListener("processorerror",f)}}}),h.addEventListener=(g=>(..._)=>{if(_[0]==="processorerror"){const m=typeof _[1]=="function"?_[1]:typeof _[1]=="object"&&_[1]!==null&&typeof _[1].handleEvent=="function"?_[1].handleEvent:null;if(m!==null){const p=d.get(_[1]);p!==void 0?_[1]=p:(_[1]=y=>{y.type==="error"?(Object.defineProperties(y,{type:{value:"processorerror"}}),m(y)):m(new ErrorEvent(_[0],{...y}))},d.set(m,_[1]))}}return g.call(h,"error",_[1],_[2]),g.call(h,..._)})(h.addEventListener),h.removeEventListener=(g=>(..._)=>{if(_[0]==="processorerror"){const m=d.get(_[1]);m!==void 0&&(d.delete(_[1]),_[1]=m)}return g.call(h,"error",_[1],_[2]),g.call(h,_[0],_[1],_[2])})(h.removeEventListener),u.numberOfOutputs!==0){const g=t(r,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",gain:0});return h.connect(g).connect(r.destination),s(h,()=>g.disconnect(),()=>g.connect(r.destination))}return h}catch(h){throw h.code===11?n():h}if(l===void 0)throw n();return cT(u),e(r,o,l,u)},df=(i,e)=>i===null?512:Math.max(512,Math.min(16384,Math.pow(2,Math.round(Math.log2(i*e))))),uT=i=>new Promise((e,t)=>{const{port1:n,port2:s}=new MessageChannel;n.onmessage=({data:r})=>{n.close(),s.close(),e(r)},n.onmessageerror=({data:r})=>{n.close(),s.close(),t(r)},s.postMessage(i)}),hT=async(i,e)=>{const t=await uT(e);return new i(t)},dT=(i,e,t,n)=>{let s=Jc.get(i);s===void 0&&(s=new WeakMap,Jc.set(i,s));const r=hT(t,n);return s.set(e,r),r},fT=(i,e,t,n,s,r,o,a,c,l,u,h,d)=>(f,g,_,m)=>{if(m.numberOfInputs===0&&m.numberOfOutputs===0)throw c();const p=Array.isArray(m.outputChannelCount)?m.outputChannelCount:Array.from(m.outputChannelCount);if(p.some(Y=>Y<1))throw c();if(p.length!==m.numberOfOutputs)throw e();if(m.channelCountMode!=="explicit")throw c();const y=m.channelCount*m.numberOfInputs,x=p.reduce((Y,ue)=>Y+ue,0),M=_.parameterDescriptors===void 0?0:_.parameterDescriptors.length;if(y+M>6||x>6)throw c();const E=new MessageChannel,T=[],b=[];for(let Y=0;Y<m.numberOfInputs;Y+=1)T.push(o(f,{channelCount:m.channelCount,channelCountMode:m.channelCountMode,channelInterpretation:m.channelInterpretation,gain:1})),b.push(s(f,{channelCount:m.channelCount,channelCountMode:"explicit",channelInterpretation:"discrete",numberOfOutputs:m.channelCount}));const A=[];if(_.parameterDescriptors!==void 0)for(const{defaultValue:Y,maxValue:ue,minValue:Se,name:_e}of _.parameterDescriptors){const we=r(f,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",offset:m.parameterData[_e]!==void 0?m.parameterData[_e]:Y===void 0?0:Y});Object.defineProperties(we.offset,{defaultValue:{get:()=>Y===void 0?0:Y},maxValue:{get:()=>ue===void 0?Wt:ue},minValue:{get:()=>Se===void 0?Zt:Se}}),A.push(we)}const S=n(f,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:Math.max(1,y+M)}),v=df(g,f.sampleRate),R=a(f,v,y+M,Math.max(1,x)),P=s(f,{channelCount:Math.max(1,x),channelCountMode:"explicit",channelInterpretation:"discrete",numberOfOutputs:Math.max(1,x)}),D=[];for(let Y=0;Y<m.numberOfOutputs;Y+=1)D.push(n(f,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:p[Y]}));for(let Y=0;Y<m.numberOfInputs;Y+=1){T[Y].connect(b[Y]);for(let ue=0;ue<m.channelCount;ue+=1)b[Y].connect(S,ue,Y*m.channelCount+ue)}const O=new lf(_.parameterDescriptors===void 0?[]:_.parameterDescriptors.map(({name:Y},ue)=>{const Se=A[ue];return Se.connect(S,0,y+ue),Se.start(0),[Y,Se.offset]}));S.connect(R);let B=m.channelInterpretation,U=null;const H=m.numberOfOutputs===0?[R]:D,z={get bufferSize(){return v},get channelCount(){return m.channelCount},set channelCount(Y){throw t()},get channelCountMode(){return m.channelCountMode},set channelCountMode(Y){throw t()},get channelInterpretation(){return B},set channelInterpretation(Y){for(const ue of T)ue.channelInterpretation=Y;B=Y},get context(){return R.context},get inputs(){return T},get numberOfInputs(){return m.numberOfInputs},get numberOfOutputs(){return m.numberOfOutputs},get onprocessorerror(){return U},set onprocessorerror(Y){typeof U=="function"&&z.removeEventListener("processorerror",U),U=typeof Y=="function"?Y:null,typeof U=="function"&&z.addEventListener("processorerror",U)},get parameters(){return O},get port(){return E.port2},addEventListener(...Y){return R.addEventListener(Y[0],Y[1],Y[2])},connect:i.bind(null,H),disconnect:l.bind(null,H),dispatchEvent(...Y){return R.dispatchEvent(Y[0])},removeEventListener(...Y){return R.removeEventListener(Y[0],Y[1],Y[2])}},Z=new Map;E.port1.addEventListener=(Y=>(...ue)=>{if(ue[0]==="message"){const Se=typeof ue[1]=="function"?ue[1]:typeof ue[1]=="object"&&ue[1]!==null&&typeof ue[1].handleEvent=="function"?ue[1].handleEvent:null;if(Se!==null){const _e=Z.get(ue[1]);_e!==void 0?ue[1]=_e:(ue[1]=we=>{u(f.currentTime,f.sampleRate,()=>Se(we))},Z.set(Se,ue[1]))}}return Y.call(E.port1,ue[0],ue[1],ue[2])})(E.port1.addEventListener),E.port1.removeEventListener=(Y=>(...ue)=>{if(ue[0]==="message"){const Se=Z.get(ue[1]);Se!==void 0&&(Z.delete(ue[1]),ue[1]=Se)}return Y.call(E.port1,ue[0],ue[1],ue[2])})(E.port1.removeEventListener);let ee=null;Object.defineProperty(E.port1,"onmessage",{get:()=>ee,set:Y=>{typeof ee=="function"&&E.port1.removeEventListener("message",ee),ee=typeof Y=="function"?Y:null,typeof ee=="function"&&(E.port1.addEventListener("message",ee),E.port1.start())}}),_.prototype.port=E.port1;let te=null;dT(f,z,_,m).then(Y=>te=Y);const Oe=Qo(m.numberOfInputs,m.channelCount),X=Qo(m.numberOfOutputs,p),j=_.parameterDescriptors===void 0?[]:_.parameterDescriptors.reduce((Y,{name:ue})=>({...Y,[ue]:new Float32Array(128)}),{});let oe=!0;const re=()=>{m.numberOfOutputs>0&&R.disconnect(P);for(let Y=0,ue=0;Y<m.numberOfOutputs;Y+=1){const Se=D[Y];for(let _e=0;_e<p[Y];_e+=1)P.disconnect(Se,ue+_e,_e);ue+=p[Y]}},se=new Map;R.onaudioprocess=({inputBuffer:Y,outputBuffer:ue})=>{if(te!==null){const Se=h(z);for(let _e=0;_e<v;_e+=128){for(let we=0;we<m.numberOfInputs;we+=1)for(let I=0;I<m.channelCount;I+=1)Ko(Y,Oe[we],I,I,_e);_.parameterDescriptors!==void 0&&_.parameterDescriptors.forEach(({name:we},I)=>{Ko(Y,j,we,y+I,_e)});for(let we=0;we<m.numberOfInputs;we+=1)for(let I=0;I<p[we];I+=1)X[we][I].byteLength===0&&(X[we][I]=new Float32Array(128));try{const we=Oe.map((w,W)=>{if(Se[W].size>0)return se.set(W,v/128),w;const ne=se.get(W);return ne===void 0?[]:(w.every(ie=>ie.every(be=>be===0))&&(ne===1?se.delete(W):se.set(W,ne-1)),w)});oe=u(f.currentTime+_e/f.sampleRate,f.sampleRate,()=>te.process(we,X,j));for(let w=0,W=0;w<m.numberOfOutputs;w+=1){for(let J=0;J<p[w];J+=1)uf(ue,X[w],J,W+J,_e);W+=p[w]}}catch(we){oe=!1,z.dispatchEvent(new ErrorEvent("processorerror",{colno:we.colno,filename:we.filename,lineno:we.lineno,message:we.message}))}if(!oe){for(let we=0;we<m.numberOfInputs;we+=1){T[we].disconnect(b[we]);for(let I=0;I<m.channelCount;I+=1)b[_e].disconnect(S,I,we*m.channelCount+I)}if(_.parameterDescriptors!==void 0){const we=_.parameterDescriptors.length;for(let I=0;I<we;I+=1){const w=A[I];w.disconnect(S,0,y+I),w.stop()}}S.disconnect(R),R.onaudioprocess=null,Re?re():Fe();break}}}};let Re=!1;const Ue=o(f,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",gain:0}),N=()=>R.connect(Ue).connect(f.destination),Fe=()=>{R.disconnect(Ue),Ue.disconnect()},Ge=()=>{if(oe){Fe(),m.numberOfOutputs>0&&R.connect(P);for(let Y=0,ue=0;Y<m.numberOfOutputs;Y+=1){const Se=D[Y];for(let _e=0;_e<p[Y];_e+=1)P.connect(Se,ue+_e,_e);ue+=p[Y]}}Re=!0},ct=()=>{oe&&(N(),re()),Re=!1};return N(),d(z,Ge,ct)},ff=(i,e)=>{const t=i.createBiquadFilter();return Ct(t,e),mt(t,e,"Q"),mt(t,e,"detune"),mt(t,e,"frequency"),mt(t,e,"gain"),dt(t,e,"type"),t},pT=(i,e)=>(t,n)=>{const s=t.createChannelMerger(n.numberOfInputs);return i!==null&&i.name==="webkitAudioContext"&&e(t,s),Ct(s,n),s},mT=i=>{const e=i.numberOfOutputs;Object.defineProperty(i,"channelCount",{get:()=>e,set:t=>{if(t!==e)throw Nt()}}),Object.defineProperty(i,"channelCountMode",{get:()=>"explicit",set:t=>{if(t!=="explicit")throw Nt()}}),Object.defineProperty(i,"channelInterpretation",{get:()=>"discrete",set:t=>{if(t!=="discrete")throw Nt()}})},Wr=(i,e)=>{const t=i.createChannelSplitter(e.numberOfOutputs);return Ct(t,e),mT(t),t},gT=(i,e,t,n,s)=>(r,o)=>{if(r.createConstantSource===void 0)return t(r,o);const a=r.createConstantSource();return Ct(a,o),mt(a,o,"offset"),e(n,()=>n(r))||Dl(a),e(s,()=>s(r))||Nl(a),i(r,a),a},or=(i,e)=>(i.connect=e.connect.bind(e),i.disconnect=e.disconnect.bind(e),i),_T=(i,e,t,n)=>(s,{offset:r,...o})=>{const a=s.createBuffer(1,2,44100),c=e(s,{buffer:null,channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",loop:!1,loopEnd:0,loopStart:0,playbackRate:1}),l=t(s,{...o,gain:r}),u=a.getChannelData(0);u[0]=1,u[1]=1,c.buffer=a,c.loop=!0;const h={get bufferSize(){},get channelCount(){return l.channelCount},set channelCount(g){l.channelCount=g},get channelCountMode(){return l.channelCountMode},set channelCountMode(g){l.channelCountMode=g},get channelInterpretation(){return l.channelInterpretation},set channelInterpretation(g){l.channelInterpretation=g},get context(){return l.context},get inputs(){return[]},get numberOfInputs(){return c.numberOfInputs},get numberOfOutputs(){return l.numberOfOutputs},get offset(){return l.gain},get onended(){return c.onended},set onended(g){c.onended=g},addEventListener(...g){return c.addEventListener(g[0],g[1],g[2])},dispatchEvent(...g){return c.dispatchEvent(g[0])},removeEventListener(...g){return c.removeEventListener(g[0],g[1],g[2])},start(g=0){c.start.call(c,g)},stop(g=0){c.stop.call(c,g)}},d=()=>c.connect(l),f=()=>c.disconnect(l);return i(s,c),n(or(h,l),d,f)},vT=(i,e)=>(t,n)=>{const s=t.createConvolver();if(Ct(s,n),n.disableNormalization===s.normalize&&(s.normalize=!n.disableNormalization),dt(s,n,"buffer"),n.channelCount>2||(e(s,"channelCount",r=>()=>r.call(s),r=>o=>{if(o>2)throw i();return r.call(s,o)}),n.channelCountMode==="max"))throw i();return e(s,"channelCountMode",r=>()=>r.call(s),r=>o=>{if(o==="max")throw i();return r.call(s,o)}),s},pf=(i,e)=>{const t=i.createDelay(e.maxDelayTime);return Ct(t,e),mt(t,e,"delayTime"),t},xT=i=>(e,t)=>{const n=e.createDynamicsCompressor();if(Ct(n,t),t.channelCount>2||t.channelCountMode==="max")throw i();return mt(n,t,"attack"),mt(n,t,"knee"),mt(n,t,"ratio"),mt(n,t,"release"),mt(n,t,"threshold"),n},Jt=(i,e)=>{const t=i.createGain();return Ct(t,e),mt(t,e,"gain"),t},yT=i=>(e,t,n)=>{if(e.createIIRFilter===void 0)return i(e,t,n);const s=e.createIIRFilter(n.feedforward,n.feedback);return Ct(s,n),s};function ST(i,e){const t=e[0]*e[0]+e[1]*e[1];return[(i[0]*e[0]+i[1]*e[1])/t,(i[1]*e[0]-i[0]*e[1])/t]}function MT(i,e){return[i[0]*e[0]-i[1]*e[1],i[0]*e[1]+i[1]*e[0]]}function $h(i,e){let t=[0,0];for(let n=i.length-1;n>=0;n-=1)t=MT(t,e),t[0]+=i[n];return t}const TT=(i,e,t,n)=>(s,r,{channelCount:o,channelCountMode:a,channelInterpretation:c,feedback:l,feedforward:u})=>{const h=df(r,s.sampleRate),d=l instanceof Float64Array?l:new Float64Array(l),f=u instanceof Float64Array?u:new Float64Array(u),g=d.length,_=f.length,m=Math.min(g,_);if(g===0||g>20)throw n();if(d[0]===0)throw e();if(_===0||_>20)throw n();if(f[0]===0)throw e();if(d[0]!==1){for(let A=0;A<_;A+=1)f[A]/=d[0];for(let A=1;A<g;A+=1)d[A]/=d[0]}const p=t(s,h,o,o);p.channelCount=o,p.channelCountMode=a,p.channelInterpretation=c;const y=32,x=[],M=[],E=[];for(let A=0;A<o;A+=1){x.push(0);const S=new Float32Array(y),v=new Float32Array(y);S.fill(0),v.fill(0),M.push(S),E.push(v)}p.onaudioprocess=A=>{const S=A.inputBuffer,v=A.outputBuffer,R=S.numberOfChannels;for(let P=0;P<R;P+=1){const D=S.getChannelData(P),O=v.getChannelData(P);x[P]=hf(d,g,f,_,m,M[P],E[P],x[P],y,D,O)}};const T=s.sampleRate/2;return or({get bufferSize(){return h},get channelCount(){return p.channelCount},set channelCount(A){p.channelCount=A},get channelCountMode(){return p.channelCountMode},set channelCountMode(A){p.channelCountMode=A},get channelInterpretation(){return p.channelInterpretation},set channelInterpretation(A){p.channelInterpretation=A},get context(){return p.context},get inputs(){return[p]},get numberOfInputs(){return p.numberOfInputs},get numberOfOutputs(){return p.numberOfOutputs},addEventListener(...A){return p.addEventListener(A[0],A[1],A[2])},dispatchEvent(...A){return p.dispatchEvent(A[0])},getFrequencyResponse(A,S,v){if(A.length!==S.length||S.length!==v.length)throw i();const R=A.length;for(let P=0;P<R;P+=1){const D=-Math.PI*(A[P]/T),O=[Math.cos(D),Math.sin(D)],B=$h(f,O),U=$h(d,O),H=ST(B,U);S[P]=Math.sqrt(H[0]*H[0]+H[1]*H[1]),v[P]=Math.atan2(H[1],H[0])}},removeEventListener(...A){return p.removeEventListener(A[0],A[1],A[2])}},p)},bT=(i,e)=>i.createMediaElementSource(e.mediaElement),ET=(i,e)=>{const t=i.createMediaStreamDestination();return Ct(t,e),t.numberOfOutputs===1&&Object.defineProperty(t,"numberOfOutputs",{get:()=>0}),t},wT=(i,{mediaStream:e})=>{const t=e.getAudioTracks();t.sort((r,o)=>r.id<o.id?-1:r.id>o.id?1:0);const n=t.slice(0,1),s=i.createMediaStreamSource(new MediaStream(n));return Object.defineProperty(s,"mediaStream",{value:e}),s},AT=(i,e)=>(t,{mediaStreamTrack:n})=>{if(typeof t.createMediaStreamTrackSource=="function")return t.createMediaStreamTrackSource(n);const s=new MediaStream([n]),r=t.createMediaStreamSource(s);if(n.kind!=="audio")throw i();if(e(t))throw new TypeError;return r},CT=i=>i===null?null:i.hasOwnProperty("OfflineAudioContext")?i.OfflineAudioContext:i.hasOwnProperty("webkitOfflineAudioContext")?i.webkitOfflineAudioContext:null,RT=(i,e,t,n,s,r)=>(o,a)=>{const c=o.createOscillator();return Ct(c,a),mt(c,a,"detune"),mt(c,a,"frequency"),a.periodicWave!==void 0?c.setPeriodicWave(a.periodicWave):dt(c,a,"type"),e(t,()=>t(o))||Dl(c),e(n,()=>n(o))||r(c,o),e(s,()=>s(o))||Nl(c),i(o,c),c},IT=i=>(e,t)=>{const n=e.createPanner();return n.orientationX===void 0?i(e,t):(Ct(n,t),mt(n,t,"orientationX"),mt(n,t,"orientationY"),mt(n,t,"orientationZ"),mt(n,t,"positionX"),mt(n,t,"positionY"),mt(n,t,"positionZ"),dt(n,t,"coneInnerAngle"),dt(n,t,"coneOuterAngle"),dt(n,t,"coneOuterGain"),dt(n,t,"distanceModel"),dt(n,t,"maxDistance"),dt(n,t,"panningModel"),dt(n,t,"refDistance"),dt(n,t,"rolloffFactor"),n)},PT=(i,e,t,n,s,r,o,a,c,l)=>(u,{coneInnerAngle:h,coneOuterAngle:d,coneOuterGain:f,distanceModel:g,maxDistance:_,orientationX:m,orientationY:p,orientationZ:y,panningModel:x,positionX:M,positionY:E,positionZ:T,refDistance:b,rolloffFactor:A,...S})=>{const v=u.createPanner();if(S.channelCount>2||S.channelCountMode==="max")throw o();Ct(v,S);const R={channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete"},P=t(u,{...R,channelInterpretation:"speakers",numberOfInputs:6}),D=n(u,{...S,gain:1}),O=n(u,{...R,gain:1}),B=n(u,{...R,gain:0}),U=n(u,{...R,gain:0}),H=n(u,{...R,gain:0}),z=n(u,{...R,gain:0}),Z=n(u,{...R,gain:0}),ee=s(u,256,6,1),te=r(u,{...R,curve:new Float32Array([1,1]),oversample:"none"});let ve=[m,p,y],Oe=[M,E,T];const X=new Float32Array(1);ee.onaudioprocess=({inputBuffer:se})=>{const Re=[c(se,X,0),c(se,X,1),c(se,X,2)];Re.some((N,Fe)=>N!==ve[Fe])&&(v.setOrientation(...Re),ve=Re);const Ue=[c(se,X,3),c(se,X,4),c(se,X,5)];Ue.some((N,Fe)=>N!==Oe[Fe])&&(v.setPosition(...Ue),Oe=Ue)},Object.defineProperty(B.gain,"defaultValue",{get:()=>0}),Object.defineProperty(U.gain,"defaultValue",{get:()=>0}),Object.defineProperty(H.gain,"defaultValue",{get:()=>0}),Object.defineProperty(z.gain,"defaultValue",{get:()=>0}),Object.defineProperty(Z.gain,"defaultValue",{get:()=>0});const j={get bufferSize(){},get channelCount(){return v.channelCount},set channelCount(se){if(se>2)throw o();D.channelCount=se,v.channelCount=se},get channelCountMode(){return v.channelCountMode},set channelCountMode(se){if(se==="max")throw o();D.channelCountMode=se,v.channelCountMode=se},get channelInterpretation(){return v.channelInterpretation},set channelInterpretation(se){D.channelInterpretation=se,v.channelInterpretation=se},get coneInnerAngle(){return v.coneInnerAngle},set coneInnerAngle(se){v.coneInnerAngle=se},get coneOuterAngle(){return v.coneOuterAngle},set coneOuterAngle(se){v.coneOuterAngle=se},get coneOuterGain(){return v.coneOuterGain},set coneOuterGain(se){if(se<0||se>1)throw e();v.coneOuterGain=se},get context(){return v.context},get distanceModel(){return v.distanceModel},set distanceModel(se){v.distanceModel=se},get inputs(){return[D]},get maxDistance(){return v.maxDistance},set maxDistance(se){if(se<0)throw new RangeError;v.maxDistance=se},get numberOfInputs(){return v.numberOfInputs},get numberOfOutputs(){return v.numberOfOutputs},get orientationX(){return O.gain},get orientationY(){return B.gain},get orientationZ(){return U.gain},get panningModel(){return v.panningModel},set panningModel(se){v.panningModel=se},get positionX(){return H.gain},get positionY(){return z.gain},get positionZ(){return Z.gain},get refDistance(){return v.refDistance},set refDistance(se){if(se<0)throw new RangeError;v.refDistance=se},get rolloffFactor(){return v.rolloffFactor},set rolloffFactor(se){if(se<0)throw new RangeError;v.rolloffFactor=se},addEventListener(...se){return D.addEventListener(se[0],se[1],se[2])},dispatchEvent(...se){return D.dispatchEvent(se[0])},removeEventListener(...se){return D.removeEventListener(se[0],se[1],se[2])}};h!==j.coneInnerAngle&&(j.coneInnerAngle=h),d!==j.coneOuterAngle&&(j.coneOuterAngle=d),f!==j.coneOuterGain&&(j.coneOuterGain=f),g!==j.distanceModel&&(j.distanceModel=g),_!==j.maxDistance&&(j.maxDistance=_),m!==j.orientationX.value&&(j.orientationX.value=m),p!==j.orientationY.value&&(j.orientationY.value=p),y!==j.orientationZ.value&&(j.orientationZ.value=y),x!==j.panningModel&&(j.panningModel=x),M!==j.positionX.value&&(j.positionX.value=M),E!==j.positionY.value&&(j.positionY.value=E),T!==j.positionZ.value&&(j.positionZ.value=T),b!==j.refDistance&&(j.refDistance=b),A!==j.rolloffFactor&&(j.rolloffFactor=A),(ve[0]!==1||ve[1]!==0||ve[2]!==0)&&v.setOrientation(...ve),(Oe[0]!==0||Oe[1]!==0||Oe[2]!==0)&&v.setPosition(...Oe);const oe=()=>{D.connect(v),i(D,te,0,0),te.connect(O).connect(P,0,0),te.connect(B).connect(P,0,1),te.connect(U).connect(P,0,2),te.connect(H).connect(P,0,3),te.connect(z).connect(P,0,4),te.connect(Z).connect(P,0,5),P.connect(ee).connect(u.destination)},re=()=>{D.disconnect(v),a(D,te,0,0),te.disconnect(O),O.disconnect(P),te.disconnect(B),B.disconnect(P),te.disconnect(U),U.disconnect(P),te.disconnect(H),H.disconnect(P),te.disconnect(z),z.disconnect(P),te.disconnect(Z),Z.disconnect(P),P.disconnect(ee),ee.disconnect(u.destination)};return l(or(j,v),oe,re)},DT=i=>(e,{disableNormalization:t,imag:n,real:s})=>{const r=n instanceof Float32Array?n:new Float32Array(n),o=s instanceof Float32Array?s:new Float32Array(s),a=e.createPeriodicWave(o,r,{disableNormalization:t});if(Array.from(n).length<2)throw i();return a},qr=(i,e,t,n)=>i.createScriptProcessor(e,t,n),NT=(i,e)=>(t,n)=>{const s=n.channelCountMode;if(s==="clamped-max")throw e();if(t.createStereoPanner===void 0)return i(t,n);const r=t.createStereoPanner();return Ct(r,n),mt(r,n,"pan"),Object.defineProperty(r,"channelCountMode",{get:()=>s,set:o=>{if(o!==s)throw e()}}),r},LT=(i,e,t,n,s,r)=>{const a=new Float32Array([1,1]),c=Math.PI/2,l={channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete"},u={...l,oversample:"none"},h=(g,_,m,p)=>{const y=new Float32Array(16385),x=new Float32Array(16385);for(let S=0;S<16385;S+=1){const v=S/16384*c;y[S]=Math.cos(v),x[S]=Math.sin(v)}const M=t(g,{...l,gain:0}),E=n(g,{...u,curve:y}),T=n(g,{...u,curve:a}),b=t(g,{...l,gain:0}),A=n(g,{...u,curve:x});return{connectGraph(){_.connect(M),_.connect(T.inputs===void 0?T:T.inputs[0]),_.connect(b),T.connect(m),m.connect(E.inputs===void 0?E:E.inputs[0]),m.connect(A.inputs===void 0?A:A.inputs[0]),E.connect(M.gain),A.connect(b.gain),M.connect(p,0,0),b.connect(p,0,1)},disconnectGraph(){_.disconnect(M),_.disconnect(T.inputs===void 0?T:T.inputs[0]),_.disconnect(b),T.disconnect(m),m.disconnect(E.inputs===void 0?E:E.inputs[0]),m.disconnect(A.inputs===void 0?A:A.inputs[0]),E.disconnect(M.gain),A.disconnect(b.gain),M.disconnect(p,0,0),b.disconnect(p,0,1)}}},d=(g,_,m,p)=>{const y=new Float32Array(16385),x=new Float32Array(16385),M=new Float32Array(16385),E=new Float32Array(16385),T=Math.floor(16385/2);for(let H=0;H<16385;H+=1)if(H>T){const z=(H-T)/(16384-T)*c;y[H]=Math.cos(z),x[H]=Math.sin(z),M[H]=0,E[H]=1}else{const z=H/(16384-T)*c;y[H]=1,x[H]=0,M[H]=Math.cos(z),E[H]=Math.sin(z)}const b=e(g,{channelCount:2,channelCountMode:"explicit",channelInterpretation:"discrete",numberOfOutputs:2}),A=t(g,{...l,gain:0}),S=n(g,{...u,curve:y}),v=t(g,{...l,gain:0}),R=n(g,{...u,curve:x}),P=n(g,{...u,curve:a}),D=t(g,{...l,gain:0}),O=n(g,{...u,curve:M}),B=t(g,{...l,gain:0}),U=n(g,{...u,curve:E});return{connectGraph(){_.connect(b),_.connect(P.inputs===void 0?P:P.inputs[0]),b.connect(A,0),b.connect(v,0),b.connect(D,1),b.connect(B,1),P.connect(m),m.connect(S.inputs===void 0?S:S.inputs[0]),m.connect(R.inputs===void 0?R:R.inputs[0]),m.connect(O.inputs===void 0?O:O.inputs[0]),m.connect(U.inputs===void 0?U:U.inputs[0]),S.connect(A.gain),R.connect(v.gain),O.connect(D.gain),U.connect(B.gain),A.connect(p,0,0),D.connect(p,0,0),v.connect(p,0,1),B.connect(p,0,1)},disconnectGraph(){_.disconnect(b),_.disconnect(P.inputs===void 0?P:P.inputs[0]),b.disconnect(A,0),b.disconnect(v,0),b.disconnect(D,1),b.disconnect(B,1),P.disconnect(m),m.disconnect(S.inputs===void 0?S:S.inputs[0]),m.disconnect(R.inputs===void 0?R:R.inputs[0]),m.disconnect(O.inputs===void 0?O:O.inputs[0]),m.disconnect(U.inputs===void 0?U:U.inputs[0]),S.disconnect(A.gain),R.disconnect(v.gain),O.disconnect(D.gain),U.disconnect(B.gain),A.disconnect(p,0,0),D.disconnect(p,0,0),v.disconnect(p,0,1),B.disconnect(p,0,1)}}},f=(g,_,m,p,y)=>{if(_===1)return h(g,m,p,y);if(_===2)return d(g,m,p,y);throw s()};return(g,{channelCount:_,channelCountMode:m,pan:p,...y})=>{if(m==="max")throw s();const x=i(g,{...y,channelCount:1,channelCountMode:m,numberOfInputs:2}),M=t(g,{...y,channelCount:_,channelCountMode:m,gain:1}),E=t(g,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",gain:p});let{connectGraph:T,disconnectGraph:b}=f(g,_,M,E,x);Object.defineProperty(E.gain,"defaultValue",{get:()=>0}),Object.defineProperty(E.gain,"maxValue",{get:()=>1}),Object.defineProperty(E.gain,"minValue",{get:()=>-1});const A={get bufferSize(){},get channelCount(){return M.channelCount},set channelCount(P){M.channelCount!==P&&(S&&b(),{connectGraph:T,disconnectGraph:b}=f(g,P,M,E,x),S&&T()),M.channelCount=P},get channelCountMode(){return M.channelCountMode},set channelCountMode(P){if(P==="clamped-max"||P==="max")throw s();M.channelCountMode=P},get channelInterpretation(){return M.channelInterpretation},set channelInterpretation(P){M.channelInterpretation=P},get context(){return M.context},get inputs(){return[M]},get numberOfInputs(){return M.numberOfInputs},get numberOfOutputs(){return M.numberOfOutputs},get pan(){return E.gain},addEventListener(...P){return M.addEventListener(P[0],P[1],P[2])},dispatchEvent(...P){return M.dispatchEvent(P[0])},removeEventListener(...P){return M.removeEventListener(P[0],P[1],P[2])}};let S=!1;const v=()=>{T(),S=!0},R=()=>{b(),S=!1};return r(or(A,x),v,R)}},OT=(i,e,t,n,s,r,o)=>(a,c)=>{const l=a.createWaveShaper();if(r!==null&&r.name==="webkitAudioContext"&&a.createGain().gain.automationRate===void 0)return t(a,c);Ct(l,c);const u=c.curve===null||c.curve instanceof Float32Array?c.curve:new Float32Array(c.curve);if(u!==null&&u.length<2)throw e();dt(l,{curve:u},"curve"),dt(l,c,"oversample");let h=null,d=!1;return o(l,"curve",_=>()=>_.call(l),_=>m=>(_.call(l,m),d&&(n(m)&&h===null?h=i(a,l):!n(m)&&h!==null&&(h(),h=null)),m)),s(l,()=>{d=!0,n(l.curve)&&(h=i(a,l))},()=>{d=!1,h!==null&&(h(),h=null)})},UT=(i,e,t,n,s)=>(r,{curve:o,oversample:a,...c})=>{const l=r.createWaveShaper(),u=r.createWaveShaper();Ct(l,c),Ct(u,c);const h=t(r,{...c,gain:1}),d=t(r,{...c,gain:-1}),f=t(r,{...c,gain:1}),g=t(r,{...c,gain:-1});let _=null,m=!1,p=null;const y={get bufferSize(){},get channelCount(){return l.channelCount},set channelCount(E){h.channelCount=E,d.channelCount=E,l.channelCount=E,f.channelCount=E,u.channelCount=E,g.channelCount=E},get channelCountMode(){return l.channelCountMode},set channelCountMode(E){h.channelCountMode=E,d.channelCountMode=E,l.channelCountMode=E,f.channelCountMode=E,u.channelCountMode=E,g.channelCountMode=E},get channelInterpretation(){return l.channelInterpretation},set channelInterpretation(E){h.channelInterpretation=E,d.channelInterpretation=E,l.channelInterpretation=E,f.channelInterpretation=E,u.channelInterpretation=E,g.channelInterpretation=E},get context(){return l.context},get curve(){return p},set curve(E){if(E!==null&&E.length<2)throw e();if(E===null)l.curve=E,u.curve=E;else{const T=E.length,b=new Float32Array(T+2-T%2),A=new Float32Array(T+2-T%2);b[0]=E[0],A[0]=-E[T-1];const S=Math.ceil((T+1)/2),v=(T+1)/2-1;for(let R=1;R<S;R+=1){const P=R/S*v,D=Math.floor(P),O=Math.ceil(P);b[R]=D===O?E[D]:(1-(P-D))*E[D]+(1-(O-P))*E[O],A[R]=D===O?-E[T-1-D]:-((1-(P-D))*E[T-1-D])-(1-(O-P))*E[T-1-O]}b[S]=T%2===1?E[S-1]:(E[S-2]+E[S-1])/2,l.curve=b,u.curve=A}p=E,m&&(n(p)&&_===null?_=i(r,h):_!==null&&(_(),_=null))},get inputs(){return[h]},get numberOfInputs(){return l.numberOfInputs},get numberOfOutputs(){return l.numberOfOutputs},get oversample(){return l.oversample},set oversample(E){l.oversample=E,u.oversample=E},addEventListener(...E){return h.addEventListener(E[0],E[1],E[2])},dispatchEvent(...E){return h.dispatchEvent(E[0])},removeEventListener(...E){return h.removeEventListener(E[0],E[1],E[2])}};o!==null&&(y.curve=o instanceof Float32Array?o:new Float32Array(o)),a!==y.oversample&&(y.oversample=a);const x=()=>{h.connect(l).connect(f),h.connect(d).connect(u).connect(g).connect(f),m=!0,n(p)&&(_=i(r,h))},M=()=>{h.disconnect(l),l.disconnect(f),h.disconnect(d),d.disconnect(u),u.disconnect(g),g.disconnect(f),m=!1,_!==null&&(_(),_=null)};return s(or(y,f),x,M)},Xt=()=>new DOMException("","NotSupportedError"),FT={numberOfChannels:1},kT=(i,e,t,n,s)=>class extends i{constructor(o,a,c){let l;if(typeof o=="number"&&a!==void 0&&c!==void 0)l={length:a,numberOfChannels:o,sampleRate:c};else if(typeof o=="object")l=o;else throw new Error("The given parameters are not valid.");const{length:u,numberOfChannels:h,sampleRate:d}={...FT,...l},f=n(h,u,d);e(Mr,()=>Mr(f))||f.addEventListener("statechange",(()=>{let g=0;const _=m=>{this._state==="running"&&(g>0?(f.removeEventListener("statechange",_),m.stopImmediatePropagation(),this._waitForThePromiseToSettle(m)):g+=1)};return _})()),super(f,h),this._length=u,this._nativeOfflineAudioContext=f,this._state=null}get length(){return this._nativeOfflineAudioContext.length===void 0?this._length:this._nativeOfflineAudioContext.length}get state(){return this._state===null?this._nativeOfflineAudioContext.state:this._state}startRendering(){return this._state==="running"?Promise.reject(t()):(this._state="running",s(this.destination,this._nativeOfflineAudioContext).finally(()=>{this._state=null,rf(this)}))}_waitForThePromiseToSettle(o){this._state===null?this._nativeOfflineAudioContext.dispatchEvent(o):setTimeout(()=>this._waitForThePromiseToSettle(o))}},BT={channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",detune:0,frequency:440,periodicWave:void 0,type:"sine"},VT=(i,e,t,n,s,r,o)=>class extends i{constructor(c,l){const u=s(c),h={...BT,...l},d=t(u,h),f=r(u),g=f?n():null,_=c.sampleRate/2;super(c,!1,d,g),this._detune=e(this,f,d.detune,153600,-153600),this._frequency=e(this,f,d.frequency,_,-_),this._nativeOscillatorNode=d,this._onended=null,this._oscillatorNodeRenderer=g,this._oscillatorNodeRenderer!==null&&h.periodicWave!==void 0&&(this._oscillatorNodeRenderer.periodicWave=h.periodicWave)}get detune(){return this._detune}get frequency(){return this._frequency}get onended(){return this._onended}set onended(c){const l=typeof c=="function"?o(this,c):null;this._nativeOscillatorNode.onended=l;const u=this._nativeOscillatorNode.onended;this._onended=u!==null&&u===l?c:u}get type(){return this._nativeOscillatorNode.type}set type(c){this._nativeOscillatorNode.type=c,this._oscillatorNodeRenderer!==null&&(this._oscillatorNodeRenderer.periodicWave=null)}setPeriodicWave(c){this._nativeOscillatorNode.setPeriodicWave(c),this._oscillatorNodeRenderer!==null&&(this._oscillatorNodeRenderer.periodicWave=c)}start(c=0){if(this._nativeOscillatorNode.start(c),this._oscillatorNodeRenderer!==null&&(this._oscillatorNodeRenderer.start=c),this.context.state!=="closed"){js(this);const l=()=>{this._nativeOscillatorNode.removeEventListener("ended",l),ni(this)&&zr(this)};this._nativeOscillatorNode.addEventListener("ended",l)}}stop(c=0){this._nativeOscillatorNode.stop(c),this._oscillatorNodeRenderer!==null&&(this._oscillatorNodeRenderer.stop=c)}},zT=(i,e,t,n,s)=>()=>{const r=new WeakMap;let o=null,a=null,c=null;const l=async(u,h)=>{let d=t(u);const f=zt(d,h);if(!f){const g={channelCount:d.channelCount,channelCountMode:d.channelCountMode,channelInterpretation:d.channelInterpretation,detune:d.detune.value,frequency:d.frequency.value,periodicWave:o===null?void 0:o,type:d.type};d=e(h,g),a!==null&&d.start(a),c!==null&&d.stop(c)}return r.set(h,d),f?(await i(h,u.detune,d.detune),await i(h,u.frequency,d.frequency)):(await n(h,u.detune,d.detune),await n(h,u.frequency,d.frequency)),await s(u,h,d),d};return{set periodicWave(u){o=u},set start(u){a=u},set stop(u){c=u},render(u,h){const d=r.get(h);return d!==void 0?Promise.resolve(d):l(u,h)}}},HT={channelCount:2,channelCountMode:"clamped-max",channelInterpretation:"speakers",coneInnerAngle:360,coneOuterAngle:360,coneOuterGain:0,distanceModel:"inverse",maxDistance:1e4,orientationX:1,orientationY:0,orientationZ:0,panningModel:"equalpower",positionX:0,positionY:0,positionZ:0,refDistance:1,rolloffFactor:1},GT=(i,e,t,n,s,r,o)=>class extends i{constructor(c,l){const u=s(c),h={...HT,...l},d=t(u,h),f=r(u),g=f?n():null;super(c,!1,d,g),this._nativePannerNode=d,this._orientationX=e(this,f,d.orientationX,Wt,Zt),this._orientationY=e(this,f,d.orientationY,Wt,Zt),this._orientationZ=e(this,f,d.orientationZ,Wt,Zt),this._positionX=e(this,f,d.positionX,Wt,Zt),this._positionY=e(this,f,d.positionY,Wt,Zt),this._positionZ=e(this,f,d.positionZ,Wt,Zt),o(this,1)}get coneInnerAngle(){return this._nativePannerNode.coneInnerAngle}set coneInnerAngle(c){this._nativePannerNode.coneInnerAngle=c}get coneOuterAngle(){return this._nativePannerNode.coneOuterAngle}set coneOuterAngle(c){this._nativePannerNode.coneOuterAngle=c}get coneOuterGain(){return this._nativePannerNode.coneOuterGain}set coneOuterGain(c){this._nativePannerNode.coneOuterGain=c}get distanceModel(){return this._nativePannerNode.distanceModel}set distanceModel(c){this._nativePannerNode.distanceModel=c}get maxDistance(){return this._nativePannerNode.maxDistance}set maxDistance(c){this._nativePannerNode.maxDistance=c}get orientationX(){return this._orientationX}get orientationY(){return this._orientationY}get orientationZ(){return this._orientationZ}get panningModel(){return this._nativePannerNode.panningModel}set panningModel(c){this._nativePannerNode.panningModel=c}get positionX(){return this._positionX}get positionY(){return this._positionY}get positionZ(){return this._positionZ}get refDistance(){return this._nativePannerNode.refDistance}set refDistance(c){this._nativePannerNode.refDistance=c}get rolloffFactor(){return this._nativePannerNode.rolloffFactor}set rolloffFactor(c){this._nativePannerNode.rolloffFactor=c}},WT=(i,e,t,n,s,r,o,a,c,l)=>()=>{const u=new WeakMap;let h=null;const d=async(f,g)=>{let _=null,m=r(f);const p={channelCount:m.channelCount,channelCountMode:m.channelCountMode,channelInterpretation:m.channelInterpretation},y={...p,coneInnerAngle:m.coneInnerAngle,coneOuterAngle:m.coneOuterAngle,coneOuterGain:m.coneOuterGain,distanceModel:m.distanceModel,maxDistance:m.maxDistance,panningModel:m.panningModel,refDistance:m.refDistance,rolloffFactor:m.rolloffFactor},x=zt(m,g);if("bufferSize"in m)_=n(g,{...p,gain:1});else if(!x){const M={...y,orientationX:m.orientationX.value,orientationY:m.orientationY.value,orientationZ:m.orientationZ.value,positionX:m.positionX.value,positionY:m.positionY.value,positionZ:m.positionZ.value};m=s(g,M)}if(u.set(g,_===null?m:_),_!==null){if(h===null){if(o===null)throw new Error("Missing the native OfflineAudioContext constructor.");const R=new o(6,f.context.length,g.sampleRate),P=e(R,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:6});P.connect(R.destination),h=(async()=>{const D=await Promise.all([f.orientationX,f.orientationY,f.orientationZ,f.positionX,f.positionY,f.positionZ].map(async(O,B)=>{const U=t(R,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",offset:B===0?1:0});return await a(R,O,U.offset),U}));for(let O=0;O<6;O+=1)D[O].connect(P,0,O),D[O].start(0);return l(R)})()}const M=await h,E=n(g,{...p,gain:1});await c(f,g,E);const T=[];for(let R=0;R<M.numberOfChannels;R+=1)T.push(M.getChannelData(R));let b=[T[0][0],T[1][0],T[2][0]],A=[T[3][0],T[4][0],T[5][0]],S=n(g,{...p,gain:1}),v=s(g,{...y,orientationX:b[0],orientationY:b[1],orientationZ:b[2],positionX:A[0],positionY:A[1],positionZ:A[2]});E.connect(S).connect(v.inputs[0]),v.connect(_);for(let R=128;R<M.length;R+=128){const P=[T[0][R],T[1][R],T[2][R]],D=[T[3][R],T[4][R],T[5][R]];if(P.some((O,B)=>O!==b[B])||D.some((O,B)=>O!==A[B])){b=P,A=D;const O=R/g.sampleRate;S.gain.setValueAtTime(0,O),S=n(g,{...p,gain:0}),v=s(g,{...y,orientationX:b[0],orientationY:b[1],orientationZ:b[2],positionX:A[0],positionY:A[1],positionZ:A[2]}),S.gain.setValueAtTime(1,O),E.connect(S).connect(v.inputs[0]),v.connect(_)}}return _}return x?(await i(g,f.orientationX,m.orientationX),await i(g,f.orientationY,m.orientationY),await i(g,f.orientationZ,m.orientationZ),await i(g,f.positionX,m.positionX),await i(g,f.positionY,m.positionY),await i(g,f.positionZ,m.positionZ)):(await a(g,f.orientationX,m.orientationX),await a(g,f.orientationY,m.orientationY),await a(g,f.orientationZ,m.orientationZ),await a(g,f.positionX,m.positionX),await a(g,f.positionY,m.positionY),await a(g,f.positionZ,m.positionZ)),rr(m)?await c(f,g,m.inputs[0]):await c(f,g,m),m};return{render(f,g){const _=u.get(g);return _!==void 0?Promise.resolve(_):d(f,g)}}},qT={disableNormalization:!1},XT=(i,e,t,n)=>class mf{constructor(r,o){const a=e(r),c=n({...qT,...o}),l=i(a,c);return t.add(l),l}static[Symbol.hasInstance](r){return r!==null&&typeof r=="object"&&Object.getPrototypeOf(r)===mf.prototype||t.has(r)}},jT=(i,e)=>(t,n,s)=>(i(n).replay(s),e(n,t,s)),YT=(i,e,t)=>async(n,s,r)=>{const o=i(n);await Promise.all(o.activeInputs.map((a,c)=>Array.from(a).map(async([l,u])=>{const d=await e(l).render(l,s),f=n.context.destination;!t(l)&&(n!==f||!t(n))&&d.connect(r,u,c)})).reduce((a,c)=>[...a,...c],[]))},$T=(i,e,t)=>async(n,s,r)=>{const o=e(n);await Promise.all(Array.from(o.activeInputs).map(async([a,c])=>{const u=await i(a).render(a,s);t(a)||u.connect(r,c)}))},ZT=(i,e,t,n)=>s=>i(Mr,()=>Mr(s))?Promise.resolve(i(n,n)).then(r=>{if(!r){const o=t(s,512,0,1);s.oncomplete=()=>{o.onaudioprocess=null,o.disconnect()},o.onaudioprocess=()=>s.currentTime,o.connect(s.destination)}return s.startRendering()}):new Promise(r=>{const o=e(s,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",gain:0});s.oncomplete=a=>{o.disconnect(),r(a.renderedBuffer)},o.connect(s.destination),s.startRendering()}),KT=i=>(e,t)=>{i.set(e,t)},QT=i=>(e,t)=>i.set(e,t),JT=(i,e,t,n,s,r,o,a)=>(c,l)=>t(c).render(c,l).then(()=>Promise.all(Array.from(n(l)).map(u=>t(u).render(u,l)))).then(()=>s(l)).then(u=>(typeof u.copyFromChannel!="function"?(o(u),Rl(u)):e(r,()=>r(u))||a(u),i.add(u),u)),eb={channelCount:2,channelCountMode:"explicit",channelInterpretation:"speakers",pan:0},tb=(i,e,t,n,s,r)=>class extends i{constructor(a,c){const l=s(a),u={...eb,...c},h=t(l,u),d=r(l),f=d?n():null;super(a,!1,h,f),this._pan=e(this,d,h.pan)}get pan(){return this._pan}},nb=(i,e,t,n,s)=>()=>{const r=new WeakMap,o=async(a,c)=>{let l=t(a);const u=zt(l,c);if(!u){const h={channelCount:l.channelCount,channelCountMode:l.channelCountMode,channelInterpretation:l.channelInterpretation,pan:l.pan.value};l=e(c,h)}return r.set(c,l),u?await i(c,a.pan,l.pan):await n(c,a.pan,l.pan),rr(l)?await s(a,c,l.inputs[0]):await s(a,c,l),l};return{render(a,c){const l=r.get(c);return l!==void 0?Promise.resolve(l):o(a,c)}}},ib=i=>()=>{if(i===null)return!1;try{new i({length:1,sampleRate:44100})}catch{return!1}return!0},sb=(i,e)=>async()=>{if(i===null)return!0;if(e===null)return!1;const t=new Blob(['class A extends AudioWorkletProcessor{process(i){this.port.postMessage(i,[i[0][0].buffer])}}registerProcessor("a",A)'],{type:"application/javascript; charset=utf-8"}),n=new e(1,128,44100),s=URL.createObjectURL(t);let r=!1,o=!1;try{await n.audioWorklet.addModule(s);const a=new i(n,"a",{numberOfOutputs:0}),c=n.createOscillator();a.port.onmessage=()=>r=!0,a.onprocessorerror=()=>o=!0,c.connect(a),c.start(0),await n.startRendering(),await new Promise(l=>setTimeout(l))}catch{}finally{URL.revokeObjectURL(s)}return r&&!o},rb=(i,e)=>()=>{if(e===null)return Promise.resolve(!1);const t=new e(1,1,44100),n=i(t,{channelCount:1,channelCountMode:"explicit",channelInterpretation:"discrete",gain:0});return new Promise(s=>{t.oncomplete=()=>{n.disconnect(),s(t.currentTime!==0)},t.startRendering()})},ob=()=>new DOMException("","UnknownError"),ab={channelCount:2,channelCountMode:"max",channelInterpretation:"speakers",curve:null,oversample:"none"},cb=(i,e,t,n,s,r,o)=>class extends i{constructor(c,l){const u=s(c),h={...ab,...l},d=t(u,h),g=r(u)?n():null;super(c,!0,d,g),this._isCurveNullified=!1,this._nativeWaveShaperNode=d,o(this,1)}get curve(){return this._isCurveNullified?null:this._nativeWaveShaperNode.curve}set curve(c){if(c===null)this._isCurveNullified=!0,this._nativeWaveShaperNode.curve=new Float32Array([0,0]);else{if(c.length<2)throw e();this._isCurveNullified=!1,this._nativeWaveShaperNode.curve=c}}get oversample(){return this._nativeWaveShaperNode.oversample}set oversample(c){this._nativeWaveShaperNode.oversample=c}},lb=(i,e,t)=>()=>{const n=new WeakMap,s=async(r,o)=>{let a=e(r);if(!zt(a,o)){const l={channelCount:a.channelCount,channelCountMode:a.channelCountMode,channelInterpretation:a.channelInterpretation,curve:a.curve,oversample:a.oversample};a=i(o,l)}return n.set(o,a),rr(a)?await t(r,o,a.inputs[0]):await t(r,o,a),a};return{render(r,o){const a=n.get(o);return a!==void 0?Promise.resolve(a):s(r,o)}}},ub=()=>typeof window>"u"?null:window,hb=(i,e)=>t=>{t.copyFromChannel=(n,s,r=0)=>{const o=i(r),a=i(s);if(a>=t.numberOfChannels)throw e();const c=t.length,l=t.getChannelData(a),u=n.length;for(let h=o<0?-o:0;h+o<c&&h<u;h+=1)n[h]=l[h+o]},t.copyToChannel=(n,s,r=0)=>{const o=i(r),a=i(s);if(a>=t.numberOfChannels)throw e();const c=t.length,l=t.getChannelData(a),u=n.length;for(let h=o<0?-o:0;h+o<c&&h<u;h+=1)l[h+o]=n[h]}},db=i=>e=>{e.copyFromChannel=(t=>(n,s,r=0)=>{const o=i(r),a=i(s);if(o<e.length)return t.call(e,n,a,o)})(e.copyFromChannel),e.copyToChannel=(t=>(n,s,r=0)=>{const o=i(r),a=i(s);if(o<e.length)return t.call(e,n,a,o)})(e.copyToChannel)},fb=i=>(e,t)=>{const n=t.createBuffer(1,1,44100);e.buffer===null&&(e.buffer=n),i(e,"buffer",s=>()=>{const r=s.call(e);return r===n?null:r},s=>r=>s.call(e,r===null?n:r))},pb=(i,e)=>(t,n)=>{n.channelCount=1,n.channelCountMode="explicit",Object.defineProperty(n,"channelCount",{get:()=>1,set:()=>{throw i()}}),Object.defineProperty(n,"channelCountMode",{get:()=>"explicit",set:()=>{throw i()}});const s=t.createBufferSource();e(n,()=>{const a=n.numberOfInputs;for(let c=0;c<a;c+=1)s.connect(n,0,c)},()=>s.disconnect(n))},gf=(i,e,t)=>i.copyFromChannel===void 0?i.getChannelData(t)[0]:(i.copyFromChannel(e,t),e[0]),_f=i=>{if(i===null)return!1;const e=i.length;return e%2!==0?i[Math.floor(e/2)]!==0:i[e/2-1]+i[e/2]!==0},Xr=(i,e,t,n)=>{let s=i;for(;!s.hasOwnProperty(e);)s=Object.getPrototypeOf(s);const{get:r,set:o}=Object.getOwnPropertyDescriptor(s,e);Object.defineProperty(i,e,{get:t(r),set:n(o)})},mb=i=>({...i,outputChannelCount:i.outputChannelCount!==void 0?i.outputChannelCount:i.numberOfInputs===1&&i.numberOfOutputs===1?[i.channelCount]:Array.from({length:i.numberOfOutputs},()=>1)}),gb=i=>({...i,channelCount:i.numberOfOutputs}),_b=i=>{const{imag:e,real:t}=i;return e===void 0?t===void 0?{...i,imag:[0,0],real:[0,0]}:{...i,imag:Array.from(t,()=>0),real:t}:t===void 0?{...i,imag:e,real:Array.from(e,()=>0)}:{...i,imag:e,real:t}},vf=(i,e,t)=>{try{i.setValueAtTime(e,t)}catch(n){if(n.code!==9)throw n;vf(i,e,t+1e-7)}},vb=i=>{const e=i.createBufferSource();e.start();try{e.start()}catch{return!0}return!1},xb=i=>{const e=i.createBufferSource(),t=i.createBuffer(1,1,44100);e.buffer=t;try{e.start(0,1)}catch{return!1}return!0},yb=i=>{const e=i.createBufferSource();e.start();try{e.stop()}catch{return!1}return!0},Ll=i=>{const e=i.createOscillator();try{e.start(-1)}catch(t){return t instanceof RangeError}return!1},xf=i=>{const e=i.createBuffer(1,1,44100),t=i.createBufferSource();t.buffer=e,t.start(),t.stop();try{return t.stop(),!0}catch{return!1}},Ol=i=>{const e=i.createOscillator();try{e.stop(-1)}catch(t){return t instanceof RangeError}return!1},Sb=i=>{const{port1:e,port2:t}=new MessageChannel;try{e.postMessage(i)}finally{e.close(),t.close()}},Mb=i=>{i.start=(e=>(t=0,n=0,s)=>{const r=i.buffer,o=r===null?n:Math.min(r.duration,n);r!==null&&o>r.duration-.5/i.context.sampleRate?e.call(i,t,0,0):e.call(i,t,o,s)})(i.start)},yf=(i,e)=>{const t=e.createGain();i.connect(t);const n=(s=>()=>{s.call(i,t),i.removeEventListener("ended",n)})(i.disconnect);i.addEventListener("ended",n),or(i,t),i.stop=(s=>{let r=!1;return(o=0)=>{if(r)try{s.call(i,o)}catch{t.gain.setValueAtTime(0,o)}else s.call(i,o),r=!0}})(i.stop)},ar=(i,e)=>t=>{const n={value:i};return Object.defineProperties(t,{currentTarget:n,target:n}),typeof e=="function"?e.call(i,t):e.handleEvent.call(i,t)},Tb=Gy(us),bb=$y(us),Eb=aM(ka),Sf=new WeakMap,wb=EM(Sf),En=FS(new Map,new WeakMap),Fn=ub(),Mf=tT(En,Vn),Ul=bM(qt),Ot=YT(qt,Ul,is),Ab=eS(Mf,ht,Ot),at=CM(Fa),ai=CT(Fn),rt=qM(ai),Tf=new WeakMap,bf=_M(ar),jr=rT(Fn),Fl=zM(jr),kl=HM(Fn),Ef=GM(Fn),Tr=aT(Fn),St=ES(Wy(Kd),Yy(Tb,bb,Yo,Eb,$o,qt,wb,Vr,ht,us,ni,is,Po),En,UM(Kc,$o,qt,ht,Sr,ni),Vn,Ba,Xt,iM(Yo,Kc,qt,ht,Sr,at,ni,rt),uM(Tf,qt,Mn),bf,at,Fl,kl,Ef,rt,Tr),Cb=Jy(St,Ab,Vn,Mf,at,rt),Bl=new WeakSet,Zh=nT(Fn),wf=ZS(new Uint32Array(1)),Vl=hb(wf,Vn),zl=db(wf),Af=nS(Bl,En,Xt,Zh,ai,ib(Zh),Vl,zl),Va=Zy(Jt),Cf=$T(Ul,Hr,is),zn=WS(Cf),cr=sT(Va,En,vb,xb,yb,Ll,xf,Ol,Mb,fb(Xr),yf),Hn=jT(wM(Hr),Cf),Rb=rS(zn,cr,ht,Hn,Ot),wn=wS(qy(Qd),Tf,Cl,AS,Fy,ky,By,Vy,zy,Yc,Yd,jr,vf),Ib=sS(St,Rb,wn,Nt,cr,at,rt,ar),Pb=pS(St,mS,Vn,Nt,oT(Jt,Xr),at,rt,Ot),Db=US(zn,ff,ht,Hn,Ot),hs=QT(Sf),Nb=OS(St,wn,Db,Ba,ff,at,rt,hs),Ni=JM(us,kl),Lb=pb(Nt,Ni),Li=pT(jr,Lb),Ob=VS(Li,ht,Ot),Ub=BS(St,Ob,Li,at,rt),Fb=GS(Wr,ht,Ot),kb=HS(St,Fb,Wr,at,rt,gb),Bb=_T(Va,cr,Jt,Ni),lr=gT(Va,En,Bb,Ll,Ol),Vb=$S(zn,lr,ht,Hn,Ot),zb=YS(St,wn,Vb,lr,at,rt,ar),Rf=vT(Xt,Xr),Hb=JS(Rf,ht,Ot),Gb=QS(St,Hb,Rf,at,rt,hs),Wb=oM(zn,pf,ht,Hn,Ot),qb=rM(St,wn,Wb,pf,at,rt,hs),If=xT(Xt),Xb=pM(zn,If,ht,Hn,Ot),jb=fM(St,wn,Xb,If,Xt,at,rt,hs),Yb=MM(zn,Jt,ht,Hn,Ot),$b=SM(St,wn,Yb,Jt,at,rt),Zb=TT(Ba,Nt,qr,Xt),za=ZT(En,Jt,qr,rb(Jt,ai)),Kb=OM(cr,ht,ai,Ot,za),Qb=yT(Zb),Jb=NM(St,Qb,Kb,at,rt,hs),eE=gS(wn,Li,lr,qr,Xt,gf,rt,Xr),Pf=new WeakMap,tE=QM(Pb,eE,bf,rt,Pf,ar),Df=RT(Va,En,Ll,xf,Ol,yf),nE=zT(zn,Df,ht,Hn,Ot),iE=VT(St,wn,Df,nE,at,rt,ar),Nf=XS(cr),sE=UT(Nf,Nt,Jt,_f,Ni),Ha=OT(Nf,Nt,sE,_f,Ni,jr,Xr),rE=PT(Yo,Nt,Li,Jt,qr,Ha,Xt,$o,gf,Ni),Lf=IT(rE),oE=WT(zn,Li,lr,Jt,Lf,ht,ai,Hn,Ot,za),aE=GT(St,wn,Lf,oE,at,rt,hs),cE=DT(Vn),lE=XT(cE,at,new WeakSet,_b),uE=LT(Li,Wr,Jt,Ha,Xt,Ni),Of=NT(uE,Xt),hE=nb(zn,Of,ht,Hn,Ot),dE=tb(St,wn,Of,hE,at,rt),fE=lb(Ha,ht,Ot),pE=cb(St,Nt,Ha,fE,at,rt,hs),Uf=XM(Fn),Hl=vM(Fn),Ff=new WeakMap,mE=RM(Ff,ai),gE=Uf?jy(En,Xt,gM(Fn),Hl,xM(Hy),at,mE,rt,Tr,new WeakMap,new WeakMap,sb(Tr,ai),Fn):void 0,_E=WM(Fl,rt),vE=nM(Bl,En,tM,mM,new WeakSet,at,_E,Xo,Mr,Vl,zl),kf=NS(gE,Cb,Af,Ib,Nb,Ub,kb,zb,Gb,vE,qb,jb,$b,Jb,tE,iE,aE,lE,dE,pE),xE=jM(St,bT,at,rt),yE=$M(St,ET,at,rt),SE=ZM(St,wT,at,rt),ME=AT(Nt,rt),TE=KM(St,ME,at),bE=fS(kf,Nt,Xt,ob,xE,yE,SE,TE,jr),Gl=IM(Pf),EE=Ky(Gl),Bf=qS(Vn),wE=cM(Gl),Vf=hM(Vn),zf=new WeakMap,AE=TM(zf,Mn),CE=fT(Bf,Vn,Nt,Li,Wr,lr,Jt,qr,Xt,Vf,Hl,AE,Ni),RE=lT(Nt,CE,Jt,Xt,Ni),IE=DS(zn,Bf,cr,Li,Wr,lr,Jt,wE,Vf,Hl,ht,Tr,ai,Hn,Ot,za),PE=AM(Ff),DE=KT(zf),Kh=Uf?RS(EE,St,wn,IE,RE,qt,PE,at,rt,Tr,mb,DE,Sb,ar):void 0,NE=eM(Xt,ai),LE=JT(Bl,En,Ul,Gl,za,Xo,Vl,zl),OE=kT(kf,En,Nt,NE,LE),UE=FM(Fa,Fl),FE=kM(Al,kl),kE=BM(Cl,Ef),BE=VM(Fa,rt);function dn(i){return i===void 0}function qe(i){return i!==void 0}function VE(i){return typeof i=="function"}function Tn(i){return typeof i=="number"}function Ji(i){return Object.prototype.toString.call(i)==="[object Object]"&&i.constructor===Object}function Hf(i){return typeof i=="boolean"}function rn(i){return Array.isArray(i)}function si(i){return typeof i=="string"}function wo(i){return si(i)&&/^([a-g]{1}(?:b|#|x|bb)?)(-?[0-9]+)/i.test(i)}function Ce(i,e){if(!i)throw new Error(e)}function Ri(i,e,t=1/0){if(!(e<=i&&i<=t))throw new RangeError(`Value must be within [${e}, ${t}], got: ${i}`)}function Gf(i){!i.isOffline&&i.state!=="running"&&Ga('The AudioContext is "suspended". Invoke Tone.start() from a user action to start the audio.')}let Wf=!1,Qh=!1;function Jh(i){Wf=i}function zE(i){dn(i)&&Wf&&!Qh&&(Qh=!0,Ga("Events scheduled inside of scheduled callbacks should use the passed in scheduling time. See https://github.com/Tonejs/Tone.js/wiki/Accurate-Timing"))}let qf=console;function HE(...i){qf.log(...i)}function Ga(...i){qf.warn(...i)}function GE(i){return new bE(i)}function WE(i,e,t){return new OE(i,e,t)}const es=typeof self=="object"?self:null,qE=es&&(es.hasOwnProperty("AudioContext")||es.hasOwnProperty("webkitAudioContext"));function XE(i,e,t){return Ce(qe(Kh),"This node only works in a secure context (https or localhost)"),new Kh(i,e,t)}function An(i,e,t,n){var s=arguments.length,r=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,t,n);else for(var a=i.length-1;a>=0;a--)(o=i[a])&&(r=(s<3?o(r):s>3?o(e,t,r):o(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r}function Tt(i,e,t,n){function s(r){return r instanceof t?r:new t(function(o){o(r)})}return new(t||(t=Promise))(function(r,o){function a(u){try{l(n.next(u))}catch(h){o(h)}}function c(u){try{l(n.throw(u))}catch(h){o(h)}}function l(u){u.done?r(u.value):s(u.value).then(a,c)}l((n=n.apply(i,e||[])).next())})}class jE{constructor(e,t,n,s){this._callback=e,this._type=t,this._minimumUpdateInterval=Math.max(128/(s||44100),.001),this.updateInterval=n,this._createClock()}_createWorker(){const e=new Blob([`
...
`;Jl(Sw);const tp="feedback-comb-filter",Mw=`
